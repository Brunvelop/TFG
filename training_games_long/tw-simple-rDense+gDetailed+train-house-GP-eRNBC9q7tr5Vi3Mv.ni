...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You are in a kitchen. An usual one.
 ...
 Look over there! a refrigerator.[if c_2 is open and there is something in the c_2] The refrigerator contains [a list of things in the c_2]. The light flickers for a second, but nothing else happens.[end if]".
...
The kitchen part 2 is some text that varies. The kitchen part 2 is " Oh wow! Is that what I think it is? It is! It's a counter. [if there is something on the s_1]On the counter you can make out [a list of things on the s_1].[end if]".
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " You make out a stove. The stove is ordinary.[if there is something on the s_2] On the stove you can see [a list of things on the s_2].[end if]".
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " Look over there! a kitchen island. The kitchen island is usual.[if there is something on the s_3] On the kitchen island you can see [a list of things on the s_3]. Now that's what I call TextWorld![end if]".
...
The kitchen part 10 is some text that varies. The kitchen part 10 is " wooden door leading west. There is an unguarded exit to the north. You don't like doors? Why not try going south, that entranceway is unguarded.".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "Well, here we are in the bedroom.
 ...
 Look out! It's a- oh, never mind, it's just a chest drawer.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0]. You can't wait to tell the folks at home about this![end if]".
...
The bedroom part 2 is some text that varies. The bedroom part 2 is " Were you looking for an antique trunk? Because look over there, it's an antique trunk.[if c_1 is open and there is something in the c_1] The antique trunk contains [a list of things in the c_1].[end if]".
...
The bedroom part 4 is some text that varies. The bedroom part 4 is " You can see a king-size bed. What a coincidence, weren't you just thinking about a king-size bed? [if there is something on the s_0]On the king-size bed you can see [a list of things on the s_0]. Hmmm... what else, what else?[end if]".
The bedroom part 5 is some text that varies. The bedroom part 5 is "[if there is nothing on the s_0]But oh no! there's nothing on this piece of garbage. Hopefully this doesn't make you too upset.[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You bend down to tie your shoe. When you stand up, you notice a bbq. The bbq is usual.[if there is something on the s_8] On the bbq you can make out [a list of things on the s_8]. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You can see a patio table. The patio table is standard.[if there is something on the s_9] On the patio table you can see [a list of things on the s_9].[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "Look around you. Take it all in. It's not every day someone gets to be in a living room.
 ...
 You can make out a couch. The couch is ordinary.[if there is something on the s_5] On the couch you can make out [a list of things on the s_5]. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
The living room part 1 is some text that varies. The living room part 1 is "[if there is nothing on the s_5] Unfortunately, there isn't a thing on it. You swear loudly.[end if]".
The living room part 2 is some text that varies. The living room part 2 is " You see a low table. [if there is something on the s_6]On the low table you can make out [a list of things on the s_6].[end if]".
...
The living room part 5 is some text that varies. The living room part 5 is "[if there is nothing on the s_7]Unfortunately, there isn't a thing on it. You move on, clearly upset with TextWorld.[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You're not going to believe this, but you've just entered a bathroom. You begin to take stock of what's in the room.

 You can make out a toilet. Wow, isn't TextWorld just the best?[if c_3 is open and there is something in the c_3] The toilet contains [a list of things in the c_3].[end if]".
...
The bathroom part 4 is some text that varies. The bathroom part 4 is " You see a gleam over in a corner, where you can see a sink. [if there is something on the s_4]On the sink you see [a list of things on the s_4].[end if]".
...
The c_4 is in r_3.
The c_4 is closed.
The description of f_3 is "The bell pepper looks appealing.".
...
The f_3 is in r_5.
The f_3 is edible.
The description of f_4 is "that's an ordinary lettuce!".
...
The description of f_2 is "The milk looks delicious.".
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is how to play! First thing I need you to do is to ensure that the antique trunk is open. After that, take the old key from the antique trunk.".
The objective part 1 is some text that varies. The objective part 1 is " After that, make sure that the wooden door is unlocked with the old key. Then, ensure that the wooden door within the bedroom is open. Then, move east. And then, make an attempt to venture south. And".
The objective part 2 is some text that varies. The objective part 2 is " then, pick up the milk from the couch. After that, move north. And then, place the milk on the stove within the kitchen. Alright, thanks!".
