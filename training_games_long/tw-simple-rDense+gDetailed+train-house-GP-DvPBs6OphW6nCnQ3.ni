...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an fast paced round of TextWorld? You do! Here is how to play! First step, doublecheck that the antique trunk is open. After that, pick up the ".
The objective part 1 is some text that varies. The objective part 1 is "old key from the antique trunk. And then, unlock the wooden door inside the bedroom. After that, ensure that the wooden door is open. Then, travel east. Okay, and then, make absolutely sure that the r".
The objective part 2 is some text that varies. The objective part 2 is "efrigerator is open. After that, recover the tomato plant from the refrigerator. And then, put the tomato plant on the stove. Once that's all handled, you can stop!".
