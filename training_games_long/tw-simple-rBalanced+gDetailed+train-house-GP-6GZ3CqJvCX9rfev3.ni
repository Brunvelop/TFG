...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First of all, you could, like, doublecheck that the antique trunk inside the bedroom is opened. And then".
The objective part 1 is some text that varies. The objective part 1 is ", pick up the old key from the antique trunk. After that, doublecheck that the wooden door is unlocked. And then, look and see that the wooden door is wide open. Then, move east. Then, open the screen".
The objective part 2 is some text that varies. The objective part 2 is " door. After pulling open the screen door, go east. And then, take a trip south. And then, retrieve the apple from the floor of the garden. After that, head north. And then, try to head west. And then".
The objective part 3 is some text that varies. The objective part 3 is ", sit the apple on the stove within the kitchen. Once that's all handled, you can stop!".
