...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Your first objective is to open the antique trunk. And then, recover the old key from the antique".
The objective part 1 is some text that varies. The objective part 1 is " trunk. After that, doublecheck that the wooden door within the bedroom is unlocked with the old key. After unlocking the wooden door, assure that the wooden door within the bedroom is open. After you".
The objective part 2 is some text that varies. The objective part 2 is " have opened the wooden door, attempt to take a trip east. Once you accomplish that, open the screen door in the kitchen. And then, make an effort to travel east. And then, try to go south. With that ".
The objective part 3 is some text that varies. The objective part 3 is "over with, lift the milk from the floor of the garden. Then, attempt to move north. And then, attempt to go to the west. And then, sit the milk on the stove inside the kitchen. Once that's all handled".
