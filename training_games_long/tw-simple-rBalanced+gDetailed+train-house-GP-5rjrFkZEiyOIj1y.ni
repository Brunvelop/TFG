...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is how to play! First step, ensure that the antique trunk is open. If you have opened the antique trunk, re".
The objective part 1 is some text that varies. The objective part 1 is "trieve the old key from the antique trunk in the bedroom. After that, check that the wooden door inside the bedroom is unlocked with the old key. Then, make absolutely sure that the wooden door in the".
The objective part 2 is some text that varies. The objective part 2 is " bedroom is opened. And then, attempt to go east. Okay, and then, open the refrigerator within the kitchen. After opening the refrigerator, retrieve the bell pepper from the refrigerator within the ki".
The objective part 3 is some text that varies. The objective part 3 is "tchen. Then, sit the bell pepper on the stove. Alright, thanks!".
