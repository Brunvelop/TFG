...
The kitchen part 0 is some text that varies. The kitchen part 0 is "I am sorry to announce that you are now in the kitchen.
 ...
 You scan the room, seeing a refrigerator.[if c_2 is open and there is something in the c_2] The refrigerator contains [a list of things in the c_2]. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
...
The kitchen part 2 is some text that varies. The kitchen part 2 is " You scan the room, seeing a counter. The counter is normal.[if there is something on the s_1] On the counter you see [a list of things on the s_1]. I mean, just wow! Isn't TextWorld just the best?[end if]".
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " Oh, great. Here's a stove. Why don't you take a picture of it, it'll last longer! [if there is something on the s_2]On the stove you can see [a list of things on the s_2].[end if]".
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " You make out a kitchen island. I guess it's true what they say, if you're looking for a kitchen island, go to TextWorld. [if there is something on the s_3]You see [a list of things on the s_3] on the kitchen island.[end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is "[if there is nothing on the s_3]Looks like someone's already been here and taken everything off it, though. Oh! Why couldn't there just be stuff on it?[end if]".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " You can make out a king-size bed. You wonder idly who left that here. [if there is something on the s_0]You see [a list of things on the s_0] on the king-size bed.[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You've just shown up in a backyard.
 ...
 You scan the room for a set of chairs, and you find a set of chairs. The set of chairs is typical.[if there is something on the s_10] On the set of chairs you make out [a list of things on the s_10].[end if]".
The backyard part 1 is some text that varies. The backyard part 1 is "[if there is nothing on the s_10] But oh no! there's nothing on this piece of junk.[end if]".
The backyard part 2 is some text that varies. The backyard part 2 is " You can make out a bbq. The bbq is normal.[if there is something on the s_8] On the bbq you can make out [a list of things on the s_8]. Wow! Just like in the movies![end if]".
...
The living room part 1 is some text that varies. The living room part 1 is "[if there is nothing on the s_5]But the thing is empty. Oh! Why couldn't there just be stuff on it?[end if]".
The living room part 2 is some text that varies. The living room part 2 is " You bend down to tie your shoe. When you stand up, you notice a low table. The low table is ordinary.[if there is something on the s_6] On the low table you see [a list of things on the s_6].[end if]".
...
The bathroom part 3 is some text that varies. The bathroom part 3 is " Look over there! a bath.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4].[end if]".
...
The bathroom part 5 is some text that varies. The bathroom part 5 is " You make out a sink. The sink is typical.[if there is something on the s_4] On the sink you can make out [a list of things on the s_4].[end if]".
...
The garden part 0 is some text that varies. The garden part 0 is "A crooked placard tells you that you are now in the garden. You begin looking for stuff.
...
The description of f_1 is "that's a standard tomato plant!".
...
The description of f_2 is "that's a typical apple!".
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First off, if it's not too much trouble, I need you to ensure that the chest drawer in the bedroom is op".
The objective part 1 is some text that varies. The objective part 1 is "en. After pulling open the chest drawer, take the old key from the chest drawer inside the bedroom. With the old key, assure that the wooden door is unlocked. Then, doublecheck that the wooden door in".
The objective part 2 is some text that varies. The objective part 2 is "side the bedroom is ajar. After that, take a trip east. Following that, ensure that the refrigerator in the kitchen is open. After that, retrieve the tomato plant from the refrigerator inside the kitc".
The objective part 3 is some text that varies. The objective part 3 is "hen. Then, rest the tomato plant on the stove. Once that's all handled, you can stop!".
