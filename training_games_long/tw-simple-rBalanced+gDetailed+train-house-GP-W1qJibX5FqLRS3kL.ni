...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! First off, open the antique trunk. After that, recover the old key from the antique trunk. And then, make it so that the wooden door is unlocked with the old key. After that, ope".
The objective part 1 is some text that varies. The objective part 1 is "n the wooden door. And then, try to go to the east. Following that, doublecheck that the refrigerator is wide open. After that, retrieve the bell pepper from the refrigerator. And then, place the bell".
The objective part 2 is some text that varies. The objective part 2 is " pepper on the stove inside the kitchen. That's it!".
