...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You find yourself in a kitchen.
 ...
 You can see a refrigerator.[if c_2 is open and there is something in the c_2] The refrigerator contains [a list of things in the c_2]. Classic TextWorld.[end if]".
...
The kitchen part 3 is some text that varies. The kitchen part 3 is "[if there is nothing on the s_1]But oh no! there's nothing on this piece of trash.[end if]".
The kitchen part 4 is some text that varies. The kitchen part 4 is " As if things weren't amazing enough already, you can even see a stove. The stove is ordinary.[if there is something on the s_2] On the stove you see [a list of things on the s_2]. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " You can see a kitchen island. The kitchen island is usual.[if there is something on the s_3] On the kitchen island you see [a list of things on the s_3].[end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is "[if there is nothing on the s_3] Looks like someone's already been here and taken everything off it, though. Hm. Oh well[end if]".
...
The kitchen part 10 is some text that varies. The kitchen part 10 is " wooden door leading west. You don't like doors? Why not try going north, that entranceway is unguarded. There is an unblocked exit to the south.".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You find yourself in a bedroom. An usual one. You begin to take stock of what's in the room.
...
The bedroom part 4 is some text that varies. The bedroom part 4 is " antique trunk.[if c_1 is open and there is something in the c_1] The antique trunk contains [a list of things in the c_1]. There's something strange about this thing being here, but you don't have time to worry about that now.[end if]".
...
The bedroom part 6 is some text that varies. The bedroom part 6 is " You can see a king-size bed. [if there is something on the s_0]On the king-size bed you can see [a list of things on the s_0].[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "Guess what, you are in a place we're calling a backyard. You try to gain information on your surroundings by using a technique you call 'looking.'

 Were you looking for a set of chairs? Because look over there, it's a set of chairs. [if there is something on the s_10]You see [a list of things on the s_10] on the set of chairs.[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You can see a bbq. The bbq is typical.[if there is something on the s_8] On the bbq you see [a list of things on the s_8].[end if]".
The backyard part 3 is some text that varies. The backyard part 3 is "[if there is nothing on the s_8] However, the bbq, like an empty bbq, has nothing on it. Aw, here you were, all excited for there to be things on it![end if]".
The backyard part 4 is some text that varies. The backyard part 4 is " You can make out a patio table. The patio table is ordinary.[if there is something on the s_9] On the patio table you see [a list of things on the s_9].[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You've just shown up in a living room.
 ...
 You see a couch. The couch is typical.[if there is something on the s_5] On the couch you can see [a list of things on the s_5].[end if]".
...
The living room part 2 is some text that varies. The living room part 2 is " You make out a low table. The low table is usual.[if there is something on the s_6] On the low table you can make out [a list of things on the s_6].[end if]".
The living room part 3 is some text that varies. The living room part 3 is "[if there is nothing on the s_6] But the thing is empty. Sometimes, just sometimes, TextWorld can just be the worst.[end if]".
The living room part 4 is some text that varies. The living room part 4 is " You see a tv. [if there is something on the s_7]On the tv you make out [a list of things on the s_7].[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You're now in the bathroom. You start to take note of what's in the room.
 ...
 You can see a toilet.[if c_3 is open and there is something in the c_3] The toilet contains [a list of things in the c_3].[end if]".
...
The bathroom part 2 is some text that varies. The bathroom part 2 is " You scan the room for a bath, and you find a bath. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4]. You can't wait to tell the folks at home about this![end if]".
...
The bathroom part 4 is some text that varies. The bathroom part 4 is " If you haven't noticed it already, there seems to be something there by the wall, it's a sink. The sink is standard.[if there is something on the s_4] On the sink you make out [a list of things on the s_4].[end if]".
...
The description of d_0 is "The wooden door looks imposing. [if open]It is open.[else if closed]It is closed.[otherwise]It is locked.[end if]".
...
The s_9 is in r_4.
The description of f_0 is "that's an usual tomato plant!".
...
The description of f_1 is "that's an usual lettuce!".
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First of all, you could, like, ensure that the antique trunk is open. Then, pick up the old key from the".
The objective part 1 is some text that varies. The objective part 1 is " antique trunk. After that, insert the old key into the wooden door inside the bedroom's lock to unlock it. And then, ensure that the wooden door is open. Then, try to head east. And then, ensure that".
The objective part 2 is some text that varies. The objective part 2 is " the screen door within the kitchen is open. Having pulled open the screen door, make an effort to travel east. And then, go south. With that accomplished, recover the half of a bag of chips from the ".
The objective part 3 is some text that varies. The objective part 3 is "floor of the garden. And then, venture north. Following that, travel west. With that over with, rest the half of a bag of chips on the stove within the kitchen. Got that? Good!".
