...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You're now in a kitchen.
 ...
 You make out a refrigerator. Hmm. You always thought you'd be more excited to see a refrigerator in a room.[if c_2 is open and there is something in the c_2] The refrigerator contains [a list of things in the c_2].[end if]".
...
The kitchen part 2 is some text that varies. The kitchen part 2 is " You can make out a counter. There's something about an object in a room that's just so... TextWorld. The counter is usual.[if there is something on the s_1] On the counter you can make out [a list of things on the s_1].[end if]".
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " You make out a stove. Wow, isn't TextWorld just the best? The stove is normal.[if there is something on the s_2] On the stove you can make out [a list of things on the s_2].[end if]".
The kitchen part 5 is some text that varies. The kitchen part 5 is "[if there is nothing on the s_2] But oh no! there's nothing on this piece of trash. This always happens, here in TextWorld![end if]".
...
The kitchen part 7 is some text that varies. The kitchen part 7 is "[if there is nothing on the s_3] However, the kitchen island, like an empty kitchen island, has nothing on it.[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You've just sauntered into a bedroom.
 ...
 You make out a chest drawer. Something scurries by right in the corner of your eye. Probably nothing.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0]. There's something strange about this being here, but you can't put your finger on it.[end if]".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a king-size bed. The king-size bed is usual.[if there is something on the s_0] On the king-size bed you see [a list of things on the s_0].[end if]".
The bedroom part 6 is some text that varies. The bedroom part 6 is "[if there is nothing on the s_0] Looks like someone's already been here and taken everything off it, though.[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You arrive in a backyard. A standard one.
 ...
 You make out a set of chairs. Now why would someone leave that there? The set of chairs is standard.[if there is something on the s_10] On the set of chairs you make out [a list of things on the s_10]. Huh, weird.[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " If you haven't noticed it already, there seems to be something there by the wall, it's a bbq. The bbq is normal.[if there is something on the s_8] On the bbq you make out [a list of things on the s_8].[end if]".
The backyard part 3 is some text that varies. The backyard part 3 is "[if there is nothing on the s_8] But oh no! there's nothing on this piece of trash. Oh! Why couldn't there just be stuff on it?[end if]".
The backyard part 4 is some text that varies. The backyard part 4 is " You make out a patio table. The patio table is typical.[if there is something on the s_9] On the patio table you can make out [a list of things on the s_9].[end if]".
The backyard part 5 is some text that varies. The backyard part 5 is "[if there is nothing on the s_9] Unfortunately, there isn't a thing on it. Sometimes, just sometimes, TextWorld can just be the worst.[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "Look around you. Take it all in. It's not every day someone gets to be in a living room. Let's see what's in here.

 Look over there! a couch. The couch is standard.[if there is something on the s_5] On the couch you can make out [a list of things on the s_5].[end if]".
The living room part 1 is some text that varies. The living room part 1 is "[if there is nothing on the s_5] But the thing hasn't got anything on it. What, you think everything in TextWorld should have stuff on it?[end if]".
The living room part 2 is some text that varies. The living room part 2 is " You smell an awful smell, and follow it to a low table. [if there is something on the s_6]You see [a list of things on the s_6] on the low table.[end if]".
...
The living room part 5 is some text that varies. The living room part 5 is "[if there is nothing on the s_7]Unfortunately, there isn't a thing on it. Aw, here you were, all excited for there to be things on it![end if]".
...
The bathroom part 3 is some text that varies. The bathroom part 3 is " You make out a bath.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4].[end if]".
...
The garden part 0 is some text that varies. The garden part 0 is "You are in a typical kind of place. That is to say, you're in a garden.
...
The description of d_0 is "The wooden door looks noble. [if open]It is open.[else if closed]It is closed.[otherwise]It is locked.[end if]".
The printed name of d_0 is "wooden door".
Understand "wooden door" as d_0.
Understand "wooden" as d_0.
Understand "door" as d_0.
The d_0 is locked.
The description of d_1 is "it's a rugged screen door [if open]You can see inside it.[else if closed]You can't see inside it because the lid's in your way.[otherwise]There is a lock on it.[end if]".
...
The f_3 is in r_5.
The f_3 is edible.
The description of f_4 is "that's a typical bell pepper!".
...
The f_4 is in r_5.
The f_4 is edible.
The description of f_5 is "that's a typical lettuce!".
...
The description of f_2 is "that's a typical tomato plant!".
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Here is your task for today. First stop, make absolutely sure that the chest drawer is wide open.".
The objective part 1 is some text that varies. The objective part 1 is " After pulling open the chest drawer, retrieve the old key from the chest drawer in the bedroom. Then, assure that the wooden door in the bedroom is unlocked. After that, doublecheck that the wooden d".
The objective part 2 is some text that varies. The objective part 2 is "oor within the bedroom is opened. And then, head east. With that accomplished, open the refrigerator. After pulling open the refrigerator, recover the milk from the refrigerator in the kitchen. And th".
The objective part 3 is some text that varies. The objective part 3 is "en, place the milk on the stove within the kitchen. Got that? Good!".
