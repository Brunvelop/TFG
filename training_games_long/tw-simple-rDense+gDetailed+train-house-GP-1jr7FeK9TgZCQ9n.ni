...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First of all, make it so that the antique trunk in the bedroom is wide open. And then, recover the old k".
The objective part 1 is some text that varies. The objective part 1 is "ey from the antique trunk. Then, unlock the wooden door. After that, open the wooden door inside the bedroom. After opening the wooden door, venture east. Next, make absolutely sure that the screen do".
The objective part 2 is some text that varies. The objective part 2 is "or within the kitchen is wide open. And then, head east. Then, take a trip south. And then, retrieve the apple from the floor of the garden. Then, make an attempt to head north. Once you get through w".
The objective part 3 is some text that varies. The objective part 3 is "ith that, make an attempt to venture west. That done, sit the apple on the stove within the kitchen. Alright, thanks!".
