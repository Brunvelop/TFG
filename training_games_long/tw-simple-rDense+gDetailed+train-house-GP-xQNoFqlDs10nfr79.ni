...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Here is your task for today. First of all, you could, like, ensure that the antique trunk is open".
The objective part 1 is some text that varies. The objective part 1 is ". After pulling open the antique trunk, take the old key from the antique trunk inside the bedroom. Then, insert the old key into the wooden door inside the bedroom's lock to unlock it. After that, en".
The objective part 2 is some text that varies. The objective part 2 is "sure that the wooden door is open. And then, make an effort to move east. After that, ensure that the refrigerator inside the kitchen is open. After that, recover the lettuce from the refrigerator ins".
The objective part 3 is some text that varies. The objective part 3 is "ide the kitchen. After that, place the lettuce on the stove in the kitchen. And if you do that, you're the winner!".
