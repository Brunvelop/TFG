...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a fast paced game of TextWorld! First stop, open the chest drawer within the bedroom. And then, pick up the old key from the chest drawer. With the old key, look and see that the w".
The objective part 1 is some text that varies. The objective part 1 is "ooden door inside the bedroom is unlocked. After that, open the wooden door in the bedroom. After pulling open the wooden door, try to move east. Following that, open the refrigerator. Then, take the ".
The objective part 2 is some text that varies. The objective part 2 is "lettuce from the refrigerator. Having got the lettuce, sit the lettuce on the stove within the kitchen. Alright, thanks!".
