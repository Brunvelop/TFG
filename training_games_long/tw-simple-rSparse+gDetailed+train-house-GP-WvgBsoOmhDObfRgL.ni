...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! First of all, you could, like, look and see that the chest drawer is opened. Then, retrieve the old key from the chest drawer. Having got the old k".
The objective part 1 is some text that varies. The objective part 1 is "ey, insert the old key into the wooden door's lock to unlock it. And then, ensure that the wooden door is open. And then, make an attempt to take a trip east. With that accomplished, ensure that the r".
The objective part 2 is some text that varies. The objective part 2 is "efrigerator within the kitchen is open. Then, pick up the tomato plant from the refrigerator. Then, put the tomato plant on the stove. Got that? Good!".
