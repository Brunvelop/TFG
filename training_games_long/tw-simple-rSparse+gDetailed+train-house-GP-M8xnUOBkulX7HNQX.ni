...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First of all, assure that the chest drawer is open. And then, take the old key from the chest drawer ins".
The objective part 1 is some text that varies. The objective part 1 is "ide the bedroom. After that, unlock the wooden door. And then, doublecheck that the wooden door in the bedroom is opened. After that, head east. Then, make sure that the screen door within the kitchen".
The objective part 2 is some text that varies. The objective part 2 is " is wide open. And then, head east. Then, venture south. Then, retrieve the milk from the floor of the garden. After stealing the milk, make an effort to travel north. Then, move west. Following that,".
The objective part 3 is some text that varies. The objective part 3 is " place the milk on the stove inside the kitchen. And once you've done that, you win!".
