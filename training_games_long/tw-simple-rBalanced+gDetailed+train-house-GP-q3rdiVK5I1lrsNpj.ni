...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! First step, open the antique trunk. And then, recover the old key from the antique trunk. And the".
The objective part 1 is some text that varies. The objective part 1 is "n, make absolutely sure that the wooden door is unlocked. After that, ensure that the wooden door in the bedroom is open. After you have opened the wooden door, take a trip east. Following that, doubl".
The objective part 2 is some text that varies. The objective part 2 is "echeck that the screen door within the kitchen is opened. Then, make an attempt to move east. Then, move south. After that, pick up the half of a bag of chips from the floor of the garden. Then, make ".
The objective part 3 is some text that varies. The objective part 3 is "an attempt to move north. With that over with, make an attempt to head west. Then, place the half of a bag of chips on the stove within the kitchen. Alright, thanks!".
