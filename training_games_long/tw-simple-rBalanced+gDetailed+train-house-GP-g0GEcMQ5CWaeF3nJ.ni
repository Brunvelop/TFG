...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Here is your task for today. First, it would be fantastic if you could assure that the chest draw".
The objective part 1 is some text that varies. The objective part 1 is "er is wide open. If you have opened the chest drawer, pick up the old key from the chest drawer inside the bedroom. If you can get your hands on the old key, check that the wooden door within the bedr".
The objective part 2 is some text that varies. The objective part 2 is "oom is unlocked with the old key. And then, open the wooden door inside the bedroom. Then, attempt to move east. Then, make it so that the screen door is wide open. And then, try to venture east. And ".
The objective part 3 is some text that varies. The objective part 3 is "then, go south. And then, pick-up the lettuce from the floor of the garden. If you have got the lettuce, go to the north. After that, make an attempt to travel west. With that done, rest the lettuce o".
The objective part 4 is some text that varies. The objective part 4 is "n the stove in the kitchen. And once you've done that, you win!".
