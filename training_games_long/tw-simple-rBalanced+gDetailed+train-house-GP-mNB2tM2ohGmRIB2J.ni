...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! First thing I need you to do is to make it so that the antique trunk in the bedroom is open. After that, recover the old key from the antique trunk. And then, unlock the wooden d".
The objective part 1 is some text that varies. The objective part 1 is "oor with the old key. And then, ensure that the wooden door in the bedroom is open. Then, head east. With that over with, ensure that the refrigerator is open. And then, take the milk from the refrige".
The objective part 2 is some text that varies. The objective part 2 is "rator in the kitchen. Then, put the milk on the stove. Once that's all handled, you can stop!".
