...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First thing I need you to do is to assure that the chest drawer is wide open. And then, retrieve the old".
The objective part 1 is some text that varies. The objective part 1 is " key from the chest drawer in the bedroom. After stealing the old key, assure that the wooden door is unlocked. After that, make absolutely sure that the wooden door is open. After you have opened the".
The objective part 2 is some text that varies. The objective part 2 is " wooden door, take a trip east. Then, open the screen door. After that, take a trip east. Then, move south. If you can get through with that, retrieve the tomato plant from the floor of the garden. An".
The objective part 3 is some text that varies. The objective part 3 is "d then, try to venture north. Then, move west. Then, rest the tomato plant on the stove within the kitchen. And once you've done that, you win!".
