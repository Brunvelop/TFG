...
The kitchen part 1 is some text that varies. The kitchen part 1 is " refrigerator, which looks usual, in the room.[if c_2 is open and there is something in the c_2] The refrigerator contains [a list of things in the c_2]. Make a note of this, you might have to put stuff on or in it later on.[end if]".
...
The kitchen part 3 is some text that varies. The kitchen part 3 is " You can see a counter. The counter is ordinary.[if there is something on the s_1] On the counter you make out [a list of things on the s_1]. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
The kitchen part 4 is some text that varies. The kitchen part 4 is "[if there is nothing on the s_1] But oh no! there's nothing on this piece of junk. What, you think everything in TextWorld should have stuff on it?[end if]".
The kitchen part 5 is some text that varies. The kitchen part 5 is " You can make out a stove. The stove is standard.[if there is something on the s_2] On the stove you make out [a list of things on the s_2].[end if]".
The kitchen part 6 is some text that varies. The kitchen part 6 is "[if there is nothing on the s_2] Unfortunately, there isn't a thing on it. This always happens![end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is " You make out a kitchen island. The kitchen island is normal.[if there is something on the s_3] On the kitchen island you make out [a list of things on the s_3].[end if]".
The kitchen part 8 is some text that varies. The kitchen part 8 is "[if there is nothing on the s_3] However, the kitchen island, like an empty kitchen island, has nothing on it. You think about smashing the kitchen island to bits, throwing the bits into a pit, etc, until you get bored.[end if]".
...
The kitchen part 11 is some text that varies. The kitchen part 11 is " wooden door leading west. You don't like doors? Why not try going north, that entranceway is unguarded. You don't like doors? Why not try going south, that entranceway is unguarded.".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "Look around you. Take it all in. It's not every day someone gets to be in a bedroom.
 ...
 You can see a chest drawer. Now that's what I call TextWorld![if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0].[end if]".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " You can make out a king-size bed. Now why would someone leave that there? The king-size bed is ordinary.[if there is something on the s_0] On the king-size bed you make out [a list of things on the s_0].[end if]".
The bedroom part 6 is some text that varies. The bedroom part 6 is "[if there is nothing on the s_0] But there isn't a thing on it. This always happens, here in TextWorld![end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You arrive in a backyard. A normal one.
 ...
 You rest your hand against a wall, but you miss the wall and fall onto a set of chairs. The set of chairs is standard.[if there is something on the s_10] On the set of chairs you see [a list of things on the s_10].[end if]".
The backyard part 1 is some text that varies. The backyard part 1 is "[if there is nothing on the s_10] But oh no! there's nothing on this piece of trash.[end if]".
The backyard part 2 is some text that varies. The backyard part 2 is " You see a bbq. I guess it's true what they say, if you're looking for a bbq, go to TextWorld. The bbq is ordinary.[if there is something on the s_8] On the bbq you see [a list of things on the s_8].[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You can make out a patio table. Wow, isn't TextWorld just the best? [if there is something on the s_9]You see [a list of things on the s_9] on the patio table.[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You are in a living room. An ordinary kind of place.
 ...
 You can make out a couch. The couch is typical.[if there is something on the s_5] On the couch you see [a list of things on the s_5].[end if]".
...
The living room part 2 is some text that varies. The living room part 2 is " You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a low table. The low table is normal.[if there is something on the s_6] On the low table you make out [a list of things on the s_6], so there's that.[end if]".
...
The living room part 4 is some text that varies. The living room part 4 is " You can see a tv. I guess it's true what they say, if you're looking for a tv, go to TextWorld. [if there is something on the s_7]You see [a list of things on the s_7] on the tv.[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "I am required to announce that you are now in the bathroom. You decide to start listing off everything you see in the room, as if you were in a text adventure.

 You can make out a toilet.[if c_3 is open and there is something in the c_3] The toilet contains [a list of things in the c_3]. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
...
The bathroom part 2 is some text that varies. The bathroom part 2 is " You can make out a bath.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4]. Now why would someone leave that there?[end if]".
...
The bathroom part 4 is some text that varies. The bathroom part 4 is " Oh, great. Here's a sink. [if there is something on the s_4]On the sink you see [a list of things on the s_4].[end if]".
The bathroom part 5 is some text that varies. The bathroom part 5 is "[if there is nothing on the s_4]But the thing hasn't got anything on it. This always happens![end if]".
...
The garden part 0 is some text that varies. The garden part 0 is "A crooked sign tells you that you are now in the garden.
...
The description of f_2 is "The apple looks tantalizing.".
...
The description of o_2 is "The remote is clean.".
...
Test quest6_0 with "open chest drawer / take old key from chest drawer / unlock wooden door with old key / open wooden door / go east / go south / take apple from couch"
...
Test quest7_0 with "open chest drawer / take old key from chest drawer / unlock wooden door with old key / open wooden door / go east / go south / take apple from couch / go north / put apple on stove"
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! First off, open the chest drawer in the bedroom. After that, recover the old key from the chest d".
The objective part 1 is some text that varies. The objective part 1 is "rawer in the bedroom. After that, make it so that the wooden door inside the bedroom is unlocked with the old key. Then, doublecheck that the wooden door is opened. And then, take a trip east. And the".
The objective part 2 is some text that varies. The objective part 2 is "n, try to travel south. After that, take the apple from the couch within the living room. After taking the apple, take a trip north. After that, place the apple on the stove. Once that's all handled, ".
