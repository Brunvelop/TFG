...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! First off, ensure that the chest drawer within the bedroom is open. After that, take the old key from the chest drawer in the bedroom. After that, unlock the wooden door within t".
The objective part 1 is some text that varies. The objective part 1 is "he bedroom. After that, open the wooden door. Then, try to take a trip east. Then, make sure that the screen door is wide open. And then, make an effort to head east. Then, venture south. And then, pi".
The objective part 2 is some text that varies. The objective part 2 is "ck-up the milk from the floor of the garden. And then, head north. And then, go to the west. Then, sit the milk on the stove in the kitchen. And if you do that, you're the winner!".
