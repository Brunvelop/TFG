...
Test quest8_0 with "open antique trunk / take old key from antique trunk / unlock wooden door with old key / open wooden door / go east / open screen door / go east / go south / take lettuce"
...
Test quest9_0 with "open antique trunk / take old key from antique trunk / unlock wooden door with old key / open wooden door / go east / open screen door / go east / go south / take lettuce / go north / go west / put lettuce on stove"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a life changing round of TextWorld! Here is your task for today. Your first objective is to open the antique trunk. And then, pick up the old key from the antique trunk. After that".
The objective part 1 is some text that varies. The objective part 1 is ", unlock the wooden door within the bedroom with the old key. And then, open the wooden door in the bedroom. Then, attempt to travel east. Once you succeed at that, open the screen door in the kitchen".
The objective part 2 is some text that varies. The objective part 2 is ". After pulling open the screen door, go to the east. And then, take a trip south. And then, lift the lettuce from the floor of the garden. And then, head north. And then, travel west. After that, pla".
The objective part 3 is some text that varies. The objective part 3 is "ce the lettuce on the stove within the kitchen. Alright, thanks!".
