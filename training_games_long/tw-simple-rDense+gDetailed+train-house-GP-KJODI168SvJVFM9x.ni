...
The objective part 2 is some text that varies. The objective part 2 is "he kitchen is open. Once you have opened the screen door, make an effort to go to the east. After that, try to go to the south. After that, retrieve the milk from the floor of the garden. And then, tr".
The objective part 3 is some text that varies. The objective part 3 is "y to move north. Once you succeed at that, try to take a trip west. And then, rest the milk on the stove. That's it!".
