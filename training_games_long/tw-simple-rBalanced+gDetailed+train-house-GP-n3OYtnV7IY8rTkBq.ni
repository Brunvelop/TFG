...
The kitchen part 2 is some text that varies. The kitchen part 2 is " You see a counter. [if there is something on the s_1]On the counter you see [a list of things on the s_1].[end if]".
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " You can make out a stove. The stove is normal.[if there is something on the s_2] On the stove you see [a list of things on the s_2].[end if]".
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " You make out a kitchen island. The kitchen island is usual.[if there is something on the s_3] On the kitchen island you make out [a list of things on the s_3].[end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is "[if there is nothing on the s_3] But the thing hasn't got anything on it. Aw, and here you were, all excited for there to be things on it![end if]".
...
The bedroom part 3 is some text that varies. The bedroom part 3 is " antique trunk, which looks typical, is in the room.[if c_1 is open and there is something in the c_1] The antique trunk contains [a list of things in the c_1].[end if]".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " Oh, great. Here's a king-size bed. The king-size bed is typical.[if there is something on the s_0] On the king-size bed you make out [a list of things on the s_0].[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You've seen better backyards, but at least this one seems pretty typical. You decide to just list off a complete list of everything you see in the room, because hey, why not?

 Hey, want to see a set of chairs? Look over there, a set of chairs. The set of chairs is normal.[if there is something on the s_10] On the set of chairs you can see [a list of things on the s_10]. You can't wait to tell the folks at home about this![end if]".
The backyard part 1 is some text that varies. The backyard part 1 is "[if there is nothing on the s_10] But there isn't a thing on it. You make a mental note to not get your hopes up the next time you see a set of chairs in a room.[end if]".
The backyard part 2 is some text that varies. The backyard part 2 is " You make out a bbq. [if there is something on the s_8]On the bbq you can see [a list of things on the s_8]. I mean, just wow! Isn't TextWorld just the best?[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a patio table. [if there is something on the s_9]On the patio table you make out [a list of things on the s_9].[end if]".
The backyard part 5 is some text that varies. The backyard part 5 is "[if there is nothing on the s_9]Unfortunately, there isn't a thing on it. Aw, here you were, all excited for there to be things on it![end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "Fancy seeing you here. Here, by the way, being the living room. You decide to just list off a complete list of everything you see in the room, because hey, why not?

 You can see a couch. [if there is something on the s_5]You see [a list of things on the s_5] on the couch.[end if]".
The living room part 1 is some text that varies. The living room part 1 is "[if there is nothing on the s_5]But the thing hasn't got anything on it. This always happens![end if]".
The living room part 2 is some text that varies. The living room part 2 is " You make out a low table. [if there is something on the s_6]On the low table you make out [a list of things on the s_6].[end if]".
...
The living room part 4 is some text that varies. The living room part 4 is " You scan the room, seeing a tv. The tv is usual.[if there is something on the s_7] On the tv you can make out [a list of things on the s_7].[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You find yourself in a bathroom. An ordinary one. The room is well lit.

 You make out a toilet. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[if c_3 is open and there is something in the c_3] The toilet contains [a list of things in the c_3]. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
...
The bathroom part 5 is some text that varies. The bathroom part 5 is " You rest your hand against a wall, but you miss the wall and fall onto a sink. The sink is standard.[if there is something on the s_4] On the sink you make out [a list of things on the s_4]. It doesn't get more TextWorld than this![end if]".
...
The f_3 is in r_5.
The f_3 is edible.
The description of f_4 is "The milk looks tasty.".
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. Your first objective is to ensure that the chest drawer in the bedroom is open. Then, take the old key f".
The objective part 1 is some text that varies. The objective part 1 is "rom the chest drawer. And then, unlock the wooden door. And then, open the wooden door inside the bedroom. Once you have pulled open the wooden door, make an attempt to head east. And then, open the r".
The objective part 2 is some text that varies. The objective part 2 is "efrigerator in the kitchen. And then, retrieve the apple from the refrigerator. After stealing the apple, rest the apple on the stove. And if you do that, you're the winner!".
