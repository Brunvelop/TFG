...
The kitchen part 0 is some text that varies. The kitchen part 0 is "Well, here we are in a kitchen.
 ...
 You scan the room for a refrigerator, and you find a refrigerator.[if c_2 is open and there is something in the c_2] The refrigerator contains [a list of things in the c_2].[end if]".
...
The kitchen part 2 is some text that varies. The kitchen part 2 is " Were you looking for a counter? Because look over there, it's a counter. You shudder, but continue examining the counter. [if there is something on the s_1]On the counter you can make out [a list of things on the s_1], so there's that.[end if]".
The kitchen part 3 is some text that varies. The kitchen part 3 is "[if there is nothing on the s_1]The counter appears to be empty. Hopefully this doesn't make you too upset.[end if]".
The kitchen part 4 is some text that varies. The kitchen part 4 is " What's that over there? It looks like it's a stove. The stove is usual.[if there is something on the s_2] On the stove you can make out [a list of things on the s_2]. There's something strange about this being here, but you can't put your finger on it.[end if]".
The kitchen part 5 is some text that varies. The kitchen part 5 is "[if there is nothing on the s_2] Looks like someone's already been here and taken everything off it, though. Hm. Oh well[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You arrive in a bedroom. An usual one.
 ...
 You make out a chest drawer, so there's that.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0]. I mean, just wow! Isn't TextWorld just the best?[end if]".
...
The bedroom part 3 is some text that varies. The bedroom part 3 is " antique trunk right there by you.[if c_1 is open and there is something in the c_1] The antique trunk contains [a list of things in the c_1].[end if]".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " Look out! It's a- oh, never mind, it's just a king-size bed. The king-size bed is standard.[if there is something on the s_0] On the king-size bed you see [a list of things on the s_0].[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " Hey, want to see a bbq? Look over there, a bbq. The bbq is ordinary.[if there is something on the s_8] On the bbq you make out [a list of things on the s_8].[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You can make out a patio table. [if there is something on the s_9]You see [a list of things on the s_9] on the patio table. I mean, just wow! Isn't TextWorld just the best?[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You find yourself in a living room. A typical one.

 You smell an interesting smell, and follow it to a couch. The couch is ordinary.[if there is something on the s_5] On the couch you can see [a list of things on the s_5]. Now that's what I call TextWorld![end if]".
...
The living room part 2 is some text that varies. The living room part 2 is " You make out a low table. [if there is something on the s_6]On the low table you see [a list of things on the s_6].[end if]".
The living room part 3 is some text that varies. The living room part 3 is "[if there is nothing on the s_6]But there isn't a thing on it. Hm. Oh well[end if]".
The living room part 4 is some text that varies. The living room part 4 is " You see a tv. You shudder, but continue examining the tv. The tv is standard.[if there is something on the s_7] On the tv you see [a list of things on the s_7].[end if]".
...
The bathroom part 5 is some text that varies. The bathroom part 5 is " As if things weren't amazing enough already, you can even see a sink. The sink is usual.[if there is something on the s_4] On the sink you can make out [a list of things on the s_4].[end if]".
...
The description of d_0 is "it's a durable wooden door [if open]You can see inside it.[else if closed]You can't see inside it because the lid's in your way.[otherwise]There is a lock on it.[end if]".
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is how to play! First of all, you could, like, open the antique trunk. Then, retrieve the old key from the antique trunk. Then, unlock the woo".
The objective part 1 is some text that varies. The objective part 1 is "den door. After that, ensure that the wooden door is open. And then, make an attempt to take a trip east. Following that, ensure that the refrigerator within the kitchen is open. Then, retrieve the le".
The objective part 2 is some text that varies. The objective part 2 is "ttuce from the refrigerator in the kitchen. And then, rest the lettuce on the stove. And once you've done that, you win!".
