...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! First stop, ensure that the chest drawer is open. After that, take the old key from the chest dra".
The objective part 1 is some text that varies. The objective part 1 is "wer in the bedroom. After that, insert the old key into the wooden door's lock to unlock it. After that, open the wooden door. After that, attempt to travel east. With that accomplished, ensure that t".
The objective part 2 is some text that varies. The objective part 2 is "he screen door is open. Then, take a trip east. Next, travel south. With that accomplished, recover the tomato plant from the floor of the garden. Then, take a trip north. Following that, travel west.".
The objective part 3 is some text that varies. The objective part 3 is " Once you get through with that, put the tomato plant on the stove. And once you've done that, you win!".
