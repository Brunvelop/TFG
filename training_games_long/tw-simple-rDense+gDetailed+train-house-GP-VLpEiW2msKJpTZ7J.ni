...
The objective part 1 is some text that varies. The objective part 1 is "e wooden door is unlocked. Then, open the wooden door. After that, attempt to move east. With that over with, open the refrigerator in the kitchen. And then, retrieve the milk from the refrigerator. T".
The objective part 2 is some text that varies. The objective part 2 is "hen, sit the milk on the stove. Got that? Good!".
