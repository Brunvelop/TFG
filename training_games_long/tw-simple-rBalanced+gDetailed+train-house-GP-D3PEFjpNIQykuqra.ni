...
The kitchen part 2 is some text that varies. The kitchen part 2 is " You make out a counter. The counter is ordinary.[if there is something on the s_1] On the counter you can see [a list of things on the s_1].[end if]".
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " Oh, great. Here's a stove. [if there is something on the s_2]On the stove you can make out [a list of things on the s_2].[end if]".
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " You see a kitchen island. [if there is something on the s_3]You see [a list of things on the s_3] on the kitchen island. Now that's what I call TextWorld![end if]".
...
The kitchen part 10 is some text that varies. The kitchen part 10 is " wooden door leading west. You need an unguarded exit? You should try going north. You don't like doors? Why not try going south, that entranceway is unguarded.".
...
The bedroom part 3 is some text that varies. The bedroom part 3 is " You hear a noise behind you and spin around, but you can't see anything other than an antique trunk.[if c_1 is open and there is something in the c_1] The antique trunk contains [a list of things in the c_1]. You check the price tag that's still affixed to the antique trunk. 50 bucks? What a deal! You'll have to ask where they got this![end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You are in a backyard. An ordinary kind of place.
 ...
 You see a set of chairs. Wow, isn't TextWorld just the best? The set of chairs is usual.[if there is something on the s_10] On the set of chairs you make out [a list of things on the s_10].[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You can see a bbq. The bbq is standard.[if there is something on the s_8] On the bbq you can see [a list of things on the s_8]. You shudder, but continue examining the room.[end if]".
The backyard part 3 is some text that varies. The backyard part 3 is "[if there is nothing on the s_8] But the thing is empty, unfortunately. It would have been so cool if there was stuff on the bbq.[end if]".
The backyard part 4 is some text that varies. The backyard part 4 is " You see a patio table. The patio table is normal.[if there is something on the s_9] On the patio table you make out [a list of things on the s_9].[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You've entered a living room. You decide to start listing off everything you see in the room, as if you were in a text adventure.
 ...
 Oh, great. Here's a couch. The couch is typical.[if there is something on the s_5] On the couch you can make out [a list of things on the s_5]. You shudder, but continue examining the room.[end if]".
...
The living room part 2 is some text that varies. The living room part 2 is " You make out a low table. [if there is something on the s_6]You see [a list of things on the s_6] on the low table.[end if]".
The living room part 3 is some text that varies. The living room part 3 is "[if there is nothing on the s_6]But the thing is empty. What's the point of an empty low table?[end if]".
The living room part 4 is some text that varies. The living room part 4 is " You can see a tv. Make a note of this, you might have to put stuff on or in it later on. [if there is something on the s_7]On the tv you can see [a list of things on the s_7]. You shudder, but continue examining the room.[end if]".
The living room part 5 is some text that varies. The living room part 5 is "[if there is nothing on the s_7]But the thing is empty, unfortunately. You think about smashing the tv to bits, throwing the bits into the garbage, etc, until you get bored.[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You've just sauntered into a bathroom.
 ...
 You can make out a toilet. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[if c_3 is open and there is something in the c_3] The toilet contains [a list of things in the c_3].[end if]".
...
The bathroom part 5 is some text that varies. The bathroom part 5 is " You rest your hand against a wall, but you miss the wall and fall onto a sink. The sink is standard.[if there is something on the s_4] On the sink you see [a list of things on the s_4].[end if]".
...
The garden part 0 is some text that varies. The garden part 0 is "You are in a garden. A typical kind of place. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The description of d_0 is "it's a robust wooden door [if open]You can see inside it.[else if closed]You can't see inside it because the lid's in your way.[otherwise]There is a lock on it.[end if]".
...
The description of f_1 is "The half of a bag of chips looks appealing.".
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Here is your task for today. Your first objective is to make absolutely sure that the antique tru".
The objective part 1 is some text that varies. The objective part 1 is "nk inside the bedroom is open. And then, pick up the old key from the antique trunk inside the bedroom. After that, check that the wooden door is unlocked with the old key. Then, make absolutely sure ".
The objective part 2 is some text that varies. The objective part 2 is "that the wooden door is opened. Having opened the wooden door, try to head east. If you can succeed at that, ensure that the screen door in the kitchen is open. Having pulled open the screen door, att".
The objective part 3 is some text that varies. The objective part 3 is "empt to go to the east. And then, try to venture south. Then, pick-up the milk from the floor of the garden. After picking up the milk, try to take a trip north. Then, go to the west. Then, put the mi".
The objective part 4 is some text that varies. The objective part 4 is "lk on the stove within the kitchen. Got that? Good!".
