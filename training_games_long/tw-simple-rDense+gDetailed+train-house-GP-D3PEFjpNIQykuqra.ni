...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First off, doublecheck that the antique trunk is opened. Then, retrieve the old key from the antique tru".
The objective part 1 is some text that varies. The objective part 1 is "nk. And then, check that the wooden door is unlocked with the old key. Then, look and see that the wooden door is wide open. If you have opened the wooden door, attempt to move east. Next, make it so ".
The objective part 2 is some text that varies. The objective part 2 is "that the screen door within the kitchen is open. Then, head east. And then, try to take a trip south. With that over with, pick-up the milk from the floor of the garden. Then, make an attempt to go no".
The objective part 3 is some text that varies. The objective part 3 is "rth. And then, try to go to the west. After that, rest the milk on the stove inside the kitchen. Got that? Good!".
