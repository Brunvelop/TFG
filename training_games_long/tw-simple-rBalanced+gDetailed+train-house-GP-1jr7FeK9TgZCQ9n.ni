...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a life changing round of TextWorld! Here is how to play! First, it would be fantastic if you could open the antique trunk. Having opened the antique trunk, recover the old key from".
The objective part 1 is some text that varies. The objective part 1 is " the antique trunk. After picking up the old key, make absolutely sure that the wooden door is unlocked with the old key. And then, ensure that the wooden door in the bedroom is open. After that, move".
The objective part 2 is some text that varies. The objective part 2 is " east. Then, open the screen door in the kitchen. After pulling open the screen door, make an effort to move east. After that, go south. If you can finish that, pick-up the apple from the floor of the".
The objective part 3 is some text that varies. The objective part 3 is " garden. And then, go to the north. Okay, and then, take a trip west. And then, put the apple on the stove. And if you do that, you're the winner!".
