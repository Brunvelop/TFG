...
Test quest0_0 with "open antique trunk / take old key from antique trunk / unlock wooden door with old key / open wooden door / go east / open screen door / go east / go south / take lettuce / go north / go west / put lettuce on stove"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! First off, if it's not too much trouble, I need you to ensure that the antique trunk within the bedroom is open. After that, pick up the old key from the antique trunk within the".
The objective part 1 is some text that varies. The objective part 1 is " bedroom. After that, unlock the wooden door in the bedroom. After that, ensure that the wooden door in the bedroom is open. Then, make an attempt to travel east. With that accomplished, ensure that t".
The objective part 2 is some text that varies. The objective part 2 is "he screen door is open. Then, move east. Then, try to head south. Next, recover the lettuce from the floor of the garden. After you have got the lettuce, head north. And then, make an attempt to move ".
The objective part 3 is some text that varies. The objective part 3 is "west. Following that, put the lettuce on the stove. That's it!".
