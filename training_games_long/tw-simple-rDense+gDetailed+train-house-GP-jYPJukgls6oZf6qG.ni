...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You arrive in a kitchen. An usual one.
 ...
 You make out a refrigerator.[if c_2 is open and there is something in the c_2] The refrigerator contains [a list of things in the c_2]. The light flickers for a second, but nothing else happens.[end if]".
...
The kitchen part 2 is some text that varies. The kitchen part 2 is " You can make out a counter. You shudder, but continue examining the counter. The counter is typical.[if there is something on the s_1] On the counter you make out [a list of things on the s_1].[end if]".
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " You make out a stove. [if there is something on the s_2]On the stove you make out [a list of things on the s_2].[end if]".
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " You can make out a kitchen island. The kitchen island is typical.[if there is something on the s_3] On the kitchen island you can make out [a list of things on the s_3].[end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is "[if there is nothing on the s_3] But the thing hasn't got anything on it. Hm. Oh well[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You've entered a bedroom.
 ...
 Hey, want to see a chest drawer? Look over there, a chest drawer.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0].[end if]".
...
The bedroom part 2 is some text that varies. The bedroom part 2 is " You can make out an antique trunk.[if c_1 is open and there is something in the c_1] The antique trunk contains [a list of things in the c_1]. Now that's what I call TextWorld![end if]".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is "[if there is nothing on the s_0]However, the king-size bed, like an empty king-size bed, has nothing on it. Hopefully, this discovery doesn't ruin your TextWorld experience![end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You find yourself in a backyard. An usual one.
 ...
 You see a set of chairs. [if there is something on the s_10]You see [a list of things on the s_10] on the set of chairs. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You make out a bbq. The bbq is normal.[if there is something on the s_8] On the bbq you can see [a list of things on the s_8].[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You smell an awful smell, and follow it to a patio table. What a coincidence, weren't you just thinking about a patio table? The patio table is usual.[if there is something on the s_9] On the patio table you see [a list of things on the s_9].[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "This might come as a shock to you, but you've just stumbled into a living room. Let's see what's in here.

 Were you looking for a couch? Because look over there, it's a couch. [if there is something on the s_5]On the couch you can make out [a list of things on the s_5]. I mean, just wow! Isn't TextWorld just the best?[end if]".
...
The living room part 2 is some text that varies. The living room part 2 is " You make out a low table. [if there is something on the s_6]On the low table you can make out [a list of things on the s_6].[end if]".
The living room part 3 is some text that varies. The living room part 3 is "[if there is nothing on the s_6]But there isn't a thing on it. What's the point of an empty low table?[end if]".
...
The living room part 5 is some text that varies. The living room part 5 is "[if there is nothing on the s_7]But the thing is empty. What, you think everything in TextWorld should have stuff on it?[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You're not going to believe this, but you've just entered a bathroom. Okay, just remember what you're here to do, and everything will go great.
 ...
 You see a toilet.[if c_3 is open and there is something in the c_3] The toilet contains [a list of things in the c_3], so there's that.[end if]".
...
The bathroom part 4 is some text that varies. The bathroom part 4 is " You see a sink. [if there is something on the s_4]You see [a list of things on the s_4] on the sink.[end if]".
...
The description of d_0 is "The wooden door looks stuffy. [if open]It is open.[else if closed]It is closed.[otherwise]It is locked.[end if]".
...
The s_9 is in r_4.
The description of f_0 is "that's an ordinary half of a bag of chips!".
...
The description of o_2 is "The remote looks well matched to everything else here".
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is how to play! First stop, make sure that the antique trunk inside the bedroom is ajar. And then, retrieve the old key from the antique trunk inside the bedroom. Then, doub".
The objective part 1 is some text that varies. The objective part 1 is "lecheck that the wooden door is unlocked with the old key. And then, ensure that the wooden door inside the bedroom is open. Then, attempt to move east. After that, go to the south. And then, retrieve".
The objective part 2 is some text that varies. The objective part 2 is " the milk from the couch inside the living room. Then, move north. Next, place the milk on the stove within the kitchen. Got that? Good!".
