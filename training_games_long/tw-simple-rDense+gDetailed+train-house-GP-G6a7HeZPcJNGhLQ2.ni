...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an exciting round of TextWorld? You do! First thing I need you to do is to ensure that the chest drawer is open. Then, retrieve the old key fro".
The objective part 1 is some text that varies. The objective part 1 is "m the chest drawer. After that, doublecheck that the wooden door within the bedroom is unlocked. Then, open the wooden door. After that, venture east. And then, open the refrigerator within the kitche".
The objective part 2 is some text that varies. The objective part 2 is "n. After that, recover the lettuce from the refrigerator inside the kitchen. After that, place the lettuce on the stove in the kitchen. That's it!".
