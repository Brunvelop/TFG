...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is your task for today. First step, open the chest drawer. After that, pick up the old key from the chest drawer in the bedroom. After you have taken the old key, check that".
The objective part 1 is some text that varies. The objective part 1 is " the wooden door is unlocked with the old key. And then, open the wooden door. And then, make an effort to head east. And then, make absolutely sure that the screen door within the kitchen is ajar. Th".
The objective part 2 is some text that varies. The objective part 2 is "en, travel east. And then, attempt to go to the south. And then, retrieve the tomato plant from the floor of the garden. Then, move north. After that, head west. And then, sit the tomato plant on the ".
The objective part 3 is some text that varies. The objective part 3 is "stove in the kitchen. And once you've done that, you win!".
