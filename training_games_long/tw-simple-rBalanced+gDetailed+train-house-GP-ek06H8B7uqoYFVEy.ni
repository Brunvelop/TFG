...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an life changing round of TextWorld? You do! Here is your task for today. First, it would be fantastic if you could open the antique trunk. Aft".
The objective part 1 is some text that varies. The objective part 1 is "er pulling open the antique trunk, pick up the old key from the antique trunk. Then, unlock the wooden door in the bedroom. After that, ensure that the wooden door is open. And then, make an attempt t".
The objective part 2 is some text that varies. The objective part 2 is "o venture east. With that accomplished, assure that the screen door is wide open. Then, try to travel east. And then, try to go to the south. Once you finish that, recover the half of a bag of chips f".
The objective part 3 is some text that varies. The objective part 3 is "rom the floor of the garden. And then, head north. And then, try to go west. With that done, put the half of a bag of chips on the stove. Got that? Good!".
