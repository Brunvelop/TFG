...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You're now in a kitchen. Let's see what's in here.
 ...
 You can see a refrigerator. Hmmm... what else, what else?[if c_2 is open and there is something in the c_2] The refrigerator contains [a list of things in the c_2].[end if]".
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " What's that over there? It looks like it's a stove. The stove is normal.[if there is something on the s_2] On the stove you can see [a list of things on the s_2].[end if]".
The kitchen part 5 is some text that varies. The kitchen part 5 is "[if there is nothing on the s_2] But oh no! there's nothing on this piece of junk.[end if]".
The kitchen part 6 is some text that varies. The kitchen part 6 is " You see a kitchen island. [if there is something on the s_3]On the kitchen island you see [a list of things on the s_3].[end if]".
...
The kitchen part 10 is some text that varies. The kitchen part 10 is " wooden door leading west. There is an exit to the north. Don't worry, it is unguarded. There is an exit to the south. Don't worry, it is unblocked.".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You have entered the most typical of all possible bedrooms.

 You see [if c_0 is locked]a locked[else if c_0 is open]an opened[otherwise]a closed[end if]".
The bedroom part 1 is some text that varies. The bedroom part 1 is " chest drawer nearby.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0]. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
...
The bedroom part 3 is some text that varies. The bedroom part 3 is " You make out an antique trunk.[if c_1 is open and there is something in the c_1] The antique trunk contains [a list of things in the c_1]. You shudder, but continue examining the room.[end if]".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " As if things weren't amazing enough already, you can even see a king-size bed. [if there is something on the s_0]On the king-size bed you can see [a list of things on the s_0].[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You are in a backyard. A normal one.
 ...
 You can see a set of chairs. The set of chairs is standard.[if there is something on the s_10] On the set of chairs you make out [a list of things on the s_10].[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You can see a bbq. The bbq is standard.[if there is something on the s_8] On the bbq you can see [a list of things on the s_8]. Hmmm... what else, what else?[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You can make out a patio table. [if there is something on the s_9]You see [a list of things on the s_9] on the patio table.[end if]".
The backyard part 5 is some text that varies. The backyard part 5 is "[if there is nothing on the s_9]But the thing hasn't got anything on it. Aw, here you were, all excited for there to be things on it![end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You've just walked into a living room.

 You can make out a couch. [if there is something on the s_5]On the couch you can make out [a list of things on the s_5].[end if]".
...
The living room part 2 is some text that varies. The living room part 2 is " You see a low table. The low table is standard.[if there is something on the s_6] On the low table you make out [a list of things on the s_6].[end if]".
The living room part 3 is some text that varies. The living room part 3 is "[if there is nothing on the s_6] The low table appears to be empty. What, you think everything in TextWorld should have stuff on it?[end if]".
The living room part 4 is some text that varies. The living room part 4 is " Oh, great. Here's a tv. [if there is something on the s_7]On the tv you see [a list of things on the s_7].[end if]".
The living room part 5 is some text that varies. The living room part 5 is "[if there is nothing on the s_7]Unfortunately, there isn't a thing on it. It would have been so cool if there was stuff on the tv! oh well.[end if]".
...
The bathroom part 1 is some text that varies. The bathroom part 1 is " toilet nearby.[if c_3 is open and there is something in the c_3] The toilet contains [a list of things in the c_3].[end if]".
...
The bathroom part 3 is some text that varies. The bathroom part 3 is " Hey, want to see a bath? Look over there, a bath. You can't wait to tell the folks at home about this![if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4], so there's that.[end if]".
...
The bathroom part 5 is some text that varies. The bathroom part 5 is " You can see a sink. The sink is standard.[if there is something on the s_4] On the sink you can see [a list of things on the s_4].[end if]".
...
The garden part 0 is some text that varies. The garden part 0 is "You find yourself in a garden. A normal one. Okay, just remember what you're here to do, and everything will go great.
...
The description of d_0 is "it's a hefty wooden door [if open]It is open.[else if closed]It is closed.[otherwise]It is locked.[end if]".
The printed name of d_0 is "wooden door".
Understand "wooden door" as d_0.
Understand "wooden" as d_0.
Understand "door" as d_0.
The d_0 is locked.
The description of d_1 is "it's a manageable screen door [if open]It is open.[else if closed]It is closed.[otherwise]It is locked.[end if]".
...
The f_3 is in r_5.
The f_3 is edible.
The description of f_4 is "The lettuce looks tantalizing.".
The printed name of f_4 is "lettuce".
Understand "lettuce" as f_4.
The f_4 is in r_5.
The f_4 is edible.
The description of f_5 is "that's a normal half of a bag of chips!".
...
The description of f_1 is "that's a standard bell pepper!".
...
The description of f_2 is "The milk looks tempting.".
The printed name of f_2 is "milk".
Understand "milk" as f_2.
The f_2 is edible.
The f_2 is on the s_5.
The description of k_0 is "The old key is weighty.".
...
The description of o_1 is "The soap bar is cheap looking.".
...
Test quest8_0 with "open antique trunk / take old key from antique trunk / unlock wooden door with old key / open wooden door / go east / open screen door / go east / go south / take half of a bag of chips"
...
Test quest9_0 with "open antique trunk / take old key from antique trunk / unlock wooden door with old key / open wooden door / go east / open screen door / go east / go south / take half of a bag of chips / go north / go west / put half of a bag of chips on stove"
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is your task for today. First of all, look and see that the antique trunk in the bedroom is open. And then, take the old key from the antique ".
The objective part 1 is some text that varies. The objective part 1 is "trunk within the bedroom. After that, unlock the wooden door. After that, ensure that the wooden door is open. And then, make an attempt to move east. Following that, ensure that the screen door is op".
The objective part 2 is some text that varies. The objective part 2 is "en. After that, make an attempt to go east. If you can do that, make an attempt to move south. And then, pick up the half of a bag of chips from the floor of the garden. If you can get your hands on t".
The objective part 3 is some text that varies. The objective part 3 is "he half of a bag of chips, make an attempt to travel north. With that accomplished, make an effort to take a trip west. Then, put the half of a bag of chips on the stove inside the kitchen. Got that? ".
