...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! First thing I need you to do is to ensure that the antique trunk in the bedroom is open. After th".
The objective part 1 is some text that varies. The objective part 1 is "at, retrieve the old key from the antique trunk. Then, assure that the wooden door is unlocked. Having unlocked the wooden door, make it so that the wooden door in the bedroom is opened. Then, make an".
The objective part 2 is some text that varies. The objective part 2 is " attempt to travel east. After that, ensure that the refrigerator is open. After that, take the bell pepper from the refrigerator. Then, sit the bell pepper on the stove. And if you do that, you're th".
