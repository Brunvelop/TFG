...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First off, open the chest drawer. After that, take the old key from the chest drawer. Then, make it so t".
The objective part 1 is some text that varies. The objective part 1 is "hat the wooden door inside the bedroom is unlocked with the old key. And then, ensure that the wooden door is open. After that, travel east. With that over with, open the screen door inside the kitche".
The objective part 2 is some text that varies. The objective part 2 is "n. After pulling open the screen door, head east. With that done, make an attempt to head south. Okay, and then, recover the bell pepper from the floor of the garden. After that, make an attempt to he".
The objective part 3 is some text that varies. The objective part 3 is "ad north. And then, take a trip west. Then, sit the bell pepper on the stove in the kitchen. That's it!".
