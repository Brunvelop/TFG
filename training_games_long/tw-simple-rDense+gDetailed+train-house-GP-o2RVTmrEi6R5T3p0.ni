...
The objective part 2 is some text that varies. The objective part 2 is "t. Once you get around to doing that, open the screen door in the kitchen. And then, travel east. After that, make an attempt to venture south. Then, retrieve the apple from the floor of the garden. T".
The objective part 3 is some text that varies. The objective part 3 is "hen, go north. And then, attempt to go to the west. That done, place the apple on the stove. That's it!".
