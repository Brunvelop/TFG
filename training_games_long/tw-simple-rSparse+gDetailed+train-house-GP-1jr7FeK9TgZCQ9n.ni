...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You're now in a kitchen. I guess you better just go and list everything you see here.
 ...
 Look out! It's a- oh, never mind, it's just a refrigerator. Now that's what I call TextWorld![if c_2 is open and there is something in the c_2] The refrigerator contains [a list of things in the c_2].[end if]".
...
The kitchen part 2 is some text that varies. The kitchen part 2 is " You see a counter. [if there is something on the s_1]On the counter you can see [a list of things on the s_1].[end if]".
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " Look out! It's a- oh, never mind, it's just a stove. Why don't you take a picture of it, it'll last longer! The stove is usual.[if there is something on the s_2] On the stove you make out [a list of things on the s_2].[end if]".
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " You can see a kitchen island. The kitchen island is ordinary.[if there is something on the s_3] On the kitchen island you can see [a list of things on the s_3].[end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is "[if there is nothing on the s_3] But the thing is empty. This always happens![end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You are in a bedroom. A standard kind of place.
 ...
 Look out! It's a- oh, never mind, it's just a chest drawer.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0].[end if]".
...
The bedroom part 4 is some text that varies. The bedroom part 4 is " You can make out a king-size bed. [if there is something on the s_0]On the king-size bed you make out [a list of things on the s_0].[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You've just shown up in a backyard.
 ...
 Oh wow! Is that what I think it is? It is! It's a set of chairs. The set of chairs is standard.[if there is something on the s_10] On the set of chairs you see [a list of things on the s_10].[end if]".
The backyard part 1 is some text that varies. The backyard part 1 is "[if there is nothing on the s_10] But the thing is empty. Hopefully this doesn't make you too upset.[end if]".
The backyard part 2 is some text that varies. The backyard part 2 is " You can make out a bbq. The bbq is usual.[if there is something on the s_8] On the bbq you make out [a list of things on the s_8].[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " What's that over there? It looks like it's a patio table. The patio table is usual.[if there is something on the s_9] On the patio table you can make out [a list of things on the s_9].[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "Well I'll be, you are in the place we're calling the living room.
 ...
 You can make out a couch. [if there is something on the s_5]On the couch you make out [a list of things on the s_5].[end if]".
...
The living room part 2 is some text that varies. The living room part 2 is " Look over there! a low table. The low table is typical.[if there is something on the s_6] On the low table you can make out [a list of things on the s_6].[end if]".
...
The living room part 4 is some text that varies. The living room part 4 is " You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a tv. The tv is normal.[if there is something on the s_7] On the tv you make out [a list of things on the s_7].[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "I am required to announce that you are now in the bathroom. You begin to take stock of what's here.

 You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a toilet. Huh, weird.[if c_3 is open and there is something in the c_3] The toilet contains [a list of things in the c_3].[end if]".
...
The bathroom part 4 is some text that varies. The bathroom part 4 is " You can make out a sink. You shudder, but continue examining the sink. The sink is standard.[if there is something on the s_4] On the sink you see [a list of things on the s_4].[end if]".
The bathroom part 5 is some text that varies. The bathroom part 5 is "[if there is nothing on the s_4] Unfortunately, there isn't a thing on it. It would have been so cool if there was stuff on the sink.[end if]".
...
The d_0 is locked.
The description of d_1 is "The screen door looks robust. [if open]It is open.[else if closed]It is closed.[otherwise]It is locked.[end if]".
...
The f_4 is in r_5.
The f_4 is edible.
The description of f_5 is "that's an ordinary apple!".
...
The description of o_0 is "The toothbrush appears to be to fit in here".
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an fast paced round of TextWorld? You do! Here is your task for today. First of all, open the antique trunk. After opening the antique trunk, r".
The objective part 1 is some text that varies. The objective part 1 is "etrieve the old key from the antique trunk. After taking the old key, make absolutely sure that the wooden door in the bedroom is unlocked. And then, ensure that the wooden door inside the bedroom is ".
The objective part 2 is some text that varies. The objective part 2 is "open. Then, make an effort to head east. Once you succeed at that, ensure that the screen door within the kitchen is open. After you have opened the screen door, venture east. And then, go south. Afte".
The objective part 3 is some text that varies. The objective part 3 is "r that, pick up the apple from the floor of the garden. If you can get your hands on the apple, travel north. Then, move west. And then, rest the apple on the stove. Alright, thanks!".
