...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a profound episode of TextWorld! First thing I need you to do is to ensure that the chest drawer is open. And then, recover the old key from the chest drawer within the bedroom. Th".
The objective part 1 is some text that varies. The objective part 1 is "en, insert the old key into the wooden door within the bedroom's lock to unlock it. After that, open the wooden door inside the bedroom. And then, go east. Okay, and then, open the screen door. And th".
The objective part 2 is some text that varies. The objective part 2 is "en, try to travel east. After that, attempt to venture south. And then, pick up the half of a bag of chips from the floor of the garden. After that, attempt to go to the north. And then, go to the wes".
The objective part 3 is some text that varies. The objective part 3 is "t. And then, place the half of a bag of chips on the stove. That's it!".
