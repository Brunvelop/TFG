...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an life changing round of TextWorld? You do! Here is how to play! First off, ensure that the antique trunk within the bedroom is open. After th".
The objective part 1 is some text that varies. The objective part 1 is "at, pick up the old key from the antique trunk inside the bedroom. After you have taken the old key, unlock the wooden door with the old key. Then, ensure that the wooden door is open. And then, move ".
The objective part 2 is some text that varies. The objective part 2 is "east. And then, make absolutely sure that the screen door is opened. After that, attempt to move east. If you can finish that, go to the south. Then, pick up the milk from the floor of the garden. And".
The objective part 3 is some text that varies. The objective part 3 is " then, make an effort to take a trip north. Following that, move west. Then, place the milk on the stove. And if you do that, you're the winner!".
