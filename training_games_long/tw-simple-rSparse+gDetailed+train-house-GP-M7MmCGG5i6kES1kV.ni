...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is your task for today. First of all, open the chest drawer. Then, recover the old key from the chest drawer. Then, insert the old key into th".
The objective part 1 is some text that varies. The objective part 1 is "e wooden door's lock to unlock it. And then, ensure that the wooden door within the bedroom is open. If you have pulled open the wooden door, go to the east. If you can finish that, open the screen do".
The objective part 2 is some text that varies. The objective part 2 is "or. After that, head east. And then, head south. That done, lift the milk from the floor of the garden. Then, head north. And then, try to travel west. With that done, sit the milk on the stove. And o".
