...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First of all, you could, like, doublecheck that the chest drawer is opened. Then, pick up the old key fr".
The objective part 1 is some text that varies. The objective part 1 is "om the chest drawer in the bedroom. After that, unlock the wooden door. Then, make sure that the wooden door inside the bedroom is opened. Then, move east. Then, doublecheck that the refrigerator is a".
The objective part 2 is some text that varies. The objective part 2 is "jar. Then, take the lettuce from the refrigerator. After stealing the lettuce, put the lettuce on the stove. Once that's all handled, you can stop!".
