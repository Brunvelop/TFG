...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is your task for today. First stop, ensure that the antique trunk within the bedroom is open. And then, retrieve the old key from the antique ".
The objective part 1 is some text that varies. The objective part 1 is "trunk. After that, insert the old key into the wooden door in the bedroom's lock to unlock it. Then, assure that the wooden door inside the bedroom is wide open. After that, attempt to travel east. Wi".
The objective part 2 is some text that varies. The objective part 2 is "th that over with, look and see that the screen door in the kitchen is ajar. After pulling open the screen door, travel east. Then, try to go to the south. After that, recover the milk from the floor ".
The objective part 3 is some text that varies. The objective part 3 is "of the garden. After that, make an effort to travel north. And then, make an effort to move west. Then, put the milk on the stove. And once you've done that, you win!".
