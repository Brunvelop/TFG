...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another fast paced session of TextWorld! Here is your task for today. First of all, ensure that the antique trunk is open. Then, take the old key from the antique trunk in the bedroom. If y".
The objective part 1 is some text that varies. The objective part 1 is "ou can get your hands on the old key, doublecheck that the wooden door in the bedroom is unlocked. Then, open the wooden door. Then, travel east. Okay, and then, make it so that the refrigerator is wi".
The objective part 2 is some text that varies. The objective part 2 is "de open. After that, pick up the bell pepper from the refrigerator. Once you have got the bell pepper, put the bell pepper on the stove. That's it!".
