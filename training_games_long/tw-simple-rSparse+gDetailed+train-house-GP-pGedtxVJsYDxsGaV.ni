...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! First, it would be good if you could look and see that the antique trunk within the bedroom is op".
The objective part 1 is some text that varies. The objective part 1 is "en. After opening the antique trunk, pick up the old key from the antique trunk in the bedroom. After that, make absolutely sure that the wooden door is unlocked. After that, open the wooden door. And".
The objective part 2 is some text that varies. The objective part 2 is " then, head east. After that, make it so that the refrigerator within the kitchen is wide open. After that, retrieve the lettuce from the refrigerator. Then, sit the lettuce on the stove. Got that? Go".
The objective part 3 is some text that varies. The objective part 3 is "od!".
