...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is your task for today. First of all, you could, like, ensure that the antique trunk within the bedroom is ".
The objective part 1 is some text that varies. The objective part 1 is "open. After opening the antique trunk, recover the old key from the antique trunk. Then, unlock the wooden door inside the bedroom. After that, open the wooden door. And then, try to travel east. If y".
The objective part 2 is some text that varies. The objective part 2 is "ou can do that, open the screen door in the kitchen. After that, make an attempt to venture east. After that, go south. Then, retrieve the milk from the floor of the garden. If you can get your hands ".
The objective part 3 is some text that varies. The objective part 3 is "on the milk, attempt to go to the north. Then, try to venture west. Then, put the milk on the stove. And if you do that, you're the winner!".
