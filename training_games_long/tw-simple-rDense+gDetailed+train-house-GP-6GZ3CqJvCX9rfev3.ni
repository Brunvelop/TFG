...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is your task for today. Your first objective is to make it so that the antique trunk is ajar. And then, retrieve the old key from the antique trunk. Then, check that the woo".
The objective part 1 is some text that varies. The objective part 1 is "den door is unlocked with the old key. And then, open the wooden door inside the bedroom. And then, try to go east. That done, open the screen door. Then, attempt to take a trip east. Okay, and then, ".
The objective part 2 is some text that varies. The objective part 2 is "attempt to travel south. And then, retrieve the apple from the floor of the garden. And then, take a trip north. With that done, attempt to travel west. Following that, place the apple on the stove wi".
