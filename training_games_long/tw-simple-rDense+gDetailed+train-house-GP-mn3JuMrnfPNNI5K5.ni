...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You've just walked into a kitchen. Okay, just remember what you're here to do, and everything will go great.
 ...
 You can make out a refrigerator.[if c_2 is open and there is something in the c_2] The refrigerator contains [a list of things in the c_2]. I mean, just wow! Isn't TextWorld just the best?[end if]".
...
The kitchen part 2 is some text that varies. The kitchen part 2 is " Hey, want to see a counter? Look over there, a counter. The counter is standard.[if there is something on the s_1] On the counter you can make out [a list of things on the s_1].[end if]".
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " As if things weren't amazing enough already, you can even see a stove. [if there is something on the s_2]You see [a list of things on the s_2] on the stove.[end if]".
The kitchen part 5 is some text that varies. The kitchen part 5 is "[if there is nothing on the s_2]But oh no! there's nothing on this piece of junk. What, you think everything in TextWorld should have stuff on it?[end if]".
...
The kitchen part 7 is some text that varies. The kitchen part 7 is "[if there is nothing on the s_3]But there isn't a thing on it. Aw, and here you were, all excited for there to be things on it![end if]".
...
The kitchen part 10 is some text that varies. The kitchen part 10 is " wooden door leading west. You need an unblocked exit? You should try going north. You need an unguarded exit? You should try going south.".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You are in a bedroom. A normal kind of place.
 ...
 You scan the room for a chest drawer, and you find a chest drawer.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0]. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[end if]".
...
The bedroom part 2 is some text that varies. The bedroom part 2 is " You can see an antique trunk.[if c_1 is open and there is something in the c_1] The antique trunk contains [a list of things in the c_1].[end if]".
...
The bedroom part 4 is some text that varies. The bedroom part 4 is " You make out a king-size bed. The king-size bed is ordinary.[if there is something on the s_0] On the king-size bed you can make out [a list of things on the s_0].[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You arrive in a backyard. An ordinary one.
 ...
 You can make out a set of chairs. [if there is something on the s_10]On the set of chairs you can see [a list of things on the s_10]. You can't wait to tell the folks at home about this![end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You see a bbq. [if there is something on the s_8]On the bbq you see [a list of things on the s_8].[end if]".
The backyard part 3 is some text that varies. The backyard part 3 is "[if there is nothing on the s_8]The bbq appears to be empty. Aw, here you were, all excited for there to be things on it![end if]".
The backyard part 4 is some text that varies. The backyard part 4 is " You can make out a patio table. Why don't you take a picture of it, it'll last longer! [if there is something on the s_9]You see [a list of things on the s_9] on the patio table. It doesn't get more TextWorld than this![end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "Well, here we are in a living room. You begin to take stock of what's in the room.

 You see a couch. [if there is something on the s_5]You see [a list of things on the s_5] on the couch. There's something strange about this being here, but you can't put your finger on it.[end if]".
...
The living room part 2 is some text that varies. The living room part 2 is " Oh, great. Here's a low table. The low table is ordinary.[if there is something on the s_6] On the low table you make out [a list of things on the s_6].[end if]".
The living room part 3 is some text that varies. The living room part 3 is "[if there is nothing on the s_6] But the thing is empty. Aw, here you were, all excited for there to be things on it![end if]".
...
The living room part 5 is some text that varies. The living room part 5 is "[if there is nothing on the s_7]Unfortunately, there isn't a thing on it. Oh! Why couldn't there just be stuff on it?[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You've entered a bathroom. You decide to just list off a complete list of everything you see in the room, because hey, why not?
 ...
 You bend down to tie your shoe. When you stand up, you notice a toilet.[if c_3 is open and there is something in the c_3] The toilet contains [a list of things in the c_3].[end if]".
...
The bathroom part 2 is some text that varies. The bathroom part 2 is " You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a bath.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4]. Wow, isn't TextWorld just the best?[end if]".
...
The bathroom part 4 is some text that varies. The bathroom part 4 is " Look out! It's a- oh, never mind, it's just a sink. [if there is something on the s_4]On the sink you make out [a list of things on the s_4].[end if]".
The bathroom part 5 is some text that varies. The bathroom part 5 is "[if there is nothing on the s_4]But the thing is empty, unfortunately.[end if]".
...
The c_4 is in r_3.
The c_4 is closed.
The description of f_3 is "that's a standard lettuce!".
The printed name of f_3 is "lettuce".
Understand "lettuce" as f_3.
The f_3 is in r_5.
The f_3 is edible.
The description of f_4 is "that's an usual milk!".
The printed name of f_4 is "milk".
Understand "milk" as f_4.
The f_4 is in r_5.
The f_4 is edible.
The description of f_5 is "The half of a bag of chips looks tasty.".
...
The o_3 is in r_5.
The description of s_0 is "The king-size bed is an unstable piece of trash.".
...
The s_9 is in r_4.
The description of f_0 is "that's a typical apple!".
The printed name of f_0 is "apple".
Understand "apple" as f_0.
The f_0 is edible.
The f_0 is in the c_2.
The description of f_1 is "that's an usual tomato plant!".
...
The description of o_1 is "The soap bar is dirty.".
...
The description of o_0 is "The toothbrush seems well matched to everything else here".
The printed name of o_0 is "toothbrush".
Understand "toothbrush" as o_0.
The o_0 is on the s_4.
The description of o_2 is "The remote is expensive looking.".
...
Test quest8_0 with "open chest drawer / take old key from chest drawer / unlock wooden door with old key / open wooden door / go east / open screen door / go east / go south / take milk"
...
Test quest9_0 with "open chest drawer / take old key from chest drawer / unlock wooden door with old key / open wooden door / go east / open screen door / go east / go south / take milk / go north / go west / put milk on stove"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First off, open the chest drawer. And then, recover the old key from the chest drawer. After that, unloc".
The objective part 1 is some text that varies. The objective part 1 is "k the wooden door in the bedroom with the old key. Then, open the wooden door inside the bedroom. Then, attempt to head east. Next, ensure that the screen door is open. Then, head east. If you can suc".
The objective part 2 is some text that varies. The objective part 2 is "ceed at that, venture south. Once you do that, pick-up the milk from the floor of the garden. After that, try to take a trip north. And then, venture west. With that done, sit the milk on the stove in".
The objective part 3 is some text that varies. The objective part 3 is " the kitchen. And if you do that, you're the winner!".
