...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First of all, you could, like, ensure that the chest drawer within the bedroom is open. And then, retrie".
The objective part 1 is some text that varies. The objective part 1 is "ve the old key from the chest drawer within the bedroom. After getting the old key, assure that the wooden door is unlocked. If you have unlocked the wooden door, ensure that the wooden door is open. ".
The objective part 2 is some text that varies. The objective part 2 is "And then, try to take a trip east. And then, ensure that the refrigerator within the kitchen is open. Having pulled open the refrigerator, take the lettuce from the refrigerator within the kitchen. Af".
The objective part 3 is some text that varies. The objective part 3 is "ter stealing the lettuce, rest the lettuce on the stove inside the kitchen. Got that? Good!".
