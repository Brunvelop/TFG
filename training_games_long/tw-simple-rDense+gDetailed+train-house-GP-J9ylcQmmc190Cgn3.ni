...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another profound session of TextWorld! Here is your task for today. First off, if it's not too much trouble, I need you to open the chest drawer inside the bedroom. Having pulled open the c".
The objective part 1 is some text that varies. The objective part 1 is "hest drawer, pick up the old key from the chest drawer. Having got the old key, doublecheck that the wooden door is unlocked. Then, open the wooden door. And then, travel east. Then, open the screen d".
The objective part 2 is some text that varies. The objective part 2 is "oor. And then, attempt to venture east. After that, make an effort to travel south. Then, recover the half of a bag of chips from the floor of the garden. Then, move north. And then, try to head west.".
The objective part 3 is some text that varies. The objective part 3 is " With that done, place the half of a bag of chips on the stove inside the kitchen. That's it!".
