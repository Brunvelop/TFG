...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another exciting episode of TextWorld! Here is your task for today. Your first objective is to make it so that the antique trunk is open. After that, retrieve the old key from the antique t".
The objective part 1 is some text that varies. The objective part 1 is "runk. And then, check that the wooden door in the bedroom is unlocked with the old key. After that, open the wooden door inside the bedroom. After opening the wooden door, move east. Once you get thro".
The objective part 2 is some text that varies. The objective part 2 is "ugh with that, open the screen door within the kitchen. And then, attempt to take a trip east. And then, head south. And then, pick-up the milk from the floor of the garden. After taking the milk, try".
The objective part 3 is some text that varies. The objective part 3 is " to take a trip north. With that accomplished, make an attempt to move west. Following that, sit the milk on the stove. And once you've done that, you win!".
