...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is your task for today. Your first objective is to ensure that the antique trunk within the bedroom is open. And then, pick up the old key from the antique trunk. And then, ".
The objective part 1 is some text that varies. The objective part 1 is "doublecheck that the wooden door is unlocked. After that, make sure that the wooden door within the bedroom is opened. After opening the wooden door, head east. Next, open the refrigerator. Then, retr".
The objective part 2 is some text that varies. The objective part 2 is "ieve the lettuce from the refrigerator in the kitchen. And then, place the lettuce on the stove. Alright, thanks!".
