...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First off, open the antique trunk. Having opened the antique trunk, pick up the old key from the antique".
The objective part 1 is some text that varies. The objective part 1 is " trunk in the bedroom. After that, insert the old key into the wooden door's lock to unlock it. And then, make it so that the wooden door in the bedroom is ajar. Once you have pulled open the wooden d".
The objective part 2 is some text that varies. The objective part 2 is "oor, go to the east. With that done, make sure that the screen door in the kitchen is wide open. After opening the screen door, take a trip east. Once you get around to doing that, make an effort to m".
The objective part 3 is some text that varies. The objective part 3 is "ove south. And then, recover the apple from the floor of the garden. If you can get your hands on the apple, venture north. And then, go west. Then, rest the apple on the stove inside the kitchen. And".
