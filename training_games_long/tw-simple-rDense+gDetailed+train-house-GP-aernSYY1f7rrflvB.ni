...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another profound session of TextWorld! Here is how to play! First stop, ensure that the chest drawer is open. And then, retrieve the old key from the chest drawer. Then, check that the wood".
The objective part 1 is some text that varies. The objective part 1 is "en door is unlocked with the old key. And then, open the wooden door. And then, make an attempt to venture east. And then, make absolutely sure that the refrigerator in the kitchen is opened. Then, ta".
The objective part 2 is some text that varies. The objective part 2 is "ke the tomato plant from the refrigerator inside the kitchen. After that, put the tomato plant on the stove. And if you do that, you're the winner!".
