...
The kitchen part 4 is some text that varies. The kitchen part 4 is " You make out a stove. The stove is normal.[if there is something on the s_2] On the stove you make out [a list of things on the s_2].[end if]".
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " You can see a kitchen island. The kitchen island is normal.[if there is something on the s_3] On the kitchen island you see [a list of things on the s_3].[end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is "[if there is nothing on the s_3] But the thing is empty, unfortunately. Hopefully this doesn't make you too upset.[end if]".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " Look over there! a king-size bed. [if there is something on the s_0]On the king-size bed you see [a list of things on the s_0]. Hmmm... what else, what else?[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You've entered a backyard.
 ...
 Look over there! a set of chairs. The set of chairs is typical.[if there is something on the s_10] On the set of chairs you can see [a list of things on the s_10].[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You see a bbq. Why don't you take a picture of it, it'll last longer! The bbq is normal.[if there is something on the s_8] On the bbq you see [a list of things on the s_8].[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " Hey, want to see a patio table? Look over there, a patio table. [if there is something on the s_9]On the patio table you make out [a list of things on the s_9].[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "Ah, the living room. This is some kind of living room, really great usual vibes in this place, a wonderful usual atmosphere. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.

 You can see a couch. The couch is standard.[if there is something on the s_5] On the couch you see [a list of things on the s_5].[end if]".
The living room part 1 is some text that varies. The living room part 1 is "[if there is nothing on the s_5] However, the couch, like an empty couch, has nothing on it. You move on, clearly depressed by your TextWorld experience.[end if]".
The living room part 2 is some text that varies. The living room part 2 is " As if things weren't amazing enough already, you can even see a low table. [if there is something on the s_6]You see [a list of things on the s_6] on the low table.[end if]".
...
The living room part 4 is some text that varies. The living room part 4 is " You can see a tv. You shudder, but continue examining the tv. [if there is something on the s_7]On the tv you can see [a list of things on the s_7].[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You find yourself in a bathroom. A typical kind of place.
 ...
 You make out a toilet. You shudder, but continue examining the room.[if c_3 is open and there is something in the c_3] The toilet contains [a list of things in the c_3].[end if]".
...
The bathroom part 2 is some text that varies. The bathroom part 2 is " You scan the room, seeing a bath. Make a note of this, you might have to put stuff on or in it later on.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4].[end if]".
...
The bathroom part 4 is some text that varies. The bathroom part 4 is " You can see a sink. The sink is ordinary.[if there is something on the s_4] On the sink you see [a list of things on the s_4].[end if]".
...
The c_4 is in r_3.
The c_4 is closed.
The description of f_3 is "The lettuce looks delicious.".
...
The description of f_1 is "The bell pepper looks heavenly.".
...
The description of o_2 is "The remote looks out of place here".
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Here is your task for today. Your first objective is to make sure that the chest drawer is opened".
The objective part 1 is some text that varies. The objective part 1 is ". And then, recover the old key from the chest drawer in the bedroom. After that, make sure that the wooden door is unlocked with the old key. Then, doublecheck that the wooden door inside the bedroom".
The objective part 2 is some text that varies. The objective part 2 is " is open. Then, try to go to the east. After that, doublecheck that the screen door is ajar. And then, head east. And then, move south. Then, retrieve the milk from the floor of the garden. And then, ".
The objective part 3 is some text that varies. The objective part 3 is "try to go north. After that, try to take a trip west. And then, place the milk on the stove. And once you've done that, you win!".
