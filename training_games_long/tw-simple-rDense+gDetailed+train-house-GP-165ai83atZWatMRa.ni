...
The kitchen part 1 is some text that varies. The kitchen part 1 is " refrigerator.[if c_2 is open and there is something in the c_2] The refrigerator contains [a list of things in the c_2]. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
...
The kitchen part 3 is some text that varies. The kitchen part 3 is " You can make out a counter. [if there is something on the s_1]You see [a list of things on the s_1] on the counter.[end if]".
The kitchen part 4 is some text that varies. The kitchen part 4 is "[if there is nothing on the s_1]But there isn't a thing on it. You move on, clearly angry about TextWorld.[end if]".
The kitchen part 5 is some text that varies. The kitchen part 5 is " If you haven't noticed it already, there seems to be something there by the wall, it's a stove. [if there is something on the s_2]You see [a list of things on the s_2] on the stove. Huh, weird.[end if]".
The kitchen part 6 is some text that varies. The kitchen part 6 is "[if there is nothing on the s_2]But oh no! there's nothing on this piece of junk. What, you think everything in TextWorld should have stuff on it?[end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is " You see a kitchen island. The kitchen island is usual.[if there is something on the s_3] On the kitchen island you can see [a list of things on the s_3].[end if]".
The kitchen part 8 is some text that varies. The kitchen part 8 is "[if there is nothing on the s_3] The kitchen island appears to be empty.[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You're now in the bedroom.
 ...
 You bend down to tie your shoe. When you stand up, you notice a chest drawer.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0]. Classic TextWorld.[end if]".
...
The bedroom part 2 is some text that varies. The bedroom part 2 is " If you haven't noticed it already, there seems to be something there by the wall, it's an antique trunk. Does this look like anything mentioned in the instructions?[if c_1 is open and there is something in the c_1] The antique trunk contains [a list of things in the c_1].[end if]".
...
The bedroom part 4 is some text that varies. The bedroom part 4 is " You can see a king-size bed. What a coincidence, weren't you just thinking about a king-size bed? The king-size bed is ordinary.[if there is something on the s_0] On the king-size bed you can see [a list of things on the s_0].[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You've entered a backyard. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
 ...
 You see a set of chairs. The set of chairs is usual.[if there is something on the s_10] On the set of chairs you make out [a list of things on the s_10].[end if]".
The backyard part 1 is some text that varies. The backyard part 1 is "[if there is nothing on the s_10] The set of chairs appears to be empty. Oh! Why couldn't there just be stuff on it?[end if]".
The backyard part 2 is some text that varies. The backyard part 2 is " You can make out a bbq. The bbq is standard.[if there is something on the s_8] On the bbq you make out [a list of things on the s_8].[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You hear a noise behind you and spin around, but you can't see anything other than a patio table. Why don't you take a picture of it, it'll last longer! [if there is something on the s_9]On the patio table you see [a list of things on the s_9].[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You're now in a living room.
 ...
 You can see a couch. [if there is something on the s_5]You see [a list of things on the s_5] on the couch.[end if]".
...
The living room part 2 is some text that varies. The living room part 2 is " You scan the room for a low table, and you find a low table. The low table is usual.[if there is something on the s_6] On the low table you can make out [a list of things on the s_6].[end if]".
...
The living room part 4 is some text that varies. The living room part 4 is " Hey, want to see a tv? Look over there, a tv. The tv is usual.[if there is something on the s_7] On the tv you see [a list of things on the s_7].[end if]".
The living room part 5 is some text that varies. The living room part 5 is "[if there is nothing on the s_7] However, the tv, like an empty tv, has nothing on it.[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You find yourself in a bathroom. A standard kind of place.
 ...
 Oh wow! Is that what I think it is? It is! It's a toilet.[if c_3 is open and there is something in the c_3] The toilet contains [a list of things in the c_3]. You shudder, but continue examining the room.[end if]".
...
The bathroom part 2 is some text that varies. The bathroom part 2 is " You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a bath. Classic TextWorld.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4].[end if]".
...
The bathroom part 4 is some text that varies. The bathroom part 4 is " Hey, want to see a sink? Look over there, a sink. The sink is ordinary.[if there is something on the s_4] On the sink you can see [a list of things on the s_4].[end if]".
...
The d_0 is locked.
The description of d_1 is "it's a well-built screen door [if open]You can see inside it.[else if closed]You can't see inside it because the lid's in your way.[otherwise]There is a lock on it.[end if]".
...
The f_3 is in r_5.
The f_3 is edible.
The description of f_4 is "The half of a bag of chips looks appetizing.".
...
The f_5 is in r_5.
The f_5 is edible.
The description of o_3 is "The shovel appears out of place here".
...
The s_9 is in r_4.
The description of f_0 is "that's a typical milk!".
The printed name of f_0 is "milk".
Understand "milk" as f_0.
The f_0 is edible.
The f_0 is in the c_2.
The description of f_1 is "that's an ordinary tomato plant!".
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is how to play! First stop, doublecheck that the chest drawer within the bedroom is wide open. And then, retrieve the old key from the chest d".
The objective part 1 is some text that varies. The objective part 1 is "rawer in the bedroom. And then, unlock the wooden door with the old key. And then, open the wooden door. And then, make an attempt to go to the east. Then, ensure that the screen door is open. After t".
The objective part 2 is some text that varies. The objective part 2 is "hat, attempt to go east. Then, make an effort to travel south. Then, pick up the half of a bag of chips from the floor of the garden. After that, make an effort to go to the north. Following that, mak".
The objective part 3 is some text that varies. The objective part 3 is "e an attempt to venture west. With that over with, put the half of a bag of chips on the stove inside the kitchen. And once you've done that, you win!".
