...
The f_3 is in r_5.
The f_3 is edible.
The description of f_4 is "that's a standard bell pepper!".
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an life changing round of TextWorld? You do! Here is your task for today. First, it would be a great idea if you could open the chest drawer. A".
The objective part 1 is some text that varies. The objective part 1 is "nd then, retrieve the old key from the chest drawer. Then, doublecheck that the wooden door inside the bedroom is unlocked with the old key. After that, ensure that the wooden door within the bedroom ".
The objective part 2 is some text that varies. The objective part 2 is "is open. And then, make an effort to go to the east. And then, open the screen door inside the kitchen. After opening the screen door, take a trip east. Then, travel south. After that, recover the bel".
The objective part 3 is some text that varies. The objective part 3 is "l pepper from the floor of the garden. After taking the bell pepper, head north. If you can succeed at that, attempt to take a trip west. Once you accomplish that, sit the bell pepper on the stove wit".
The objective part 4 is some text that varies. The objective part 4 is "hin the kitchen. That's it!".
