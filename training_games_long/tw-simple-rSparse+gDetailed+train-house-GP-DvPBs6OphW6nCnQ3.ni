...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is how to play! First, it would be great if you could make sure that the antique trunk is ajar. And then, r".
The objective part 1 is some text that varies. The objective part 1 is "ecover the old key from the antique trunk. After that, unlock the wooden door. After unlocking the wooden door, ensure that the wooden door is open. After you have pulled open the wooden door, attempt".
The objective part 2 is some text that varies. The objective part 2 is " to venture east. If you can succeed at that, make absolutely sure that the refrigerator is opened. Then, retrieve the tomato plant from the refrigerator in the kitchen. After that, place the tomato p".
The objective part 3 is some text that varies. The objective part 3 is "lant on the stove. Got that? Good!".
