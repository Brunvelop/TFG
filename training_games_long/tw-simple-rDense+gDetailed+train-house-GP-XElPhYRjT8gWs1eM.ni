...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is your task for today. First of all, look and see that the antique trunk is opened. And then, pick up the old key from the antique trunk within the bedroom. With the old ke".
The objective part 1 is some text that varies. The objective part 1 is "y, unlock the wooden door with the old key. Then, ensure that the wooden door in the bedroom is open. And then, make an attempt to go east. After that, open the screen door. And then, make an attempt ".
The objective part 2 is some text that varies. The objective part 2 is "to move east. Next, go to the south. Okay, and then, lift the apple from the floor of the garden. After that, make an attempt to move north. And then, make an effort to head west. Following that, sit ".
The objective part 3 is some text that varies. The objective part 3 is "the apple on the stove. And once you've done that, you win!".
