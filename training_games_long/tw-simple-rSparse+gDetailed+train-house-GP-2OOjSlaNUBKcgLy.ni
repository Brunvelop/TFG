...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another life changing episode of TextWorld! Here is how to play! Your first objective is to ensure that the antique trunk in the bedroom is open. After that, recover the old key from the an".
The objective part 1 is some text that varies. The objective part 1 is "tique trunk inside the bedroom. After that, unlock the wooden door. Then, ensure that the wooden door within the bedroom is open. And then, make an attempt to take a trip east. Then, ensure that the s".
The objective part 2 is some text that varies. The objective part 2 is "creen door inside the kitchen is open. And then, make an effort to go east. And then, go south. After that, retrieve the half of a bag of chips from the floor of the garden. And then, make an attempt ".
The objective part 3 is some text that varies. The objective part 3 is "to move north. That done, go west. Then, sit the half of a bag of chips on the stove in the kitchen. That's it!".
