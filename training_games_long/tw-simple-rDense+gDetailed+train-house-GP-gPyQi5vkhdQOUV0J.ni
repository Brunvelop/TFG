...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Here is how to play! Your first objective is to ensure that the chest drawer is open. And then, r".
The objective part 1 is some text that varies. The objective part 1 is "etrieve the old key from the chest drawer inside the bedroom. And then, unlock the wooden door inside the bedroom. And then, assure that the wooden door within the bedroom is opened. Then, try to take".
The objective part 2 is some text that varies. The objective part 2 is " a trip east. That done, open the screen door in the kitchen. And then, attempt to travel east. Once you do that, attempt to move south. Then, recover the milk from the floor of the garden. And then, ".
The objective part 3 is some text that varies. The objective part 3 is "go north. With that done, move west. After that, put the milk on the stove. Alright, thanks!".
