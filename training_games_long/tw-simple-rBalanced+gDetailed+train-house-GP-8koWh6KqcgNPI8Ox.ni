...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is your task for today. First step, open the chest drawer within the bedroom. After that, take the old key from the chest drawer. Then, make i".
The objective part 1 is some text that varies. The objective part 1 is "t so that the wooden door is unlocked. And then, look and see that the wooden door is opened. Then, travel east. And then, open the screen door. Then, try to take a trip east. And then, make an attemp".
The objective part 2 is some text that varies. The objective part 2 is "t to move south. Then, pick-up the tomato plant from the floor of the garden. Then, go north. With that over with, make an attempt to travel west. With that accomplished, put the tomato plant on the s".
The objective part 3 is some text that varies. The objective part 3 is "tove inside the kitchen. Once that's all handled, you can stop!".
