...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an exciting round of TextWorld? You do! Here is how to play! First off, make it so that the chest drawer within the bedroom is opened. Then, re".
The objective part 1 is some text that varies. The objective part 1 is "cover the old key from the chest drawer in the bedroom. After that, unlock the wooden door within the bedroom. And then, open the wooden door. Then, move east. With that accomplished, open the screen ".
The objective part 2 is some text that varies. The objective part 2 is "door inside the kitchen. After pulling open the screen door, travel east. Once you get around to doing that, venture south. Once you do that, recover the lettuce from the floor of the garden. And then".
The objective part 3 is some text that varies. The objective part 3 is ", move north. And then, take a trip west. And then, rest the lettuce on the stove inside the kitchen. Alright, thanks!".
