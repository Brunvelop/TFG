...
The objective part 1 is some text that varies. The objective part 1 is "pick up the old key from the antique trunk within the bedroom. Then, check that the wooden door is unlocked with the old key. After that, ensure that the wooden door in the bedroom is open. After that".
The objective part 2 is some text that varies. The objective part 2 is ", move east. If you can get through with that, ensure that the refrigerator is open. And then, recover the milk from the refrigerator. If you can get your hands on the milk, rest the milk on the stove".
