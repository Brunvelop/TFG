...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is how to play! First off, ensure that the antique trunk inside the bedroom is open. Then, recover the old key from the antique trunk inside the bedroom. After that, make it".
The objective part 1 is some text that varies. The objective part 1 is " so that the wooden door is unlocked. And then, ensure that the wooden door within the bedroom is open. Then, venture east. With that over with, assure that the refrigerator is open. After that, take ".
The objective part 2 is some text that varies. The objective part 2 is "the lettuce from the refrigerator in the kitchen. With the lettuce, sit the lettuce on the stove. And once you've done that, you win!".
