...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You've entered a kitchen. The room is well lit.
 ...
 You make out a refrigerator. There's something strange about this being here, but you can't put your finger on it.[if c_2 is open and there is something in the c_2] The refrigerator contains [a list of things in the c_2].[end if]".
...
The kitchen part 2 is some text that varies. The kitchen part 2 is " You can make out a counter. [if there is something on the s_1]On the counter you can make out [a list of things on the s_1].[end if]".
The kitchen part 3 is some text that varies. The kitchen part 3 is "[if there is nothing on the s_1]Unfortunately, there isn't a thing on it. Aw, and here you were, all excited for there to be things on it![end if]".
The kitchen part 4 is some text that varies. The kitchen part 4 is " You see a stove. [if there is something on the s_2]On the stove you see [a list of things on the s_2].[end if]".
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " You can see a kitchen island. [if there is something on the s_3]On the kitchen island you make out [a list of things on the s_3].[end if]".
...
The bedroom part 2 is some text that varies. The bedroom part 2 is " You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal an antique trunk.[if c_1 is open and there is something in the c_1] The antique trunk contains [a list of things in the c_1].[end if]".
...
The bedroom part 4 is some text that varies. The bedroom part 4 is " You see a king-size bed. [if there is something on the s_0]On the king-size bed you make out [a list of things on the s_0].[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You've just shown up in a backyard. You decide to just list off a complete list of everything you see in the room, because hey, why not?
 ...
 You can see a set of chairs. [if there is something on the s_10]On the set of chairs you see [a list of things on the s_10]. Classic TextWorld.[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " Hey, want to see a bbq? Look over there, a bbq. [if there is something on the s_8]You see [a list of things on the s_8] on the bbq.[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " Look over there! a patio table. What a coincidence, weren't you just thinking about a patio table? The patio table is typical.[if there is something on the s_9] On the patio table you can see [a list of things on the s_9].[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You're now in a living room.
 ...
 You can see a couch. The couch is standard.[if there is something on the s_5] On the couch you make out [a list of things on the s_5].[end if]".
...
The living room part 3 is some text that varies. The living room part 3 is "[if there is nothing on the s_6]But the thing hasn't got anything on it. You move on, clearly upset by your TextWorld experience.[end if]".
The living room part 4 is some text that varies. The living room part 4 is " You can make out a tv. [if there is something on the s_7]On the tv you make out [a list of things on the s_7].[end if]".
...
The bathroom part 2 is some text that varies. The bathroom part 2 is " You can make out a bath.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4]. Wow, isn't TextWorld just the best?[end if]".
...
The bathroom part 4 is some text that varies. The bathroom part 4 is " Look out! It's a- oh, never mind, it's just a sink. [if there is something on the s_4]You see [a list of things on the s_4] on the sink.[end if]".
...
The f_3 is in r_5.
The f_3 is edible.
The description of f_4 is "that's a typical milk!".
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a fast paced session of TextWorld! Here is how to play! First off, if it's not too much trouble, I need you to open the chest drawer within the bedroom. After that, pick up the old".
The objective part 1 is some text that varies. The objective part 1 is " key from the chest drawer within the bedroom. After that, unlock the wooden door in the bedroom. After unlocking the wooden door, open the wooden door. If you have opened the wooden door, make an att".
The objective part 2 is some text that varies. The objective part 2 is "empt to venture east. Following that, ensure that the screen door within the kitchen is open. And then, try to go to the east. Then, make an attempt to head south. Then, pick-up the milk from the floo".
The objective part 3 is some text that varies. The objective part 3 is "r of the garden. After that, make an attempt to take a trip north. If you can finish that, make an effort to go west. And then, place the milk on the stove inside the kitchen. Alright, thanks!".
