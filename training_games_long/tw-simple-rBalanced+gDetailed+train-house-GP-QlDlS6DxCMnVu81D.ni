...
Test quest1_0 with "open chest drawer / take old key from chest drawer / unlock wooden door with old key / open wooden door / go east / go south / take apple from couch"
...
Test quest2_0 with "open chest drawer / take old key from chest drawer / unlock wooden door with old key / open wooden door / go east / go south / take apple from couch / go north / put apple on stove"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is your task for today. First off, if it's not too much trouble, I need you to ensure that the chest drawer is open. And then, take the old key from the chest drawer within ".
The objective part 1 is some text that varies. The objective part 1 is "the bedroom. After that, check that the wooden door inside the bedroom is unlocked with the old key. And then, ensure that the wooden door is open. After that, head east. Okay, and then, attempt to mo".
The objective part 2 is some text that varies. The objective part 2 is "ve south. And then, recover the apple from the couch. After that, make an attempt to move north. Then, put the apple on the stove inside the kitchen. And if you do that, you're the winner!".
