...
The objective part 2 is some text that varies. The objective part 2 is "And then, make an effort to head east. That done, open the refrigerator inside the kitchen. After that, take the lettuce from the refrigerator. With the lettuce, place the lettuce on the stove. Got th".
The objective part 3 is some text that varies. The objective part 3 is "at? Good!".
