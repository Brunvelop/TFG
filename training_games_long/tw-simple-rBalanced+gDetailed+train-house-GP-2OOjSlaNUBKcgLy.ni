...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First, it would be fantastic if you could assure that the antique trunk within the bedroom is wide open.".
The objective part 1 is some text that varies. The objective part 1 is " And then, take the old key from the antique trunk within the bedroom. Then, unlock the wooden door in the bedroom. After that, assure that the wooden door is ajar. Then, venture east. And then, make ".
The objective part 2 is some text that varies. The objective part 2 is "it so that the screen door is open. And then, go east. Then, try to go to the south. And then, pick up the half of a bag of chips from the floor of the garden. With the half of a bag of chips, make an".
The objective part 3 is some text that varies. The objective part 3 is " effort to take a trip north. Then, go to the west. With that done, sit the half of a bag of chips on the stove. Got that? Good!".
