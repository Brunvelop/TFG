...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an fast paced round of TextWorld? You do! Here is your task for today. First, it would be good if you could ensure that the chest drawer within".
The objective part 1 is some text that varies. The objective part 1 is " the bedroom is open. After you have pulled open the chest drawer, recover the old key from the chest drawer. After that, make it so that the wooden door is unlocked. Then, ensure that the wooden door".
The objective part 2 is some text that varies. The objective part 2 is " inside the bedroom is open. After that, move east. And then, ensure that the refrigerator is open. And then, take the lettuce from the refrigerator. After you have taken the lettuce, rest the lettuce".
The objective part 3 is some text that varies. The objective part 3 is " on the stove inside the kitchen. And once you've done that, you win!".
