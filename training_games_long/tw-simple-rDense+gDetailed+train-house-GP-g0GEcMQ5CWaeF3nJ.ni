...
The kitchen part 3 is some text that varies. The kitchen part 3 is " Look over there! a counter. [if there is something on the s_1]On the counter you can make out [a list of things on the s_1].[end if]".
...
The kitchen part 5 is some text that varies. The kitchen part 5 is " You can see a stove. You shudder, but continue examining the stove. [if there is something on the s_2]On the stove you see [a list of things on the s_2].[end if]".
The kitchen part 6 is some text that varies. The kitchen part 6 is "[if there is nothing on the s_2]But the thing is empty, unfortunately. Hm. Oh well[end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is " You can make out a kitchen island. [if there is something on the s_3]You see [a list of things on the s_3] on the kitchen island. I mean, just wow! Isn't TextWorld just the best?[end if]".
The kitchen part 8 is some text that varies. The kitchen part 8 is "[if there is nothing on the s_3]Unfortunately, there isn't a thing on it. Silly kitchen island, silly, empty, good for nothing kitchen island.[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You arrive in a bedroom. A standard one. Okay, just remember what you're here to do, and everything will go great.

 As if things weren't amazing enough already, you can even see a chest drawer.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0]. Wow, isn't TextWorld just the best?[end if]".
...
The bedroom part 6 is some text that varies. The bedroom part 6 is "[if there is nothing on the s_0]Looks like someone's already been here and taken everything off it, though. It would have been so cool if there was stuff on the king-size bed.[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You arrive in a backyard. An usual one.
 ...
 You see a set of chairs. The set of chairs is ordinary.[if there is something on the s_10] On the set of chairs you make out [a list of things on the s_10].[end if]".
The backyard part 1 is some text that varies. The backyard part 1 is "[if there is nothing on the s_10] However, the set of chairs, like an empty set of chairs, has nothing on it. You move on, clearly upset with your TextWorld experience.[end if]".
The backyard part 2 is some text that varies. The backyard part 2 is " You scan the room, seeing a bbq. The bbq is typical.[if there is something on the s_8] On the bbq you see [a list of things on the s_8]. Huh, weird.[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " Oh wow! Is that what I think it is? It is! It's a patio table. [if there is something on the s_9]On the patio table you make out [a list of things on the s_9].[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "Well, here we are in the living room. You decide to start listing off everything you see in the room, as if you were in a text adventure.

 You see a couch! [if there is something on the s_5]On the couch you can see [a list of things on the s_5].[end if]".
...
The living room part 4 is some text that varies. The living room part 4 is " You rest your hand against a wall, but you miss the wall and fall onto a tv. The tv is normal.[if there is something on the s_7] On the tv you can see [a list of things on the s_7].[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "I am sorry to announce that you are now in the bathroom.
 ...
 You can see a toilet. Wow, isn't TextWorld just the best?[if c_3 is open and there is something in the c_3] The toilet contains [a list of things in the c_3].[end if]".
...
The bathroom part 2 is some text that varies. The bathroom part 2 is " You make out a bath. Hmmm... what else, what else?[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4]. Classic TextWorld.[end if]".
...
The bathroom part 4 is some text that varies. The bathroom part 4 is " You can make out a sink. [if there is something on the s_4]On the sink you make out [a list of things on the s_4]. Classic TextWorld.[end if]".
The bathroom part 5 is some text that varies. The bathroom part 5 is "[if there is nothing on the s_4]But there isn't a thing on it.[end if]".
...
The description of k_0 is "The metal of the old key is satin.".
...
The description of o_1 is "The soap bar seems out of place here".
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! First thing I need you to do is to ensure that the chest drawer is open. Then, take the old key from the chest drawer in the bedroom. After that, insert the old key into the wood".
The objective part 1 is some text that varies. The objective part 1 is "en door's lock to unlock it. And then, make absolutely sure that the wooden door is opened. And then, make an effort to go to the east. Then, ensure that the screen door inside the kitchen is open. Th".
The objective part 2 is some text that varies. The objective part 2 is "en, move east. Next, travel south. And then, retrieve the lettuce from the floor of the garden. After that, make an effort to take a trip north. Then, go to the west. And then, sit the lettuce on the ".
The objective part 3 is some text that varies. The objective part 3 is "stove within the kitchen. Once that's all handled, you can stop!".
