...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is your task for today. First thing I need you to do is to open the antique trunk within the bedroom. After you have opened the antique trunk,".
The objective part 1 is some text that varies. The objective part 1 is " recover the old key from the antique trunk. After picking up the old key, unlock the wooden door. Then, make absolutely sure that the wooden door is ajar. After that, venture east. And then, look and".
The objective part 2 is some text that varies. The objective part 2 is " see that the screen door within the kitchen is ajar. After that, try to take a trip east. Then, go to the south. With that done, lift the half of a bag of chips from the floor of the garden. After th".
The objective part 3 is some text that varies. The objective part 3 is "at, go north. After that, head west. Okay, and then, rest the half of a bag of chips on the stove inside the kitchen. That's it!".
