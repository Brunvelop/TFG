...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First thing I need you to do is to open the chest drawer inside the bedroom. Then, take the old key from".
The objective part 1 is some text that varies. The objective part 1 is " the chest drawer inside the bedroom. And then, doublecheck that the wooden door is unlocked with the old key. And then, open the wooden door inside the bedroom. After that, take a trip east. And then".
The objective part 2 is some text that varies. The objective part 2 is ", assure that the screen door inside the kitchen is ajar. Then, move east. Then, move south. With that over with, pick up the lettuce from the floor of the garden. If you can get your hands on the let".
The objective part 3 is some text that varies. The objective part 3 is "tuce, venture north. Next, try to travel west. With that accomplished, rest the lettuce on the stove within the kitchen. Alright, thanks!".
