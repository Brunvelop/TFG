...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another profound episode of TextWorld! Here is your task for today. First stop, make it so that the chest drawer is open. And then, pick up the old key from the chest drawer. And then, make".
The objective part 1 is some text that varies. The objective part 1 is " it so that the wooden door within the bedroom is unlocked. If you have unlocked the wooden door, ensure that the wooden door is open. After that, make an attempt to go to the east. Then, open the scr".
The objective part 2 is some text that varies. The objective part 2 is "een door. Then, go east. Then, try to go to the south. Then, retrieve the tomato plant from the floor of the garden. After that, make an attempt to take a trip north. After that, make an attempt to tr".
The objective part 3 is some text that varies. The objective part 3 is "avel west. Next, place the tomato plant on the stove. Got that? Good!".
