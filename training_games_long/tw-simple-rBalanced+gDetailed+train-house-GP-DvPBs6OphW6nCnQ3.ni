...
The kitchen part 0 is some text that varies. The kitchen part 0 is "Fancy seeing you here. Here, by the way, being the kitchen.
 ...
 You make out a refrigerator.[if c_2 is open and there is something in the c_2] The refrigerator contains [a list of things in the c_2]. You can't wait to tell the folks at home about this![end if]".
...
The kitchen part 2 is some text that varies. The kitchen part 2 is " You scan the room for a counter, and you find a counter. The counter is typical.[if there is something on the s_1] On the counter you see [a list of things on the s_1].[end if]".
The kitchen part 3 is some text that varies. The kitchen part 3 is "[if there is nothing on the s_1] But oh no! there's nothing on this piece of trash. You move on, clearly infuriated by your TextWorld experience.[end if]".
The kitchen part 4 is some text that varies. The kitchen part 4 is " You scan the room, seeing a stove. [if there is something on the s_2]On the stove you can see [a list of things on the s_2].[end if]".
...
The kitchen part 10 is some text that varies. The kitchen part 10 is " wooden door leading west. There is an exit to the north. Don't worry, it is unblocked. There is an unguarded exit to the south.".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You find yourself in a bedroom. An usual kind of place.
 ...
 You bend down to tie your shoe. When you stand up, you notice a chest drawer.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0].[end if]".
...
The bedroom part 2 is some text that varies. The bedroom part 2 is " Oh wow! Is that what I think it is? It is! It's an antique trunk. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[if c_1 is open and there is something in the c_1] The antique trunk contains [a list of things in the c_1].[end if]".
...
The bedroom part 4 is some text that varies. The bedroom part 4 is " You can see a king-size bed. The king-size bed is typical.[if there is something on the s_0] On the king-size bed you can see [a list of things on the s_0].[end if]".
...
The backyard part 1 is some text that varies. The backyard part 1 is "[if there is nothing on the s_10]But the thing is empty. It would have been so cool if there was stuff on the set of chairs.[end if]".
The backyard part 2 is some text that varies. The backyard part 2 is " You see a bbq. The bbq is ordinary.[if there is something on the s_8] On the bbq you can see [a list of things on the s_8].[end if]".
...
The backyard part 5 is some text that varies. The backyard part 5 is "[if there is nothing on the s_9]But oh no! there's nothing on this piece of junk. What, you think everything in TextWorld should have stuff on it?[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You are in a living room. A normal kind of place.
 ...
 Oh, great. Here's a couch. The couch is ordinary.[if there is something on the s_5] On the couch you see [a list of things on the s_5].[end if]".
The living room part 1 is some text that varies. The living room part 1 is "[if there is nothing on the s_5] The couch appears to be empty. You make a mental note to not get your hopes up the next time you see a couch in a room.[end if]".
The living room part 2 is some text that varies. The living room part 2 is " Were you looking for a low table? Because look over there, it's a low table. [if there is something on the s_6]You see [a list of things on the s_6] on the low table.[end if]".
...
The bathroom part 2 is some text that varies. The bathroom part 2 is " Hey, want to see a bath? Look over there, a bath.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4].[end if]".
...
The bathroom part 4 is some text that varies. The bathroom part 4 is " You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a sink. The sink is normal.[if there is something on the s_4] On the sink you see [a list of things on the s_4].[end if]".
The bathroom part 5 is some text that varies. The bathroom part 5 is "[if there is nothing on the s_4] But the thing is empty, unfortunately. Aw, here you were, all excited for there to be things on it![end if]".
...
The description of d_0 is "it's a rugged wooden door [if open]It is open.[else if closed]It is closed.[otherwise]It is locked.[end if]".
The printed name of d_0 is "wooden door".
Understand "wooden door" as d_0.
Understand "wooden" as d_0.
Understand "door" as d_0.
The d_0 is locked.
The description of d_1 is "The screen door looks solid. [if open]You can see inside it.[else if closed]You can't see inside it because the lid's in your way.[otherwise]There is a lock on it.[end if]".
...
The description of f_1 is "that's an usual milk!".
...
The description of o_0 is "The toothbrush seems out of place here".
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First off, if it's not too much trouble, I need you to look and see that the antique trunk within the be".
The objective part 1 is some text that varies. The objective part 1 is "droom is ajar. After that, retrieve the old key from the antique trunk. Once you have taken the old key, unlock the wooden door inside the bedroom. And then, assure that the wooden door within the bed".
The objective part 2 is some text that varies. The objective part 2 is "room is open. After that, try to head east. Then, make absolutely sure that the refrigerator is wide open. And then, take the tomato plant from the refrigerator. And then, place the tomato plant on th".
The objective part 3 is some text that varies. The objective part 3 is "e stove. And once you've done that, you win!".
