...
The kitchen part 0 is some text that varies. The kitchen part 0 is "Of every kitchen you could have shown up in, you had to come round an usual one. I guess you better just go and list everything you see here.

 You can see [if c_2 is locked]a locked[else if c_2 is open]an opened[otherwise]a closed[end if]".
The kitchen part 1 is some text that varies. The kitchen part 1 is " refrigerator.[if c_2 is open and there is something in the c_2] The refrigerator contains [a list of things in the c_2].[end if]".
The kitchen part 2 is some text that varies. The kitchen part 2 is "[if c_2 is open and the c_2 contains nothing] The refrigerator is empty! What a waste of a day![end if]".
The kitchen part 3 is some text that varies. The kitchen part 3 is " You see a counter. [if there is something on the s_1]On the counter you can make out [a list of things on the s_1].[end if]".
The kitchen part 4 is some text that varies. The kitchen part 4 is "[if there is nothing on the s_1]Looks like someone's already been here and taken everything off it, though. Sometimes, just sometimes, TextWorld can just be the worst.[end if]".
The kitchen part 5 is some text that varies. The kitchen part 5 is " You can see a stove. [if there is something on the s_2]On the stove you can see [a list of things on the s_2]. There's something strange about this thing being here, but you don't have time to worry about that now.[end if]".
The kitchen part 6 is some text that varies. The kitchen part 6 is "[if there is nothing on the s_2]But the thing is empty, unfortunately.[end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is " You make out a kitchen island. The kitchen island is typical.[if there is something on the s_3] On the kitchen island you make out [a list of things on the s_3].[end if]".
The kitchen part 8 is some text that varies. The kitchen part 8 is "[if there is nothing on the s_3] But there isn't a thing on it.[end if]".
...
The kitchen part 11 is some text that varies. The kitchen part 11 is " wooden door leading west. You need an unblocked exit? You should try going north. There is an unblocked exit to the south.".
...
The bedroom part 4 is some text that varies. The bedroom part 4 is " antique trunk here.[if c_1 is open and there is something in the c_1] The antique trunk contains [a list of things in the c_1]. You can't wait to tell the folks at home about this![end if]".
The bedroom part 5 is some text that varies. The bedroom part 5 is "[if c_1 is open and the c_1 contains nothing] What a letdown! The antique trunk is empty![end if]".
The bedroom part 6 is some text that varies. The bedroom part 6 is " You bend down to tie your shoe. When you stand up, you notice a king-size bed. What a coincidence, weren't you just thinking about a king-size bed? The king-size bed is normal.[if there is something on the s_0] On the king-size bed you can make out [a list of things on the s_0].[end if]".
The bedroom part 7 is some text that varies. The bedroom part 7 is "[if there is nothing on the s_0] Unfortunately, there isn't a thing on it.[end if]".
The bedroom part 8 is some text that varies. The bedroom part 8 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The bedroom part 9 is some text that varies. The bedroom part 9 is " wooden door leading east.".
The description of r_0 is "[bedroom part 0][bedroom part 1][bedroom part 2][bedroom part 3][bedroom part 4][bedroom part 5][bedroom part 6][bedroom part 7][bedroom part 8][bedroom part 9]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You find yourself in a backyard.
 ...
 You can make out a set of chairs. The set of chairs is normal.[if there is something on the s_10] On the set of chairs you make out [a list of things on the s_10].[end if]".
The backyard part 1 is some text that varies. The backyard part 1 is "[if there is nothing on the s_10] However, the set of chairs, like an empty set of chairs, has nothing on it.[end if]".
The backyard part 2 is some text that varies. The backyard part 2 is " Look out! It's a- oh, never mind, it's just a bbq. [if there is something on the s_8]You see [a list of things on the s_8] on the bbq.[end if]".
The backyard part 3 is some text that varies. The backyard part 3 is "[if there is nothing on the s_8]But oh no! there's nothing on this piece of trash. Aw, here you were, all excited for there to be things on it![end if]".
The backyard part 4 is some text that varies. The backyard part 4 is " You see a patio table! The patio table is typical.[if there is something on the s_9] On the patio table you see [a list of things on the s_9].[end if]".
The backyard part 5 is some text that varies. The backyard part 5 is "[if there is nothing on the s_9] However, the patio table, like an empty patio table, has nothing on it. It would have been so cool if there was stuff on the patio table.[end if]".
The backyard part 6 is some text that varies. The backyard part 6 is "

 There is [if d_1 is open]an open[otherwise]a closed[end if]".
The backyard part 7 is some text that varies. The backyard part 7 is " screen door leading west. There is an exit to the south. Don't worry, it is unblocked.".
...
The living room part 0 is some text that varies. The living room part 0 is "Well I'll be, you are in the place we're calling the living room. You try to gain information on your surroundings by using a technique you call 'looking.'

 You see a couch. The couch is normal.[if there is something on the s_5] On the couch you see [a list of things on the s_5].[end if]".
The living room part 1 is some text that varies. The living room part 1 is "[if there is nothing on the s_5] Looks like someone's already been here and taken everything off it, though. It would have been so cool if there was stuff on the couch.[end if]".
The living room part 2 is some text that varies. The living room part 2 is " You can see a low table. The low table is typical.[if there is something on the s_6] On the low table you can see [a list of things on the s_6].[end if]".
The living room part 3 is some text that varies. The living room part 3 is "[if there is nothing on the s_6] But oh no! there's nothing on this piece of garbage. This always happens![end if]".
The living room part 4 is some text that varies. The living room part 4 is " Were you looking for a tv? Because look over there, it's a tv. [if there is something on the s_7]You see [a list of things on the s_7] on the tv. Wow! Just like in the movies![end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "Okay, so you're in a bathroom, cool, but is it typical? You better believe it is. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The bathroom part 3 is some text that varies. The bathroom part 3 is " You can make out a bath. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4]. Hmmm... what else, what else?[end if]".
...
The bathroom part 5 is some text that varies. The bathroom part 5 is " You see a sink. The sink is ordinary.[if there is something on the s_4] On the sink you see [a list of things on the s_4].[end if]".
The bathroom part 6 is some text that varies. The bathroom part 6 is "[if there is nothing on the s_4] But the thing is empty, unfortunately.[end if]".
...
The garden part 0 is some text that varies. The garden part 0 is "Of every garden you could have shown up in, you had to show up in an ordinary one. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The d_0 is locked.
The description of d_1 is "The screen door looks hefty. [if open]You can see inside it.[else if closed]You can't see inside it because the lid's in your way.[otherwise]There is a lock on it.[end if]".
...
The c_0 is in r_0.
The c_0 is closed.
The description of c_1 is "The antique trunk looks strong, and impossible to break. [if open]You can see inside it.[else if closed]You can't see inside it because the lid's in your way.[otherwise]There is a lock on it.[end if]".
...
The c_3 is in r_3.
The c_3 is closed.
The description of c_4 is "The bath looks strong, and impossible to destroy. [if open]You can see inside it.[else if closed]You can't see inside it because the lid's in your way.[otherwise]There is a lock on it.[end if]".
The printed name of c_4 is "bath".
Understand "bath" as c_4.
The c_4 is in r_3.
The c_4 is closed.
The description of f_3 is "that's an usual apple!".
The printed name of f_3 is "apple".
Understand "apple" as f_3.
The f_3 is in r_5.
The f_3 is edible.
The description of f_4 is "that's a typical half of a bag of chips!".
...
The f_4 is in r_5.
The f_4 is edible.
The description of f_5 is "that's an usual lettuce!".
The printed name of f_5 is "lettuce".
Understand "lettuce" as f_5.
The f_5 is in r_5.
The f_5 is edible.
The description of o_3 is "The shovel appears to be well matched to everything else here".
The printed name of o_3 is "shovel".
Understand "shovel" as o_3.
The o_3 is in r_5.
The description of s_0 is "The king-size bed is balanced.".
...
The s_3 is in r_1.
The description of s_4 is "The sink is stable.".
...
The s_8 is in r_4.
The description of s_9 is "The patio table is undependable.".
...
The description of k_0 is "The old key is cold to the touch".
...
The description of o_1 is "The soap bar is well-used.".
...
The description of o_0 is "The toothbrush appears to be well matched to everything else here".
The printed name of o_0 is "toothbrush".
Understand "toothbrush" as o_0.
The o_0 is on the s_4.
The description of o_2 is "The remote appears out of place here".
The printed name of o_2 is "remote".
Understand "remote" as o_2.
The o_2 is on the s_6.
The description of o_4 is "The dinner is almost ready! It's only missing a grilled apple.".
...
Test quest8_0 with "open chest drawer / take old key from chest drawer / unlock wooden door with old key / open wooden door / go east / open screen door / go east / go south / take apple"
...
Test quest9_0 with "open chest drawer / take old key from chest drawer / unlock wooden door with old key / open wooden door / go east / open screen door / go east / go south / take apple / go north / go west / put apple on stove"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an profound round of TextWorld? You do! Here is your task for today. First, it would be a great idea if you could make absolutely sure that the".
The objective part 1 is some text that varies. The objective part 1 is " chest drawer inside the bedroom is opened. After that, retrieve the old key from the chest drawer within the bedroom. And then, check that the wooden door is unlocked with the old key. And then, make".
The objective part 2 is some text that varies. The objective part 2 is " absolutely sure that the wooden door in the bedroom is wide open. After opening the wooden door, take a trip east. Next, make it so that the screen door is opened. And then, go to the east. Then, tak".
The objective part 3 is some text that varies. The objective part 3 is "e a trip south. If you can finish that, retrieve the apple from the floor of the garden. And then, try to travel north. Following that, attempt to head west. And then, put the apple on the stove withi".
The objective part 4 is some text that varies. The objective part 4 is "n the kitchen. Alright, thanks!".
