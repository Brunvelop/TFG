...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First off, if it's not too much trouble, I need you to ensure that the antique trunk is open. And then, ".
The objective part 1 is some text that varies. The objective part 1 is "pick up the old key from the antique trunk. After getting the old key, check that the wooden door is unlocked with the old key. Then, open the wooden door within the bedroom. And then, attempt to vent".
The objective part 2 is some text that varies. The objective part 2 is "ure east. After that, make absolutely sure that the screen door is ajar. Then, take a trip east. With that over with, venture south. And then, lift the apple from the floor of the garden. And then, ve".
The objective part 3 is some text that varies. The objective part 3 is "nture north. Following that, travel west. With that done, rest the apple on the stove inside the kitchen. And once you've done that, you win!".
