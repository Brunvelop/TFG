...
The kitchen part 3 is some text that varies. The kitchen part 3 is " You can make out a counter. [if there is something on the s_1]You see [a list of things on the s_1] on the counter. Huh, weird.[end if]".
...
The kitchen part 5 is some text that varies. The kitchen part 5 is " You see a stove. Wow, isn't TextWorld just the best? The stove is typical.[if there is something on the s_2] On the stove you can see [a list of things on the s_2].[end if]".
The kitchen part 6 is some text that varies. The kitchen part 6 is "[if there is nothing on the s_2] But the thing is empty.[end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is " You see a kitchen island. The kitchen island is normal.[if there is something on the s_3] On the kitchen island you see [a list of things on the s_3].[end if]".
The kitchen part 8 is some text that varies. The kitchen part 8 is "[if there is nothing on the s_3] But the thing is empty, unfortunately. It would have been so cool if there was stuff on the kitchen island.[end if]".
...
The kitchen part 11 is some text that varies. The kitchen part 11 is " wooden door leading west. There is an unguarded exit to the north. You need an unguarded exit? You should try going south.".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You find yourself in a bedroom. An usual one. You can barely contain your excitement.
...
The bedroom part 4 is some text that varies. The bedroom part 4 is " What's that over there? It looks like it's a king-size bed. [if there is something on the s_0]You see [a list of things on the s_0] on the king-size bed. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
The bedroom part 5 is some text that varies. The bedroom part 5 is "[if there is nothing on the s_0]However, the king-size bed, like an empty king-size bed, has nothing on it. Aw, here you were, all excited for there to be things on it![end if]".
...
The backyard part 1 is some text that varies. The backyard part 1 is "[if there is nothing on the s_10]But oh no! there's nothing on this piece of junk. Oh! Why couldn't there just be stuff on it?[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You scan the room, seeing a patio table. Now why would someone leave that there? The patio table is usual.[if there is something on the s_9] On the patio table you can make out [a list of things on the s_9]. Hmmm... what else, what else?[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "Well, here we are in a living room.
 ...
 You bend down to tie your shoe. When you stand up, you notice a couch. The couch is ordinary.[if there is something on the s_5] On the couch you make out [a list of things on the s_5].[end if]".
...
The living room part 2 is some text that varies. The living room part 2 is " You can see a low table. Wow, isn't TextWorld just the best? The low table is usual.[if there is something on the s_6] On the low table you see [a list of things on the s_6].[end if]".
The living room part 3 is some text that varies. The living room part 3 is "[if there is nothing on the s_6] But the thing is empty. This always happens![end if]".
The living room part 4 is some text that varies. The living room part 4 is " You see a tv. The tv is standard.[if there is something on the s_7] On the tv you see [a list of things on the s_7].[end if]".
The living room part 5 is some text that varies. The living room part 5 is "[if there is nothing on the s_7] But oh no! there's nothing on this piece of garbage.[end if]".
...
The bathroom part 3 is some text that varies. The bathroom part 3 is " You can make out a bath. You can't wait to tell the folks at home about this![if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4].[end if]".
...
The bathroom part 5 is some text that varies. The bathroom part 5 is " You see a sink. The sink is usual.[if there is something on the s_4] On the sink you see [a list of things on the s_4].[end if]".
...
The c_4 is in r_3.
The c_4 is closed.
The description of f_3 is "The tomato plant looks tantalizing.".
...
The description of f_2 is "The bell pepper looks heavenly.".
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another fast paced round of TextWorld! Here is your task for today. First step, open the antique trunk in the bedroom. And then, take the old key from the antique trunk within the bedroom. ".
The objective part 1 is some text that varies. The objective part 1 is "And then, unlock the wooden door. And then, open the wooden door inside the bedroom. And then, travel east. After that, ensure that the screen door within the kitchen is open. And then, try to go east".
The objective part 2 is some text that varies. The objective part 2 is ". Next, go to the south. Then, pick up the half of a bag of chips from the floor of the garden. And then, head north. If you can accomplish that, make an effort to go west. Okay, and then, sit the hal".
The objective part 3 is some text that varies. The objective part 3 is "f of a bag of chips on the stove in the kitchen. Got that? Good!".
