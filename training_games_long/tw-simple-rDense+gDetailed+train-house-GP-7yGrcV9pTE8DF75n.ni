...
The objective part 2 is some text that varies. The objective part 2 is "with, recover the apple from the floor of the garden. If you can get your hands on the apple, attempt to venture north. Then, make an effort to take a trip west. Following that, rest the apple on the ".
The objective part 3 is some text that varies. The objective part 3 is "stove. That's it!".
