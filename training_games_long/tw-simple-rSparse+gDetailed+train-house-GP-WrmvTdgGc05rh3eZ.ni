...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. Your first objective is to ensure that the chest drawer inside the bedroom is open. After that, recover ".
The objective part 1 is some text that varies. The objective part 1 is "the old key from the chest drawer within the bedroom. After that, doublecheck that the wooden door in the bedroom is unlocked. After that, make sure that the wooden door is open. After opening the woo".
The objective part 2 is some text that varies. The objective part 2 is "den door, attempt to go east. Then, assure that the refrigerator is wide open. Then, recover the milk from the refrigerator inside the kitchen. Then, put the milk on the stove. Alright, thanks!".
