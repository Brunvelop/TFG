...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is how to play! First stop, ensure that the antique trunk is open. And then, pick up the old key from the antique trunk in the bedroom. Then, unlock the wooden door. After t".
The objective part 1 is some text that varies. The objective part 1 is "hat, ensure that the wooden door is open. Then, venture east. Then, take a trip south. Okay, and then, retrieve the milk from the couch inside the living room. Having picked up the milk, make an effor".
The objective part 2 is some text that varies. The objective part 2 is "t to head north. And then, place the milk on the stove. Alright, thanks!".
