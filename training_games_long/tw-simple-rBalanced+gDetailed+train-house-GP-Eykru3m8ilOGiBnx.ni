...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a life changing round of TextWorld! First off, if it's not too much trouble, I need you to make absolutely sure that the antique trunk is opened. And then, take the old key from th".
The objective part 1 is some text that varies. The objective part 1 is "e antique trunk within the bedroom. After that, unlock the wooden door inside the bedroom. After that, open the wooden door inside the bedroom. After that, head east. Once you get through with that, v".
The objective part 2 is some text that varies. The objective part 2 is "enture south. And then, retrieve the apple from the couch within the living room. If you can get your hands on the apple, move north. Okay, and then, sit the apple on the stove. And once you've done t".
The objective part 3 is some text that varies. The objective part 3 is "hat, you win!".
