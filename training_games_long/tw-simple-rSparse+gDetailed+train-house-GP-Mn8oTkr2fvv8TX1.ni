...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! First, it would be fantastic if you could ensure that the chest drawer in the bedroom is open. And then, recover".
The objective part 1 is some text that varies. The objective part 1 is " the old key from the chest drawer inside the bedroom. Then, make absolutely sure that the wooden door in the bedroom is unlocked with the old key. If you have unlocked the wooden door, ensure that th".
The objective part 2 is some text that varies. The objective part 2 is "e wooden door in the bedroom is open. Having pulled open the wooden door, make an attempt to head east. Then, open the screen door within the kitchen. After that, head east. Then, take a trip south. T".
The objective part 3 is some text that varies. The objective part 3 is "hen, retrieve the bell pepper from the floor of the garden. Then, head north. With that done, move west. Next, place the bell pepper on the stove within the kitchen. That's it!".
