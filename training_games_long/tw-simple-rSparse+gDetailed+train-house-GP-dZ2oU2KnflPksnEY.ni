...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a life changing round of TextWorld! Here is your task for today. First step, make absolutely sure that the chest drawer within the bedroom is wide open. After that, pick up the old".
The objective part 1 is some text that varies. The objective part 1 is " key from the chest drawer in the bedroom. Then, assure that the wooden door within the bedroom is unlocked. And then, ensure that the wooden door is open. And then, take a trip east. And then, open t".
The objective part 2 is some text that varies. The objective part 2 is "he screen door. After pulling open the screen door, take a trip east. Then, make an attempt to go to the south. Then, lift the lettuce from the floor of the garden. After that, head north. Then, attem".
The objective part 3 is some text that varies. The objective part 3 is "pt to venture west. If you can finish that, place the lettuce on the stove. Once that's all handled, you can stop!".
