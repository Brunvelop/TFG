...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First stop, open the antique trunk within the bedroom. After that, take the old key from the antique tru".
The objective part 1 is some text that varies. The objective part 1 is "nk inside the bedroom. After that, unlock the wooden door. Then, make sure that the wooden door in the bedroom is opened. And then, take a trip east. And then, open the screen door. And then, try to g".
The objective part 2 is some text that varies. The objective part 2 is "o east. Following that, venture south. And then, recover the apple from the floor of the garden. After that, go north. After that, move west. Then, put the apple on the stove. Alright, thanks!".
