...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a fast paced episode of TextWorld! Here is how to play! First thing I need you to do is to ensure that the chest drawer within the bedroom is open. And then, take the old key from ".
The objective part 1 is some text that varies. The objective part 1 is "the chest drawer. And then, unlock the wooden door. Then, make absolutely sure that the wooden door inside the bedroom is open. After that, make an effort to take a trip east. Then, ensure that the re".
The objective part 2 is some text that varies. The objective part 2 is "frigerator inside the kitchen is open. And then, retrieve the lettuce from the refrigerator in the kitchen. Then, rest the lettuce on the stove in the kitchen. And if you do that, you're the winner!".
