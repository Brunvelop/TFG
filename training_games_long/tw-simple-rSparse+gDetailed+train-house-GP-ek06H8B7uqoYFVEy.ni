...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a exciting session of TextWorld! First off, ensure that the antique trunk is open. Once you have pulled open the antique trunk, take the old key from the antique trunk in the bedro".
The objective part 1 is some text that varies. The objective part 1 is "om. After taking the old key, insert the old key into the wooden door within the bedroom's lock to unlock it. If you have unlocked the wooden door, ensure that the wooden door is open. After that, tak".
The objective part 2 is some text that varies. The objective part 2 is "e a trip east. And then, open the screen door within the kitchen. After opening the screen door, go to the east. After that, make an attempt to head south. With that accomplished, pick-up the half of ".
The objective part 3 is some text that varies. The objective part 3 is "a bag of chips from the floor of the garden. And then, make an attempt to go to the north. And then, take a trip west. After that, place the half of a bag of chips on the stove. And if you do that, yo".
The objective part 4 is some text that varies. The objective part 4 is "u're the winner!".
