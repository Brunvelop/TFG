...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You've just shown up in a kitchen.
 ...
 Look out! It's a- oh, never mind, it's just a refrigerator.[if c_2 is open and there is something in the c_2] The refrigerator contains [a list of things in the c_2].[end if]".
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " You rest your hand against a wall, but you miss the wall and fall onto a stove. You wonder idly who left that here. The stove is standard.[if there is something on the s_2] On the stove you make out [a list of things on the s_2].[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "Well, here we are in a bedroom.
 ...
 You bend down to tie your shoe. When you stand up, you notice a chest drawer, so there's that.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0]. You wonder idly who left that here.[end if]".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " You make out a king-size bed. The king-size bed is typical.[if there is something on the s_0] On the king-size bed you make out [a list of things on the s_0].[end if]".
The bedroom part 6 is some text that varies. The bedroom part 6 is "[if there is nothing on the s_0] But the thing hasn't got anything on it. What, you think everything in TextWorld should have stuff on it?[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "Okay, so you're in a backyard, cool, but is it ordinary? You better believe it is. The room is well lit.
...
The backyard part 1 is some text that varies. The backyard part 1 is "[if there is nothing on the s_10]The set of chairs appears to be empty. Hopefully this doesn't make you too upset.[end if]".
The backyard part 2 is some text that varies. The backyard part 2 is " You see a bbq. The bbq is normal.[if there is something on the s_8] On the bbq you can make out [a list of things on the s_8].[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " Oh wow! Is that what I think it is? It is! It's a patio table. The patio table is standard.[if there is something on the s_9] On the patio table you see [a list of things on the s_9].[end if]".
...
The living room part 4 is some text that varies. The living room part 4 is " You rest your hand against a wall, but you miss the wall and fall onto a tv. [if there is something on the s_7]You see [a list of things on the s_7] on the tv. Huh, weird.[end if]".
...
The bathroom part 4 is some text that varies. The bathroom part 4 is " bath here.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4]. Make a note of this, you might have to put stuff on or in it later on.[end if]".
...
The bathroom part 6 is some text that varies. The bathroom part 6 is " You see a sink. The sink is ordinary.[if there is something on the s_4] On the sink you can make out [a list of things on the s_4].[end if]".
The bathroom part 7 is some text that varies. The bathroom part 7 is "[if there is nothing on the s_4] But the thing hasn't got anything on it. What's the point of an empty sink?[end if]".
...
The c_4 is in r_3.
The c_4 is closed.
The description of f_3 is "that's an ordinary lettuce!".
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is your task for today. First stop, open the antique trunk. After that, take the old key from the antique t".
The objective part 1 is some text that varies. The objective part 1 is "runk in the bedroom. After that, make it so that the wooden door within the bedroom is unlocked with the old key. And then, ensure that the wooden door within the bedroom is open. And then, head east.".
The objective part 2 is some text that varies. The objective part 2 is " Then, ensure that the screen door is open. And then, make an attempt to head east. After that, try to take a trip south. After that, pick-up the apple from the floor of the garden. After that, try to".
The objective part 3 is some text that varies. The objective part 3 is " head north. With that done, try to travel west. After that, put the apple on the stove. Once that's all handled, you can stop!".
