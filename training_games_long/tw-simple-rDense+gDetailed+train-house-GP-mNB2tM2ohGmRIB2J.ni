...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You are in a kitchen. A typical kind of place.
 ...
 What's that over there? It looks like it's a refrigerator.[if c_2 is open and there is something in the c_2] The refrigerator contains [a list of things in the c_2].[end if]".
...
The kitchen part 2 is some text that varies. The kitchen part 2 is " You see a counter. The counter is typical.[if there is something on the s_1] On the counter you see [a list of things on the s_1].[end if]".
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " If you haven't noticed it already, there seems to be something there by the wall, it's a stove. [if there is something on the s_2]On the stove you see [a list of things on the s_2]. Classic TextWorld.[end if]".
...
The kitchen part 10 is some text that varies. The kitchen part 10 is " wooden door leading west. There is an unguarded exit to the north. There is an unguarded exit to the south.".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You are in a bedroom. A normal kind of place.
 ...
 What's that over there? It looks like it's a chest drawer.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0]. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " You scan the room for a king-size bed, and you find a king-size bed. The king-size bed is standard.[if there is something on the s_0] On the king-size bed you see [a list of things on the s_0]. Huh, weird.[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You make out a bbq. The bbq is ordinary.[if there is something on the s_8] On the bbq you see [a list of things on the s_8].[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You find yourself in a living room. A standard one.

 You see a couch. [if there is something on the s_5]On the couch you make out [a list of things on the s_5].[end if]".
...
The living room part 2 is some text that varies. The living room part 2 is " What's that over there? It looks like it's a low table. [if there is something on the s_6]On the low table you can see [a list of things on the s_6]. Wow! Just like in the movies![end if]".
...
The living room part 4 is some text that varies. The living room part 4 is " Hey, want to see a tv? Look over there, a tv. [if there is something on the s_7]On the tv you see [a list of things on the s_7].[end if]".
...
The bathroom part 5 is some text that varies. The bathroom part 5 is " You bend down to tie your shoe. When you stand up, you notice a sink. [if there is something on the s_4]You see [a list of things on the s_4] on the sink.[end if]".
...
The f_5 is in r_5.
The f_5 is edible.
The description of o_3 is "The shovel seems well matched to everything else here".
...
The s_9 is in r_4.
The description of f_0 is "The milk looks delectable.".
...
The description of f_2 is "The tomato plant looks appealing.".
...
The description of o_1 is "The soap bar is modern.".
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! First off, if it's not too much trouble, I need you to look and see that the antique trunk is open. And then, retrieve the old key from the antique".
The objective part 1 is some text that varies. The objective part 1 is " trunk. And then, unlock the wooden door inside the bedroom. After that, ensure that the wooden door is open. After that, make an effort to travel east. After that, ensure that the refrigerator within".
The objective part 2 is some text that varies. The objective part 2 is " the kitchen is open. Then, retrieve the milk from the refrigerator within the kitchen. And then, put the milk on the stove inside the kitchen. And if you do that, you're the winner!".
