...
The kitchen part 4 is some text that varies. The kitchen part 4 is " You can make out a stove. You wonder idly who left that here. [if there is something on the s_2]On the stove you see [a list of things on the s_2].[end if]".
...
The kitchen part 10 is some text that varies. The kitchen part 10 is " wooden door leading west. There is an exit to the north. Don't worry, it is unguarded. You don't like doors? Why not try going south, that entranceway is unblocked.".
...
The bedroom part 1 is some text that varies. The bedroom part 1 is " chest drawer in the room.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0].[end if]".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " You scan the room, seeing a king-size bed. Wow, isn't TextWorld just the best? The king-size bed is standard.[if there is something on the s_0] On the king-size bed you can make out [a list of things on the s_0].[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You arrive in a backyard. An usual kind of place. You begin looking for stuff.

 You can see a set of chairs. [if there is something on the s_10]On the set of chairs you can see [a list of things on the s_10].[end if]".
The backyard part 1 is some text that varies. The backyard part 1 is "[if there is nothing on the s_10]But the thing hasn't got anything on it. Hopefully this doesn't make you too upset.[end if]".
The backyard part 2 is some text that varies. The backyard part 2 is " You make out a bbq. [if there is something on the s_8]You see [a list of things on the s_8] on the bbq. There's something strange about this thing being here, but you don't have time to worry about that now.[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You can see a patio table. The patio table is typical.[if there is something on the s_9] On the patio table you can see [a list of things on the s_9].[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You're now in a living room.
 ...
 You can see a couch. The couch is typical.[if there is something on the s_5] On the couch you see [a list of things on the s_5]. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
...
The living room part 2 is some text that varies. The living room part 2 is " You make out a low table. The low table is typical.[if there is something on the s_6] On the low table you can make out [a list of things on the s_6]. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
The living room part 3 is some text that varies. The living room part 3 is "[if there is nothing on the s_6] However, the low table, like an empty low table, has nothing on it. It would have been so cool if there was stuff on the low table.[end if]".
The living room part 4 is some text that varies. The living room part 4 is " You can see a tv. Wow, isn't TextWorld just the best? [if there is something on the s_7]You see [a list of things on the s_7] on the tv. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[end if]".
...
The bathroom part 1 is some text that varies. The bathroom part 1 is " typical looking toilet in the room.[if c_3 is open and there is something in the c_3] The toilet contains [a list of things in the c_3].[end if]".
...
The bathroom part 4 is some text that varies. The bathroom part 4 is " bath in the corner.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4].[end if]".
...
The bathroom part 6 is some text that varies. The bathroom part 6 is " You make out a sink. The sink is standard.[if there is something on the s_4] On the sink you can see [a list of things on the s_4]. You can't wait to tell the folks at home about this![end if]".
The bathroom part 7 is some text that varies. The bathroom part 7 is "[if there is nothing on the s_4] But oh no! there's nothing on this piece of trash. You swear loudly.[end if]".
...
The description of d_0 is "The wooden door looks rugged. [if open]You can see inside it.[else if closed]You can't see inside it because the lid's in your way.[otherwise]There is a lock on it.[end if]".
...
The s_9 is in r_4.
The description of f_0 is "that's a normal bell pepper!".
...
Test quest5_0 with "open antique trunk / take old key from antique trunk / unlock wooden door with old key / open wooden door / go east / open refrigerator / take bell pepper from refrigerator"
...
Test quest6_0 with "open antique trunk / take old key from antique trunk / unlock wooden door with old key / open wooden door / go east / open refrigerator / take bell pepper from refrigerator / put bell pepper on stove"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another profound episode of TextWorld! First step, make absolutely sure that the antique trunk inside the bedroom is open. After pulling open the antique trunk, recover the old key from the".
The objective part 1 is some text that varies. The objective part 1 is " antique trunk within the bedroom. If you can get your hands on the old key, unlock the wooden door within the bedroom. And then, open the wooden door. Then, head east. Then, ensure that the refrigera".
The objective part 2 is some text that varies. The objective part 2 is "tor is open. Then, recover the bell pepper from the refrigerator. Then, put the bell pepper on the stove within the kitchen. And once you've done that, you win!".
