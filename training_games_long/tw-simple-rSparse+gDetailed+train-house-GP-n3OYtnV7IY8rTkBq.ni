...
The objective part 1 is some text that varies. The objective part 1 is "in the bedroom is open. After opening the chest drawer, take the old key from the chest drawer inside the bedroom. And then, unlock the wooden door. And then, ensure that the wooden door is open. And ".
The objective part 2 is some text that varies. The objective part 2 is "then, travel east. Next, make absolutely sure that the refrigerator in the kitchen is opened. After that, recover the apple from the refrigerator. After getting the apple, rest the apple on the stove.".
