...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a fast paced game of TextWorld! Here is your task for today. Your first objective is to ensure that the antique trunk inside the bedroom is open. After that, take the old key from ".
The objective part 1 is some text that varies. The objective part 1 is "the antique trunk. And then, make it so that the wooden door is unlocked. Then, ensure that the wooden door is open. After opening the wooden door, travel east. Then, attempt to venture south. Then, t".
The objective part 2 is some text that varies. The objective part 2 is "ake the milk from the couch. After that, attempt to take a trip north. After that, put the milk on the stove in the kitchen. Alright, thanks!".
