...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! First of all, make sure that the antique trunk within the bedroom is wide open. And then, retrieve the old key from the antique trunk. After that, ".
The objective part 1 is some text that varies. The objective part 1 is "make sure that the wooden door is unlocked with the old key. And then, ensure that the wooden door within the bedroom is open. After pulling open the wooden door, make an effort to head east. And then".
The objective part 2 is some text that varies. The objective part 2 is ", ensure that the screen door is open. And then, venture east. After that, take a trip south. Next, recover the apple from the floor of the garden. And then, head north. Following that, go to the west".
The objective part 3 is some text that varies. The objective part 3 is ". After that, put the apple on the stove. That's it!".
