...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! First stop, ensure that the chest drawer is open. And then, recover the old key from the chest drawer inside the bedroom. Then, unlock the wooden door. Then, make absolutely sure".
The objective part 1 is some text that varies. The objective part 1 is " that the wooden door is open. And then, go to the east. Then, assure that the refrigerator is ajar. And then, retrieve the apple from the refrigerator. And then, sit the apple on the stove. And if yo".
The objective part 2 is some text that varies. The objective part 2 is "u do that, you're the winner!".
