...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You've just sauntered into a kitchen. Let's see what's in here.
 ...
 Were you looking for a refrigerator? Because look over there, it's a refrigerator.[if c_2 is open and there is something in the c_2] The refrigerator contains [a list of things in the c_2]. You can't wait to tell the folks at home about this![end if]".
...
The kitchen part 2 is some text that varies. The kitchen part 2 is " Look out! It's a- oh, never mind, it's just a counter. The counter is usual.[if there is something on the s_1] On the counter you can see [a list of things on the s_1].[end if]".
The kitchen part 3 is some text that varies. The kitchen part 3 is "[if there is nothing on the s_1] But oh no! there's nothing on this piece of junk. Hm. Oh well[end if]".
The kitchen part 4 is some text that varies. The kitchen part 4 is " You make out a stove. [if there is something on the s_2]On the stove you can make out [a list of things on the s_2].[end if]".
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " You can make out a kitchen island. The kitchen island is normal.[if there is something on the s_3] On the kitchen island you can make out [a list of things on the s_3].[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "I am excited to announce that you are now in the bedroom. You start to take note of what's in the room.
 ...
 You make out a chest drawer. Hmm. You always thought you'd be more excited to see a chest drawer in a room.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0]. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
...
The bedroom part 2 is some text that varies. The bedroom part 2 is " You smell an awful smell, and follow it to an antique trunk.[if c_1 is open and there is something in the c_1] The antique trunk contains [a list of things in the c_1]. Now that's what I call TextWorld![end if]".
...
The bedroom part 4 is some text that varies. The bedroom part 4 is " You can make out a king-size bed. [if there is something on the s_0]You see [a list of things on the s_0] on the king-size bed. You can't wait to tell the folks at home about this![end if]".
The bedroom part 5 is some text that varies. The bedroom part 5 is "[if there is nothing on the s_0]Unfortunately, there isn't a thing on it. What, you think everything in TextWorld should have stuff on it?[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You arrive in a backyard. A standard kind of place.
 ...
 Oh wow! Is that what I think it is? It is! It's a set of chairs. The set of chairs is usual.[if there is something on the s_10] On the set of chairs you see [a list of things on the s_10].[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " Oh wow! Is that what I think it is? It is! It's a bbq. Now why would someone leave that there? The bbq is typical.[if there is something on the s_8] On the bbq you make out [a list of things on the s_8].[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You scan the room for a patio table, and you find a patio table. You shudder, but continue examining the patio table. [if there is something on the s_9]You see [a list of things on the s_9] on the patio table. Huh, weird.[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You've just sauntered into a living room.

 You scan the room for a couch, and you find a couch. The couch is normal.[if there is something on the s_5] On the couch you can see [a list of things on the s_5].[end if]".
...
The living room part 4 is some text that varies. The living room part 4 is " You make out a tv. The tv is normal.[if there is something on the s_7] On the tv you make out [a list of things on the s_7].[end if]".
...
The bathroom part 1 is some text that varies. The bathroom part 1 is " toilet, which looks normal, right there by you.[if c_3 is open and there is something in the c_3] The toilet contains [a list of things in the c_3].[end if]".
...
The bathroom part 4 is some text that varies. The bathroom part 4 is " bath in the corner.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4]. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
The bathroom part 5 is some text that varies. The bathroom part 5 is "[if c_4 is open and the c_4 contains nothing] The bath is empty, what a horrible day![end if]".
The bathroom part 6 is some text that varies. The bathroom part 6 is " You rest your hand against a wall, but you miss the wall and fall onto a sink. The sink is standard.[if there is something on the s_4] On the sink you see [a list of things on the s_4].[end if]".
...
The description of d_0 is "The wooden door looks hefty. [if open]It is open.[else if closed]It is closed.[otherwise]It is locked.[end if]".
...
The f_4 is in r_5.
The f_4 is edible.
The description of f_5 is "The lettuce looks delicious.".
...
The s_9 is in r_4.
The description of f_0 is "The half of a bag of chips looks savory.".
...
Test quest2_0 with "open antique trunk / take old key from antique trunk / unlock wooden door with old key / open wooden door / go east / open screen door / go east / go south / take lettuce"
...
Test quest3_0 with "open antique trunk / take old key from antique trunk / unlock wooden door with old key / open wooden door / go east / open screen door / go east / go south / take lettuce / go north / go west / put lettuce on stove"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First step, doublecheck that the antique trunk is open. After that, retrieve the old key from the antiqu".
The objective part 1 is some text that varies. The objective part 1 is "e trunk. After that, make it so that the wooden door is unlocked. And then, make sure that the wooden door is open. And then, make an attempt to travel east. Then, open the screen door inside the kitc".
The objective part 2 is some text that varies. The objective part 2 is "hen. And then, make an effort to take a trip east. Once you get through with that, go south. And then, recover the lettuce from the floor of the garden. After you have got the lettuce, head north. Onc".
The objective part 3 is some text that varies. The objective part 3 is "e you get around to doing that, attempt to go to the west. Next, rest the lettuce on the stove within the kitchen. Once that's all handled, you can stop!".
