...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! First of all, ensure that the chest drawer within the bedroom is open. And then, recover the old key from the ch".
The objective part 1 is some text that varies. The objective part 1 is "est drawer inside the bedroom. If you can get your hands on the old key, unlock the wooden door within the bedroom with the old key. After that, ensure that the wooden door is open. Then, try to move ".
The objective part 2 is some text that varies. The objective part 2 is "east. After that, doublecheck that the refrigerator within the kitchen is opened. Then, retrieve the tomato plant from the refrigerator. And then, sit the tomato plant on the stove within the kitchen.".
