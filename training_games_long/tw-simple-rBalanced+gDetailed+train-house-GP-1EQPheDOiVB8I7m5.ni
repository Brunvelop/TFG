...
The kitchen part 2 is some text that varies. The kitchen part 2 is " You hear a noise behind you and spin around, but you can't see anything other than a counter. The counter is ordinary.[if there is something on the s_1] On the counter you can see [a list of things on the s_1].[end if]".
The kitchen part 3 is some text that varies. The kitchen part 3 is "[if there is nothing on the s_1] But there isn't a thing on it. This always happens, here in TextWorld![end if]".
The kitchen part 4 is some text that varies. The kitchen part 4 is " You can make out a stove. The stove is ordinary.[if there is something on the s_2] On the stove you make out [a list of things on the s_2].[end if]".
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " Look out! It's a- oh, never mind, it's just a kitchen island. [if there is something on the s_3]You see [a list of things on the s_3] on the kitchen island. I mean, just wow! Isn't TextWorld just the best?[end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is "[if there is nothing on the s_3]But there isn't a thing on it.[end if]".
...
The bedroom part 3 is some text that varies. The bedroom part 3 is " You make out an antique trunk. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[if c_1 is open and there is something in the c_1] The antique trunk contains [a list of things in the c_1].[end if]".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " You make out a king-size bed. [if there is something on the s_0]On the king-size bed you can make out [a list of things on the s_0]. Wow! Just like in the movies![end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "Okay, so you're in a backyard, cool, but is it typical? You better believe it is.
 ...
 What's that over there? It looks like it's a set of chairs. [if there is something on the s_10]You see [a list of things on the s_10] on the set of chairs.[end if]".
The backyard part 1 is some text that varies. The backyard part 1 is "[if there is nothing on the s_10]But there isn't a thing on it. Hm. Oh well[end if]".
The backyard part 2 is some text that varies. The backyard part 2 is " You make out a bbq. [if there is something on the s_8]On the bbq you can make out [a list of things on the s_8]. There's something strange about this being here, but you can't put your finger on it.[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " What's that over there? It looks like it's a patio table. Now why would someone leave that there? [if there is something on the s_9]On the patio table you make out [a list of things on the s_9]. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You find yourself in a living room. A typical kind of place.

 You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a couch. The couch is standard.[if there is something on the s_5] On the couch you make out [a list of things on the s_5].[end if]".
...
The living room part 2 is some text that varies. The living room part 2 is " You scan the room for a low table, and you find a low table. [if there is something on the s_6]You see [a list of things on the s_6] on the low table.[end if]".
...
The bathroom part 3 is some text that varies. The bathroom part 3 is " You can make out a bath.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4]. You can't wait to tell the folks at home about this![end if]".
...
The bathroom part 5 is some text that varies. The bathroom part 5 is " You can make out a sink. The sink is normal.[if there is something on the s_4] On the sink you can make out [a list of things on the s_4].[end if]".
The bathroom part 6 is some text that varies. The bathroom part 6 is "[if there is nothing on the s_4] But oh no! there's nothing on this piece of garbage.[end if]".
...
The garden part 0 is some text that varies. The garden part 0 is "You are in a garden. A typical kind of place. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The d_0 is locked.
The description of d_1 is "The screen door looks imposing. [if open]It is open.[else if closed]It is closed.[otherwise]It is locked.[end if]".
...
The f_3 is in r_5.
The f_3 is edible.
The description of f_4 is "The tomato plant looks savory.".
...
The f_4 is in r_5.
The f_4 is edible.
The description of f_5 is "The half of a bag of chips looks appealing.".
...
The s_6 is in r_2.
The description of s_7 is "The tv is an unstable piece of junk.".
...
The description of f_2 is "The lettuce looks delectable.".
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a exciting session of TextWorld! Your first objective is to make it so that the antique trunk is opened. Then, recover the old key from the antique trunk. After that, look and see ".
The objective part 1 is some text that varies. The objective part 1 is "that the wooden door is unlocked with the old key. Then, make sure that the wooden door within the bedroom is wide open. After you have opened the wooden door, make an attempt to go to the east. And t".
The objective part 2 is some text that varies. The objective part 2 is "hen, look and see that the screen door within the kitchen is opened. After pulling open the screen door, move east. After that, venture south. And then, pick up the tomato plant from the floor of the ".
The objective part 3 is some text that varies. The objective part 3 is "garden. After that, go north. After that, travel west. Then, sit the tomato plant on the stove within the kitchen. Alright, thanks!".
