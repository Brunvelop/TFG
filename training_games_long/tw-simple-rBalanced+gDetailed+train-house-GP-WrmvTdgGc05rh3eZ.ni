...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an fast paced round of TextWorld? You do! First of all, open the chest drawer. And then, retrieve the old key from the chest drawer inside the ".
The objective part 1 is some text that varies. The objective part 1 is "bedroom. After that, unlock the wooden door inside the bedroom with the old key. And then, open the wooden door in the bedroom. And then, move east. And then, make sure that the refrigerator is open. ".
The objective part 2 is some text that varies. The objective part 2 is "Then, recover the milk from the refrigerator within the kitchen. And then, sit the milk on the stove. Got that? Good!".
