...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is your task for today. First off, if it's not too much trouble, I need you to ensure that the antique trun".
The objective part 1 is some text that varies. The objective part 1 is "k is open. And then, recover the old key from the antique trunk within the bedroom. After that, check that the wooden door in the bedroom is unlocked with the old key. After that, open the wooden door".
The objective part 2 is some text that varies. The objective part 2 is ". After that, go to the east. If you can do that, ensure that the screen door inside the kitchen is open. Once you have pulled open the screen door, venture east. Then, travel south. And then, lift th".
The objective part 3 is some text that varies. The objective part 3 is "e half of a bag of chips from the floor of the garden. After picking up the half of a bag of chips, make an attempt to go to the north. Okay, and then, make an attempt to go west. Next, place the half".
The objective part 4 is some text that varies. The objective part 4 is " of a bag of chips on the stove inside the kitchen. That's it!".
