...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First stop, open the antique trunk within the bedroom. After pulling open the antique trunk, recover the".
The objective part 1 is some text that varies. The objective part 1 is " old key from the antique trunk in the bedroom. After that, make it so that the wooden door is unlocked. And then, make it so that the wooden door is open. Then, move east. Okay, and then, make it so ".
The objective part 2 is some text that varies. The objective part 2 is "that the screen door within the kitchen is wide open. After that, try to travel east. Then, head south. Following that, recover the half of a bag of chips from the floor of the garden. With the half o".
The objective part 3 is some text that varies. The objective part 3 is "f a bag of chips, attempt to travel north. With that accomplished, take a trip west. And then, place the half of a bag of chips on the stove. That's it!".
