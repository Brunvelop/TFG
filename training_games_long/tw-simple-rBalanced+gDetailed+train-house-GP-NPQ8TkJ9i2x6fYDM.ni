...
Test quest1_0 with "open chest drawer / take old key from chest drawer / unlock wooden door with old key / open wooden door / go east / open refrigerator / take lettuce from refrigerator"
...
Test quest2_0 with "open chest drawer / take old key from chest drawer / unlock wooden door with old key / open wooden door / go east / open refrigerator / take lettuce from refrigerator / put lettuce on stove"
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is how to play! First step, open the chest drawer. Once you have pulled open the chest drawer, take the old key from the chest drawer inside t".
The objective part 1 is some text that varies. The objective part 1 is "he bedroom. After you have got the old key, check that the wooden door is unlocked with the old key. After that, ensure that the wooden door is open. Then, venture east. Okay, and then, doublecheck th".
The objective part 2 is some text that varies. The objective part 2 is "at the refrigerator is ajar. Then, pick up the lettuce from the refrigerator. And then, sit the lettuce on the stove inside the kitchen. That's it!".
