...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You find yourself in a kitchen. A normal one.
 ...
 You make out a refrigerator. Wow, isn't TextWorld just the best?[if c_2 is open and there is something in the c_2] The refrigerator contains [a list of things in the c_2].[end if]".
...
The kitchen part 2 is some text that varies. The kitchen part 2 is " You see a gleam over in a corner, where you can see a counter. [if there is something on the s_1]You see [a list of things on the s_1] on the counter.[end if]".
The kitchen part 3 is some text that varies. The kitchen part 3 is "[if there is nothing on the s_1]But the thing hasn't got anything on it. Aw, here you were, all excited for there to be things on it![end if]".
The kitchen part 4 is some text that varies. The kitchen part 4 is " You bend down to tie your shoe. When you stand up, you notice a stove. The stove is usual.[if there is something on the s_2] On the stove you can see [a list of things on the s_2].[end if]".
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " You see a kitchen island. [if there is something on the s_3]On the kitchen island you can see [a list of things on the s_3].[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You've entered a bedroom.
 ...
 If you haven't noticed it already, there seems to be something there by the wall, it's a chest drawer.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0].[end if]".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " Were you looking for a king-size bed? Because look over there, it's a king-size bed. The king-size bed is ordinary.[if there is something on the s_0] On the king-size bed you see [a list of things on the s_0].[end if]".
The bedroom part 6 is some text that varies. The bedroom part 6 is "[if there is nothing on the s_0] However, the king-size bed, like an empty king-size bed, has nothing on it. You think about smashing the king-size bed to bits, throwing the bits in the dump, etc, until you get bored.[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You're now in the backyard.
 ...
 You smell an interesting smell, and follow it to a set of chairs. [if there is something on the s_10]You see [a list of things on the s_10] on the set of chairs. Wow! Just like in the movies![end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You scan the room for a bbq, and you find a bbq. [if there is something on the s_8]On the bbq you see [a list of things on the s_8].[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You see a patio table. The patio table is typical.[if there is something on the s_9] On the patio table you can make out [a list of things on the s_9].[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You arrive in a living room. An ordinary kind of place.
 ...
 You see a couch. [if there is something on the s_5]You see [a list of things on the s_5] on the couch. It doesn't get more TextWorld than this![end if]".
...
The living room part 2 is some text that varies. The living room part 2 is " You rest your hand against a wall, but you miss the wall and fall onto a low table. The low table is usual.[if there is something on the s_6] On the low table you see [a list of things on the s_6].[end if]".
The living room part 3 is some text that varies. The living room part 3 is "[if there is nothing on the s_6] But the thing is empty, unfortunately. Hm. Oh well[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You have walked into a bathroom. Not the bathroom you'd expect. No, this is a bathroom.
 ...
 You can make out a toilet.[if c_3 is open and there is something in the c_3] The toilet contains [a list of things in the c_3]. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[end if]".
...
The bathroom part 3 is some text that varies. The bathroom part 3 is " bath, which looks typical, in the room.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4].[end if]".
...
The garden part 0 is some text that varies. The garden part 0 is "Well how about that, you are in the place we're calling the garden. You begin looking for stuff.
...
The f_3 is in r_5.
The f_3 is edible.
The description of f_4 is "that's a standard apple!".
The printed name of f_4 is "apple".
Understand "apple" as f_4.
The f_4 is in r_5.
The f_4 is edible.
The description of f_5 is "that's an usual tomato plant!".
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First off, if it's not too much trouble, I need you to make absolutely sure that the chest drawer inside".
The objective part 1 is some text that varies. The objective part 1 is " the bedroom is ajar. Having pulled open the chest drawer, retrieve the old key from the chest drawer. And then, check that the wooden door inside the bedroom is unlocked with the old key. After that,".
The objective part 2 is some text that varies. The objective part 2 is " make absolutely sure that the wooden door is wide open. After that, go east. If you can manage that, open the screen door. Then, attempt to take a trip east. And then, go to the south. Okay, and then".
The objective part 3 is some text that varies. The objective part 3 is ", recover the tomato plant from the floor of the garden. After that, try to head north. Then, venture west. Then, put the tomato plant on the stove inside the kitchen. Got that? Good!".
