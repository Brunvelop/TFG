...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Your first objective is to open the chest drawer. And then, recover the old key from the chest drawer. After that, unlock the wooden door. And then".
The objective part 1 is some text that varies. The objective part 1 is ", ensure that the wooden door is open. After that, make an effort to go east. Following that, ensure that the screen door within the kitchen is open. Then, make an effort to go to the east. With that ".
The objective part 2 is some text that varies. The objective part 2 is "over with, make an effort to move south. If you can manage that, retrieve the milk from the floor of the garden. And then, try to move north. Then, head west. And then, rest the milk on the stove. And".
