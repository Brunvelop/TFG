...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another profound round of TextWorld! Here is your task for today. First off, ensure that the chest drawer within the bedroom is open. After that, retrieve the old key from the chest drawer ".
The objective part 1 is some text that varies. The objective part 1 is "in the bedroom. And then, look and see that the wooden door within the bedroom is unlocked with the old key. Then, make absolutely sure that the wooden door in the bedroom is wide open. After opening ".
The objective part 2 is some text that varies. The objective part 2 is "the wooden door, make an attempt to travel east. And then, open the screen door inside the kitchen. And then, make an attempt to venture east. And then, take a trip south. And then, retrieve the lettu".
The objective part 3 is some text that varies. The objective part 3 is "ce from the floor of the garden. With the lettuce, move north. After that, travel west. Next, sit the lettuce on the stove within the kitchen. And if you do that, you're the winner!".
