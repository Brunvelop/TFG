...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an life changing round of TextWorld? You do! Here is your task for today. First off, make sure that the antique trunk is open. And then, retrie".
The objective part 1 is some text that varies. The objective part 1 is "ve the old key from the antique trunk. Then, make sure that the wooden door is unlocked with the old key. After that, ensure that the wooden door is open. After that, make an effort to take a trip eas".
The objective part 2 is some text that varies. The objective part 2 is "t. That done, make sure that the screen door within the kitchen is ajar. If you have opened the screen door, make an effort to head east. Then, travel south. Following that, pick-up the milk from the ".
The objective part 3 is some text that varies. The objective part 3 is "floor of the garden. Then, make an attempt to go to the north. After that, attempt to travel west. If you can do that, put the milk on the stove. Got that? Good!".
