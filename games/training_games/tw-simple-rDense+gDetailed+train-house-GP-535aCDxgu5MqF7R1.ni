...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! First, it would be fantastic if you could open the antique trunk. Then, take the old key from the antique trunk. And then, make it so that the wood".
The objective part 1 is some text that varies. The objective part 1 is "en door within the bedroom is unlocked with the old key. Having unlocked the wooden door, look and see that the wooden door within the bedroom is wide open. After that, head east. Then, look and see t".
The objective part 2 is some text that varies. The objective part 2 is "hat the screen door in the kitchen is open. And then, attempt to go east. Following that, make an attempt to move south. Then, recover the milk from the floor of the garden. After picking up the milk,".
The objective part 3 is some text that varies. The objective part 3 is " travel north. Following that, try to take a trip west. If you can succeed at that, sit the milk on the stove within the kitchen. Got that? Good!".
