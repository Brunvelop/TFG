...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You've just sauntered into a kitchen. You begin to take stock of what's in the room.
 ...
 You make out a refrigerator.[if c_2 is open and there is something in the c_2] The refrigerator contains [a list of things in the c_2]. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " You can make out a stove. [if there is something on the s_2]On the stove you see [a list of things on the s_2].[end if]".
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " You make out a kitchen island. The kitchen island is ordinary.[if there is something on the s_3] On the kitchen island you make out [a list of things on the s_3].[end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is "[if there is nothing on the s_3] But the thing is empty. It would have been so cool if there was stuff on the kitchen island! oh well.[end if]".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " As if things weren't amazing enough already, you can even see a king-size bed. [if there is something on the s_0]On the king-size bed you can make out [a list of things on the s_0].[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " Oh wow! Is that what I think it is? It is! It's a bbq. [if there is something on the s_8]You see [a list of things on the s_8] on the bbq.[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You see a gleam over in a corner, where you can see a patio table. I guess it's true what they say, if you're looking for a patio table, go to TextWorld. The patio table is standard.[if there is something on the s_9] On the patio table you make out [a list of things on the s_9]. It doesn't get more TextWorld than this![end if]".
The backyard part 5 is some text that varies. The backyard part 5 is "[if there is nothing on the s_9] But oh no! there's nothing on this piece of junk. Oh! Why couldn't there just be stuff on it?[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You arrive in a living room. An ordinary one. You decide to just list off a complete list of everything you see in the room, because hey, why not?

 You can make out a couch. The couch is usual.[if there is something on the s_5] On the couch you make out [a list of things on the s_5].[end if]".
...
The living room part 2 is some text that varies. The living room part 2 is " You can make out a low table. You wonder idly who left that here. [if there is something on the s_6]On the low table you can make out [a list of things on the s_6].[end if]".
...
The living room part 4 is some text that varies. The living room part 4 is " You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a tv. You wonder idly who left that here. [if there is something on the s_7]You see [a list of things on the s_7] on the tv.[end if]".
The living room part 5 is some text that varies. The living room part 5 is "[if there is nothing on the s_7]But the thing hasn't got anything on it. Aw, here you were, all excited for there to be things on it![end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You have walked into a bathroom. Not the bathroom you'd expect. No, this is a bathroom. You try to gain information on your surroundings by using a technique you call 'looking.'

 You make out a toilet.[if c_3 is open and there is something in the c_3] The toilet contains [a list of things in the c_3]. There's something strange about this being here, but you can't put your finger on it.[end if]".
...
The bathroom part 4 is some text that varies. The bathroom part 4 is " You see a sink. You can't really describe the sink besides that it's normal. [if there is something on the s_4]You see [a list of things on the s_4] on the sink. There's something strange about this thing being here, but you don't have time to worry about that now.[end if]".
The bathroom part 5 is some text that varies. The bathroom part 5 is "[if there is nothing on the s_4]But the thing is empty. You move on, clearly infuriated by your TextWorld experience.[end if]".
...
The d_0 is locked.
The description of d_1 is "it's a noble screen door [if open]It is open.[else if closed]It is closed.[otherwise]It is locked.[end if]".
...
The f_3 is in r_5.
The f_3 is edible.
The description of f_4 is "that's a standard milk!".
The printed name of f_4 is "milk".
Understand "milk" as f_4.
The f_4 is in r_5.
The f_4 is edible.
The description of f_5 is "that's an ordinary half of a bag of chips!".
...
The f_5 is in r_5.
The f_5 is edible.
The description of o_3 is "The shovel appears to fit in here".
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First thing I need you to do is to open the antique trunk within the bedroom. And then, recover the old ".
The objective part 1 is some text that varies. The objective part 1 is "key from the antique trunk in the bedroom. Then, unlock the wooden door within the bedroom. And then, open the wooden door within the bedroom. Then, move east. Once you get through with that, make an ".
The objective part 2 is some text that varies. The objective part 2 is "effort to travel south. And then, pick up the apple from the couch within the living room. After that, venture north. And then, sit the apple on the stove in the kitchen. Alright, thanks!".
