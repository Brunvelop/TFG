...
The kitchen part 3 is some text that varies. The kitchen part 3 is " As if things weren't amazing enough already, you can even see a counter. [if there is something on the s_1]On the counter you can see [a list of things on the s_1].[end if]".
...
The kitchen part 7 is some text that varies. The kitchen part 7 is " What's that over there? It looks like it's a kitchen island. Why don't you take a picture of it, it'll last longer! [if there is something on the s_3]You see [a list of things on the s_3] on the kitchen island. There's something strange about this being here, but you can't put your finger on it.[end if]".
...
The kitchen part 11 is some text that varies. The kitchen part 11 is " wooden door leading west. You need an unblocked exit? You should try going north. You don't like doors? Why not try going south, that entranceway is unguarded.".
...
The bedroom part 1 is some text that varies. The bedroom part 1 is " chest drawer, which looks standard, nearby.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0], so there's that.[end if]".
...
The bedroom part 3 is some text that varies. The bedroom part 3 is " What's that over there? It looks like it's an antique trunk.[if c_1 is open and there is something in the c_1] The antique trunk contains [a list of things in the c_1]. Now that's what I call TextWorld![end if]".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " You see a king-size bed. The king-size bed is typical.[if there is something on the s_0] On the king-size bed you make out [a list of things on the s_0].[end if]".
The bedroom part 6 is some text that varies. The bedroom part 6 is "[if there is nothing on the s_0] But oh no! there's nothing on this piece of trash. Hopefully, this discovery doesn't ruin your TextWorld experience![end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You've just shown up in a backyard.
 ...
 You see a set of chairs. You wonder idly who left that here. [if there is something on the s_10]You see [a list of things on the s_10] on the set of chairs. I mean, just wow! Isn't TextWorld just the best?[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You see a gleam over in a corner, where you can see a bbq. The bbq is ordinary.[if there is something on the s_8] On the bbq you can see [a list of things on the s_8].[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You see a patio table. [if there is something on the s_9]You see [a list of things on the s_9] on the patio table.[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "Ah, the living room. This is some kind of living room, really great usual vibes in this place, a wonderful usual atmosphere.
...
The living room part 2 is some text that varies. The living room part 2 is " You can see a low table. [if there is something on the s_6]On the low table you make out [a list of things on the s_6]. Classic TextWorld.[end if]".
The living room part 3 is some text that varies. The living room part 3 is "[if there is nothing on the s_6]But the thing hasn't got anything on it. It would have been so cool if there was stuff on the low table.[end if]".
The living room part 4 is some text that varies. The living room part 4 is " You see a tv. I guess it's true what they say, if you're looking for a tv, go to TextWorld. [if there is something on the s_7]On the tv you make out [a list of things on the s_7].[end if]".
The living room part 5 is some text that varies. The living room part 5 is "[if there is nothing on the s_7]The tv appears to be empty. It would have been so cool if there was stuff on the tv! oh well.[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "Okay, so you're in a bathroom, cool, but is it typical? You better believe it is. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The bathroom part 6 is some text that varies. The bathroom part 6 is "[if there is nothing on the s_4]But oh no! there's nothing on this piece of junk.[end if]".
...
The c_4 is in r_3.
The c_4 is closed.
The description of f_3 is "The milk looks appetizing.".
The printed name of f_3 is "milk".
Understand "milk" as f_3.
The f_3 is in r_5.
The f_3 is edible.
The description of f_4 is "The tomato plant looks inviting.".
...
Test quest8_0 with "open chest drawer / take old key from chest drawer / unlock wooden door with old key / open wooden door / go east / open screen door / go east / go south / take tomato plant"
...
Test quest9_0 with "open chest drawer / take old key from chest drawer / unlock wooden door with old key / open wooden door / go east / open screen door / go east / go south / take tomato plant / go north / go west / put tomato plant on stove"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a life changing episode of TextWorld! First stop, open the chest drawer. And then, retrieve the old key from the chest drawer within the bedroom. And then, unlock the wooden door i".
The objective part 1 is some text that varies. The objective part 1 is "nside the bedroom. Then, ensure that the wooden door is open. After that, attempt to head east. With that over with, look and see that the screen door within the kitchen is ajar. And then, venture eas".
The objective part 2 is some text that varies. The objective part 2 is "t. Once you finish that, go to the south. And then, pick up the tomato plant from the floor of the garden. With the tomato plant, make an attempt to go north. Okay, and then, try to go west. After tha".
The objective part 3 is some text that varies. The objective part 3 is "t, put the tomato plant on the stove. Got that? Good!".
