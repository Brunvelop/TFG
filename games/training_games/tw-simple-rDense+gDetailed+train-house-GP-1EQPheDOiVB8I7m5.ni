...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a exciting episode of TextWorld! First step, assure that the antique trunk within the bedroom is wide open. Then, recover the old key from the antique trunk. With the old key, unlo".
The objective part 1 is some text that varies. The objective part 1 is "ck the wooden door. Having unlocked the wooden door, doublecheck that the wooden door is ajar. Then, attempt to travel east. And then, make absolutely sure that the screen door in the kitchen is opene".
The objective part 2 is some text that varies. The objective part 2 is "d. Then, try to head east. And then, go to the south. If you can accomplish that, recover the tomato plant from the floor of the garden. With the tomato plant, go to the north. After that, travel west".
The objective part 3 is some text that varies. The objective part 3 is ". If you can succeed at that, rest the tomato plant on the stove. Alright, thanks!".
