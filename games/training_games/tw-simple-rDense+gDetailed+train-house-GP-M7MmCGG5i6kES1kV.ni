...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. Your first objective is to look and see that the chest drawer is ajar. Once you have opened the chest dr".
The objective part 1 is some text that varies. The objective part 1 is "awer, pick up the old key from the chest drawer inside the bedroom. Then, make sure that the wooden door in the bedroom is unlocked. After that, make sure that the wooden door is opened. After pulling".
The objective part 2 is some text that varies. The objective part 2 is " open the wooden door, go to the east. And then, open the screen door. And then, make an effort to travel east. After that, take a trip south. And then, retrieve the milk from the floor of the garden.".
The objective part 3 is some text that varies. The objective part 3 is " And then, head north. And then, head west. Then, sit the milk on the stove. And if you do that, you're the winner!".
