...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is your task for today. First off, if it's not too much trouble, I need you to open the chest drawer inside the bedroom. After you have pulled open the chest drawer, pick up".
The objective part 1 is some text that varies. The objective part 1 is " the old key from the chest drawer inside the bedroom. And then, unlock the wooden door. And then, assure that the wooden door in the bedroom is open. After that, head east. If you can accomplish that".
The objective part 2 is some text that varies. The objective part 2 is ", open the refrigerator. And then, take the tomato plant from the refrigerator within the kitchen. After that, sit the tomato plant on the stove. That's it!".
