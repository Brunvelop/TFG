...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You are in a kitchen. An usual kind of place. You can barely contain your excitement.
...
The kitchen part 2 is some text that varies. The kitchen part 2 is " You bend down to tie your shoe. When you stand up, you notice a counter. You wonder idly who left that here. The counter is standard.[if there is something on the s_1] On the counter you see [a list of things on the s_1].[end if]".
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " You smell a terrible smell, and follow it to a stove. [if there is something on the s_2]On the stove you can make out [a list of things on the s_2].[end if]".
The kitchen part 5 is some text that varies. The kitchen part 5 is "[if there is nothing on the s_2]But the thing is empty. Aw, here you were, all excited for there to be things on it![end if]".
The kitchen part 6 is some text that varies. The kitchen part 6 is " You see a kitchen island. The kitchen island is ordinary.[if there is something on the s_3] On the kitchen island you can see [a list of things on the s_3]. Wow! Just like in the movies![end if]".
...
The kitchen part 10 is some text that varies. The kitchen part 10 is " wooden door leading west. You don't like doors? Why not try going north, that entranceway is unguarded. You don't like doors? Why not try going south, that entranceway is unblocked.".
...
The bedroom part 3 is some text that varies. The bedroom part 3 is " You see an antique trunk.[if c_1 is open and there is something in the c_1] The antique trunk contains [a list of things in the c_1].[end if]".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " You bend down to tie your shoe. When you stand up, you notice a king-size bed. [if there is something on the s_0]You see [a list of things on the s_0] on the king-size bed.[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You've entered a backyard.
 ...
 You make out a set of chairs. The set of chairs is ordinary.[if there is something on the s_10] On the set of chairs you see [a list of things on the s_10].[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You see a bbq. [if there is something on the s_8]On the bbq you can see [a list of things on the s_8]. I mean, just wow! Isn't TextWorld just the best?[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You scan the room for a patio table, and you find a patio table. [if there is something on the s_9]On the patio table you make out [a list of things on the s_9]. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
...
The living room part 2 is some text that varies. The living room part 2 is " You can see a low table. The low table is normal.[if there is something on the s_6] On the low table you can see [a list of things on the s_6].[end if]".
The living room part 3 is some text that varies. The living room part 3 is "[if there is nothing on the s_6] But oh no! there's nothing on this piece of junk. Aw, here you were, all excited for there to be things on it![end if]".
The living room part 4 is some text that varies. The living room part 4 is " You can see a tv. The tv is standard.[if there is something on the s_7] On the tv you see [a list of things on the s_7]. Wow! Just like in the movies![end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You arrive in a bathroom. An usual one.
 ...
 You make out a toilet. Hmmm... what else, what else?[if c_3 is open and there is something in the c_3] The toilet contains [a list of things in the c_3]. Hmmm... what else, what else?[end if]".
...
The bathroom part 3 is some text that varies. The bathroom part 3 is " bath, which looks normal, close by.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4].[end if]".
...
The bathroom part 5 is some text that varies. The bathroom part 5 is " Hey, want to see a sink? Look over there, a sink. [if there is something on the s_4]You see [a list of things on the s_4] on the sink.[end if]".
...
The c_4 is in r_3.
The c_4 is closed.
The description of f_3 is "The half of a bag of chips looks delectable.".
...
The f_3 is in r_5.
The f_3 is edible.
The description of f_4 is "The apple looks delicious.".
The printed name of f_4 is "apple".
Understand "apple" as f_4.
The f_4 is in r_5.
The f_4 is edible.
The description of f_5 is "The tomato plant looks tempting.".
...
The s_9 is in r_4.
The description of f_0 is "The bell pepper looks appealing.".
...
The description of f_1 is "that's a standard milk!".
The printed name of f_1 is "milk".
Understand "milk" as f_1.
The f_1 is edible.
The f_1 is in the c_2.
The description of f_2 is "The lettuce looks delicious.".
...
Test quest6_0 with "open antique trunk / take old key from antique trunk / unlock wooden door with old key / open wooden door / go east / go south / take lettuce from couch"
...
Test quest7_0 with "open antique trunk / take old key from antique trunk / unlock wooden door with old key / open wooden door / go east / go south / take lettuce from couch / go north / put lettuce on stove"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First off, ensure that the antique trunk in the bedroom is open. Then, retrieve the old key from the ant".
The objective part 1 is some text that varies. The objective part 1 is "ique trunk within the bedroom. If you can get your hands on the old key, doublecheck that the wooden door in the bedroom is unlocked with the old key. And then, open the wooden door. After you have op".
The objective part 2 is some text that varies. The objective part 2 is "ened the wooden door, go to the east. Then, make an attempt to go south. With that done, take the lettuce from the couch in the living room. Then, venture north. Once you accomplish that, sit the lett".
The objective part 3 is some text that varies. The objective part 3 is "uce on the stove. That's it!".
