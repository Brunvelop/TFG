...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is how to play! First off, open the antique trunk within the bedroom. After that, pick up the old key from the antique trunk within the bedroo".
The objective part 1 is some text that varies. The objective part 1 is "m. Then, look and see that the wooden door is unlocked. And then, look and see that the wooden door within the bedroom is open. After that, travel east. Then, make it so that the refrigerator is opene".
The objective part 2 is some text that varies. The objective part 2 is "d. Then, recover the apple from the refrigerator. And then, rest the apple on the stove in the kitchen. Got that? Good!".
