...
The kitchen part 3 is some text that varies. The kitchen part 3 is " You see a counter. [if there is something on the s_1]You see [a list of things on the s_1] on the counter.[end if]".
The kitchen part 4 is some text that varies. The kitchen part 4 is "[if there is nothing on the s_1]But there isn't a thing on it. Sometimes, just sometimes, TextWorld can just be the worst.[end if]".
The kitchen part 5 is some text that varies. The kitchen part 5 is " You can see a stove. The stove is usual.[if there is something on the s_2] On the stove you can make out [a list of things on the s_2].[end if]".
The kitchen part 6 is some text that varies. The kitchen part 6 is "[if there is nothing on the s_2] But the thing is empty, unfortunately. You move on, clearly angry about TextWorld.[end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is " You can see a kitchen island. You wonder idly who left that here. [if there is something on the s_3]You see [a list of things on the s_3] on the kitchen island. There's something strange about this being here, but you can't put your finger on it.[end if]".
...
The kitchen part 11 is some text that varies. The kitchen part 11 is " wooden door leading west. There is an exit to the north. Don't worry, it is unguarded. There is an exit to the south. Don't worry, it is unguarded.".
...
The bedroom part 6 is some text that varies. The bedroom part 6 is " You can see a king-size bed. The king-size bed is normal.[if there is something on the s_0] On the king-size bed you see [a list of things on the s_0].[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You see a bbq. What a coincidence, weren't you just thinking about a bbq? The bbq is standard.[if there is something on the s_8] On the bbq you can see [a list of things on the s_8]. There's something strange about this thing being here, but you don't have time to worry about that now.[end if]".
The backyard part 3 is some text that varies. The backyard part 3 is "[if there is nothing on the s_8] The bbq appears to be empty.[end if]".
The backyard part 4 is some text that varies. The backyard part 4 is " You can make out a patio table! The patio table is ordinary.[if there is something on the s_9] On the patio table you can make out [a list of things on the s_9].[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You arrive in a living room. A typical kind of place.

 You see a couch. The couch is usual.[if there is something on the s_5] On the couch you see [a list of things on the s_5].[end if]".
...
The living room part 2 is some text that varies. The living room part 2 is " You scan the room, seeing a low table. The low table is standard.[if there is something on the s_6] On the low table you can make out [a list of things on the s_6].[end if]".
...
The living room part 4 is some text that varies. The living room part 4 is " You see a tv. The tv is typical.[if there is something on the s_7] On the tv you can see [a list of things on the s_7].[end if]".
...
The bathroom part 1 is some text that varies. The bathroom part 1 is " toilet in the corner.[if c_3 is open and there is something in the c_3] The toilet contains [a list of things in the c_3].[end if]".
...
The bathroom part 3 is some text that varies. The bathroom part 3 is " You smell a lovely smell, and follow it to a bath.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4].[end if]".
The bathroom part 4 is some text that varies. The bathroom part 4 is "[if c_4 is open and the c_4 contains nothing] The bath is empty! What a waste of a day![end if]".
The bathroom part 5 is some text that varies. The bathroom part 5 is " As if things weren't amazing enough already, you can even see a sink. The sink is ordinary.[if there is something on the s_4] On the sink you can make out [a list of things on the s_4]. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
The bathroom part 6 is some text that varies. The bathroom part 6 is "[if there is nothing on the s_4] But there isn't a thing on it. Hm. Oh well[end if]".
...
The garden part 0 is some text that varies. The garden part 0 is "Well I'll be, you are in the place we're calling the garden.
...
The description of d_0 is "The wooden door looks grand. [if open]It is open.[else if closed]It is closed.[otherwise]It is locked.[end if]".
The printed name of d_0 is "wooden door".
Understand "wooden door" as d_0.
Understand "wooden" as d_0.
Understand "door" as d_0.
The d_0 is locked.
The description of d_1 is "it's an ominous screen door [if open]You can see inside it.[else if closed]You can't see inside it because the lid's in your way.[otherwise]There is a lock on it.[end if]".
...
Test quest5_0 with "open chest drawer / take old key from chest drawer / unlock wooden door with old key / open wooden door / go east / open refrigerator / take milk from refrigerator"
...
Test quest6_0 with "open chest drawer / take old key from chest drawer / unlock wooden door with old key / open wooden door / go east / open refrigerator / take milk from refrigerator / put milk on stove"
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! First stop, look and see that the chest drawer within the bedroom is ajar. After that, pick up the old key from ".
The objective part 1 is some text that varies. The objective part 1 is "the chest drawer inside the bedroom. And then, check that the wooden door in the bedroom is unlocked with the old key. And then, make absolutely sure that the wooden door is wide open. Once you have p".
The objective part 2 is some text that varies. The objective part 2 is "ulled open the wooden door, make an effort to venture east. Then, doublecheck that the refrigerator within the kitchen is wide open. And then, retrieve the milk from the refrigerator in the kitchen. A".
The objective part 3 is some text that varies. The objective part 3 is "fter that, place the milk on the stove inside the kitchen. Once that's all handled, you can stop!".
