...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First off, open the chest drawer. And then, take the old key from the chest drawer. If you can get your ".
The objective part 1 is some text that varies. The objective part 1 is "hands on the old key, make it so that the wooden door is unlocked. After that, open the wooden door in the bedroom. Having pulled open the wooden door, take a trip east. Then, ensure that the refriger".
The objective part 2 is some text that varies. The objective part 2 is "ator within the kitchen is open. After that, recover the apple from the refrigerator in the kitchen. Then, place the apple on the stove. And if you do that, you're the winner!".
