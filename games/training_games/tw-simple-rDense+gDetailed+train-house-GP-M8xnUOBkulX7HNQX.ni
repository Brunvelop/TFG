...
The kitchen part 1 is some text that varies. The kitchen part 1 is " refrigerator nearby.[if c_2 is open and there is something in the c_2] The refrigerator contains [a list of things in the c_2]. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[end if]".
...
The kitchen part 3 is some text that varies. The kitchen part 3 is " You can see a counter. The counter is typical.[if there is something on the s_1] On the counter you can see [a list of things on the s_1].[end if]".
The kitchen part 4 is some text that varies. The kitchen part 4 is "[if there is nothing on the s_1] Looks like someone's already been here and taken everything off it, though. What's the point of an empty counter?[end if]".
The kitchen part 5 is some text that varies. The kitchen part 5 is " You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a stove. [if there is something on the s_2]On the stove you can make out [a list of things on the s_2].[end if]".
...
The kitchen part 7 is some text that varies. The kitchen part 7 is " You make out a kitchen island. The kitchen island is normal.[if there is something on the s_3] On the kitchen island you can make out [a list of things on the s_3].[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "I am excited to announce that you are now in the bedroom.

 You see [if c_0 is locked]a locked[else if c_0 is open]an opened[otherwise]a closed[end if]".
The bedroom part 1 is some text that varies. The bedroom part 1 is " chest drawer.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0]. There's something strange about this being here, but you can't put your finger on it.[end if]".
...
The bedroom part 3 is some text that varies. The bedroom part 3 is " You can make out an antique trunk. There's something strange about this being here, but you can't put your finger on it.[if c_1 is open and there is something in the c_1] The antique trunk contains [a list of things in the c_1]. Huh, weird.[end if]".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " You can make out a king-size bed! [if there is something on the s_0]On the king-size bed you see [a list of things on the s_0]. You shudder, but continue examining the room.[end if]".
The bedroom part 6 is some text that varies. The bedroom part 6 is "[if there is nothing on the s_0]But the thing is empty. It would have been so cool if there was stuff on the king-size bed.[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You've entered a backyard. You try to gain information on your surroundings by using a technique you call 'looking.'
 ...
 You can make out a set of chairs. The set of chairs is usual.[if there is something on the s_10] On the set of chairs you make out [a list of things on the s_10].[end if]".
The backyard part 1 is some text that varies. The backyard part 1 is "[if there is nothing on the s_10] However, the set of chairs, like an empty set of chairs, has nothing on it. Aw, here you were, all excited for there to be things on it![end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You see a patio table. What a coincidence, weren't you just thinking about a patio table? The patio table is standard.[if there is something on the s_9] On the patio table you can see [a list of things on the s_9]. Huh, weird.[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You're now in a living room.
 ...
 You can make out a couch. The couch is standard.[if there is something on the s_5] On the couch you can make out [a list of things on the s_5].[end if]".
The living room part 1 is some text that varies. The living room part 1 is "[if there is nothing on the s_5] But the thing is empty, unfortunately. Oh! Why couldn't there just be stuff on it?[end if]".
The living room part 2 is some text that varies. The living room part 2 is " You see a low table. The low table is ordinary.[if there is something on the s_6] On the low table you can see [a list of things on the s_6]. It doesn't get more TextWorld than this![end if]".
...
The living room part 4 is some text that varies. The living room part 4 is " You can make out a tv. [if there is something on the s_7]On the tv you can make out [a list of things on the s_7].[end if]".
The living room part 5 is some text that varies. The living room part 5 is "[if there is nothing on the s_7]Looks like someone's already been here and taken everything off it, though. Aw, and here you were, all excited for there to be things on it![end if]".
...
The bathroom part 1 is some text that varies. The bathroom part 1 is " toilet nearby.[if c_3 is open and there is something in the c_3] The toilet contains [a list of things in the c_3]. There's something strange about this being here, but you can't put your finger on it.[end if]".
...
The bathroom part 4 is some text that varies. The bathroom part 4 is " bath in the room.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4].[end if]".
...
The bathroom part 6 is some text that varies. The bathroom part 6 is " Look over there! a sink. I guess it's true what they say, if you're looking for a sink, go to TextWorld. [if there is something on the s_4]You see [a list of things on the s_4] on the sink.[end if]".
The bathroom part 7 is some text that varies. The bathroom part 7 is "[if there is nothing on the s_4]But there isn't a thing on it.[end if]".
...
The garden part 0 is some text that varies. The garden part 0 is "This might come as a shock to you, but you've just entered a garden.
...
The d_0 is locked.
The description of d_1 is "it's a towering screen door [if open]You can see inside it.[else if closed]You can't see inside it because the lid's in your way.[otherwise]There is a lock on it.[end if]".
...
The description of f_1 is "The apple looks delectable.".
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First off, if it's not too much trouble, I need you to make it so that the chest drawer inside the bedro".
The objective part 1 is some text that varies. The objective part 1 is "om is ajar. After opening the chest drawer, recover the old key from the chest drawer. Then, doublecheck that the wooden door is unlocked with the old key. After that, ensure that the wooden door in t".
The objective part 2 is some text that varies. The objective part 2 is "he bedroom is open. And then, head east. Okay, and then, ensure that the screen door inside the kitchen is open. After that, attempt to move east. After that, go to the south. That done, retrieve the ".
The objective part 3 is some text that varies. The objective part 3 is "milk from the floor of the garden. And then, head north. After that, travel west. After that, put the milk on the stove. Once that's all handled, you can stop!".
