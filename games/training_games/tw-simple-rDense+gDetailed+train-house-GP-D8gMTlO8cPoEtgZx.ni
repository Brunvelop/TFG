...
The kitchen part 3 is some text that varies. The kitchen part 3 is " What's that over there? It looks like it's a counter. Now why would someone leave that there? The counter is ordinary.[if there is something on the s_1] On the counter you make out [a list of things on the s_1].[end if]".
The kitchen part 4 is some text that varies. The kitchen part 4 is "[if there is nothing on the s_1] Unfortunately, there isn't a thing on it. What's the point of an empty counter?[end if]".
The kitchen part 5 is some text that varies. The kitchen part 5 is " You can see a stove. The stove is usual.[if there is something on the s_2] On the stove you see [a list of things on the s_2].[end if]".
...
The kitchen part 7 is some text that varies. The kitchen part 7 is " You see a kitchen island. The kitchen island is standard.[if there is something on the s_3] On the kitchen island you make out [a list of things on the s_3]. Hmmm... what else, what else?[end if]".
The kitchen part 8 is some text that varies. The kitchen part 8 is "[if there is nothing on the s_3] But the thing is empty, unfortunately. Aw, and here you were, all excited for there to be things on it![end if]".
...
The kitchen part 11 is some text that varies. The kitchen part 11 is " wooden door leading west. You don't like doors? Why not try going north, that entranceway is unblocked. You don't like doors? Why not try going south, that entranceway is unguarded.".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You arrive in a bedroom. You decide to just list off a complete list of everything you see in the room, because hey, why not?
 ...
 You make out a chest drawer.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0].[end if]".
...
The bedroom part 2 is some text that varies. The bedroom part 2 is " What's that over there? It looks like it's an antique trunk.[if c_1 is open and there is something in the c_1] The antique trunk contains [a list of things in the c_1].[end if]".
The bedroom part 3 is some text that varies. The bedroom part 3 is "[if c_1 is open and the c_1 contains nothing] The antique trunk is empty! What a waste of a day![end if]".
The bedroom part 4 is some text that varies. The bedroom part 4 is " Were you looking for a king-size bed? Because look over there, it's a king-size bed. The king-size bed is usual.[if there is something on the s_0] On the king-size bed you can make out [a list of things on the s_0].[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You're now in the backyard. You begin looking for stuff.
 ...
 You make out a set of chairs. The set of chairs is ordinary.[if there is something on the s_10] On the set of chairs you can make out [a list of things on the s_10]. There's something strange about this thing being here, but you don't have time to worry about that now.[end if]".
The backyard part 1 is some text that varies. The backyard part 1 is "[if there is nothing on the s_10] Looks like someone's already been here and taken everything off it, though. What, you think everything in TextWorld should have stuff on it?[end if]".
The backyard part 2 is some text that varies. The backyard part 2 is " Oh, great. Here's a bbq. [if there is something on the s_8]On the bbq you can make out [a list of things on the s_8].[end if]".
The backyard part 3 is some text that varies. The backyard part 3 is "[if there is nothing on the s_8]The bbq appears to be empty. Hm. Oh well[end if]".
The backyard part 4 is some text that varies. The backyard part 4 is " Look over there! a patio table. [if there is something on the s_9]On the patio table you can see [a list of things on the s_9].[end if]".
The backyard part 5 is some text that varies. The backyard part 5 is "[if there is nothing on the s_9]But the thing is empty, unfortunately. It would have been so cool if there was stuff on the patio table.[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You arrive in a living room. A normal kind of place. I guess you better just go and list everything you see here.

 You smell a sickening smell, and follow it to a couch. [if there is something on the s_5]On the couch you see [a list of things on the s_5].[end if]".
The living room part 1 is some text that varies. The living room part 1 is "[if there is nothing on the s_5]But oh no! there's nothing on this piece of trash.[end if]".
The living room part 2 is some text that varies. The living room part 2 is " You scan the room, seeing a low table. [if there is something on the s_6]You see [a list of things on the s_6] on the low table. Now that's what I call TextWorld![end if]".
The living room part 3 is some text that varies. The living room part 3 is "[if there is nothing on the s_6]But the thing is empty, unfortunately. You move on, clearly furious with your TextWorld experience.[end if]".
The living room part 4 is some text that varies. The living room part 4 is " You can see a tv. Why don't you take a picture of it, it'll last longer! [if there is something on the s_7]You see [a list of things on the s_7] on the tv.[end if]".
The living room part 5 is some text that varies. The living room part 5 is "[if there is nothing on the s_7]The tv appears to be empty. Hm. Oh well[end if]".
...
The bathroom part 5 is some text that varies. The bathroom part 5 is " You see a sink. [if there is something on the s_4]You see [a list of things on the s_4] on the sink.[end if]".
...
The garden part 0 is some text that varies. The garden part 0 is "You've just shown up in a garden. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The description of d_0 is "The wooden door looks solid. [if open]You can see inside it.[else if closed]You can't see inside it because the lid's in your way.[otherwise]There is a lock on it.[end if]".
The printed name of d_0 is "wooden door".
Understand "wooden door" as d_0.
Understand "wooden" as d_0.
Understand "door" as d_0.
The d_0 is locked.
The description of d_1 is "The screen door looks commanding. [if open]You can see inside it.[else if closed]You can't see inside it because the lid's in your way.[otherwise]There is a lock on it.[end if]".
...
The f_5 is in r_5.
The f_5 is edible.
The description of o_3 is "The shovel is unremarkable.".
...
The s_1 is in r_1.
The description of s_10 is "The set of chairs is an unstable piece of trash.".
...
The s_9 is in r_4.
The description of f_0 is "that's a typical tomato plant!".
...
The description of f_2 is "The milk looks delectable.".
...
The description of o_2 is "The remote appears well matched to everything else here".
...
Test quest8_0 with "open chest drawer / take old key from chest drawer / unlock wooden door with old key / open wooden door / go east / open screen door / go east / go south / take lettuce"
...
Test quest9_0 with "open chest drawer / take old key from chest drawer / unlock wooden door with old key / open wooden door / go east / open screen door / go east / go south / take lettuce / go north / go west / put lettuce on stove"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First off, if it's not too much trouble, I need you to ensure that the chest drawer within the bedroom i".
The objective part 1 is some text that varies. The objective part 1 is "s open. After that, take the old key from the chest drawer within the bedroom. Then, make it so that the wooden door is unlocked with the old key. After that, open the wooden door. Once you have pulle".
The objective part 2 is some text that varies. The objective part 2 is "d open the wooden door, make an attempt to go to the east. And then, ensure that the screen door inside the kitchen is open. Then, attempt to move east. With that over with, make an effort to venture ".
The objective part 3 is some text that varies. The objective part 3 is "south. That done, pick-up the lettuce from the floor of the garden. Once you have got the lettuce, attempt to go to the north. Following that, make an effort to go to the west. Okay, and then, put the".
The objective part 4 is some text that varies. The objective part 4 is " lettuce on the stove. Got that? Good!".
