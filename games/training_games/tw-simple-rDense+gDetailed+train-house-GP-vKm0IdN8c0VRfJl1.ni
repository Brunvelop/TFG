...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. Your first objective is to ensure that the antique trunk is open. After that, pick up the old key from t".
The objective part 1 is some text that varies. The objective part 1 is "he antique trunk. Once you have picked up the old key, check that the wooden door is unlocked with the old key. And then, open the wooden door in the bedroom. After that, go to the east. Once you succ".
The objective part 2 is some text that varies. The objective part 2 is "eed at that, open the screen door within the kitchen. After that, go to the east. After that, travel south. After that, recover the tomato plant from the floor of the garden. After getting the tomato ".
The objective part 3 is some text that varies. The objective part 3 is "plant, try to travel north. After that, take a trip west. Then, put the tomato plant on the stove. That's it!".
