...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! First of all, ensure that the chest drawer is open. And then, pick up the old key from the chest ".
The objective part 1 is some text that varies. The objective part 1 is "drawer. After that, make absolutely sure that the wooden door within the bedroom is unlocked with the old key. Then, make it so that the wooden door within the bedroom is opened. Then, take a trip eas".
The objective part 2 is some text that varies. The objective part 2 is "t. After that, ensure that the refrigerator is open. And then, pick up the tomato plant from the refrigerator inside the kitchen. And then, rest the tomato plant on the stove within the kitchen. That'".
The objective part 3 is some text that varies. The objective part 3 is "s it!".
