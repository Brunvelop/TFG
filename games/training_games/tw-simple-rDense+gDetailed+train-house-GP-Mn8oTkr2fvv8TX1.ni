...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is your task for today. First thing I need you to do is to open the chest drawer. After that, take the old ".
The objective part 1 is some text that varies. The objective part 1 is "key from the chest drawer inside the bedroom. And then, unlock the wooden door with the old key. After that, ensure that the wooden door is open. After that, make an effort to go to the east. Once you".
The objective part 2 is some text that varies. The objective part 2 is " do that, open the screen door. And then, move east. Then, try to travel south. Then, lift the bell pepper from the floor of the garden. And then, head north. Okay, and then, make an effort to travel ".
The objective part 3 is some text that varies. The objective part 3 is "west. Following that, put the bell pepper on the stove within the kitchen. And if you do that, you're the winner!".
