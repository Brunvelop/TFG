...
The kitchen part 3 is some text that varies. The kitchen part 3 is " You can see a counter. The counter is typical.[if there is something on the s_1] On the counter you see [a list of things on the s_1].[end if]".
...
The kitchen part 5 is some text that varies. The kitchen part 5 is " If you haven't noticed it already, there seems to be something there by the wall, it's a stove. You wonder idly who left that here. [if there is something on the s_2]On the stove you can make out [a list of things on the s_2].[end if]".
...
The kitchen part 7 is some text that varies. The kitchen part 7 is " You see a kitchen island. The kitchen island is typical.[if there is something on the s_3] On the kitchen island you see [a list of things on the s_3].[end if]".
...
The kitchen part 11 is some text that varies. The kitchen part 11 is " wooden door leading west. There is an exit to the north. Don't worry, it is unblocked. There is an exit to the south. Don't worry, it is unblocked.".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "Look around you. Take it all in. It's not every day someone gets to be in a bedroom.
 ...
 You see a gleam over in a corner, where you can see a chest drawer. The light flickers for a second, but nothing else happens.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0]. Now that's what I call TextWorld![end if]".
...
The bedroom part 2 is some text that varies. The bedroom part 2 is " You see an antique trunk. Now that's what I call TextWorld![if c_1 is open and there is something in the c_1] The antique trunk contains [a list of things in the c_1].[end if]".
...
The bedroom part 4 is some text that varies. The bedroom part 4 is " You can make out a king-size bed. [if there is something on the s_0]On the king-size bed you make out [a list of things on the s_0]. Now that's what I call TextWorld![end if]".
The bedroom part 5 is some text that varies. The bedroom part 5 is "[if there is nothing on the s_0]But the thing is empty, unfortunately. Hm. Oh well[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You find yourself in a backyard. An ordinary one. The room is well lit.
 ...
 Look out! It's a- oh, never mind, it's just a set of chairs! [if there is something on the s_10]On the set of chairs you see [a list of things on the s_10].[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You hear a noise behind you and spin around, but you can't see anything other than a bbq. The bbq is usual.[if there is something on the s_8] On the bbq you can see [a list of things on the s_8]. Wow! Just like in the movies![end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " Look over there! a patio table. The patio table is normal.[if there is something on the s_9] On the patio table you can make out [a list of things on the s_9].[end if]".
The backyard part 5 is some text that varies. The backyard part 5 is "[if there is nothing on the s_9] But oh no! there's nothing on this piece of trash. What, you think everything in TextWorld should have stuff on it?[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You find yourself in a living room.
...
The living room part 3 is some text that varies. The living room part 3 is "[if there is nothing on the s_6] The low table appears to be empty. Oh! Why couldn't there just be stuff on it?[end if]".
The living room part 4 is some text that varies. The living room part 4 is " You can make out a tv. The tv is ordinary.[if there is something on the s_7] On the tv you see [a list of things on the s_7].[end if]".
...
The bathroom part 3 is some text that varies. The bathroom part 3 is " You see a bath. There's something strange about this being here, but you can't put your finger on it.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4]. There's something strange about this being here, but you can't put your finger on it.[end if]".
...
The f_3 is in r_5.
The f_3 is edible.
The description of f_4 is "The milk looks appealing.".
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First stop, open the antique trunk inside the bedroom. Then, recover the old key from the antique trunk ".
The objective part 1 is some text that varies. The objective part 1 is "within the bedroom. Then, make it so that the wooden door is unlocked. And then, ensure that the wooden door is open. After you have pulled open the wooden door, try to take a trip east. That done, ma".
The objective part 2 is some text that varies. The objective part 2 is "ke sure that the refrigerator is ajar. Then, retrieve the bell pepper from the refrigerator. If you can get your hands on the bell pepper, place the bell pepper on the stove. And once you've done that".
