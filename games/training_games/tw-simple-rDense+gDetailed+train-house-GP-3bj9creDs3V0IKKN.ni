...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! First off, if it's not too much trouble, I need you to assure that the antique trunk is open. If you have pulled open the antique trunk, pick up th".
The objective part 1 is some text that varies. The objective part 1 is "e old key from the antique trunk. Then, unlock the wooden door within the bedroom. And then, open the wooden door. And then, go east. After that, look and see that the refrigerator in the kitchen is a".
The objective part 2 is some text that varies. The objective part 2 is "jar. After that, pick up the lettuce from the refrigerator. Once you have got the lettuce, place the lettuce on the stove within the kitchen. That's it!".
