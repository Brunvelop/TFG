...
The objective part 2 is some text that varies. The objective part 2 is " wooden door is opened. After that, make an effort to go to the east. And then, travel south. With that done, recover the milk from the couch. And then, move north. Then, rest the milk on the stove in".
The objective part 3 is some text that varies. The objective part 3 is " the kitchen. And once you've done that, you win!".
