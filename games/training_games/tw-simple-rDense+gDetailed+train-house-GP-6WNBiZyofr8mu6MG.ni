...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an profound round of TextWorld? You do! Here is your task for today. First off, open the antique trunk. If you have pulled open the antique tru".
The objective part 1 is some text that varies. The objective part 1 is "nk, retrieve the old key from the antique trunk inside the bedroom. Then, make sure that the wooden door within the bedroom is unlocked with the old key. And then, open the wooden door in the bedroom.".
The objective part 2 is some text that varies. The objective part 2 is " After that, make an attempt to venture east. And then, ensure that the refrigerator in the kitchen is open. Then, pick up the lettuce from the refrigerator inside the kitchen. After that, sit the let".
The objective part 3 is some text that varies. The objective part 3 is "tuce on the stove inside the kitchen. Once that's all handled, you can stop!".
