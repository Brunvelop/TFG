...
The objective part 2 is some text that varies. The objective part 2 is "open the screen door. And then, venture east. Then, travel south. That done, retrieve the milk from the floor of the garden. After that, go to the north. Then, attempt to go to the west. If you can ma".
The objective part 3 is some text that varies. The objective part 3 is "nage that, sit the milk on the stove. And if you do that, you're the winner!".
