...
The kitchen part 0 is some text that varies. The kitchen part 0 is "Of every kitchen you could have sauntered into, you had to walk into an usual one.
...
The kitchen part 3 is some text that varies. The kitchen part 3 is " You can make out a counter. The counter is standard.[if there is something on the s_1] On the counter you can see [a list of things on the s_1].[end if]".
The kitchen part 4 is some text that varies. The kitchen part 4 is "[if there is nothing on the s_1] But there isn't a thing on it.[end if]".
...
The kitchen part 7 is some text that varies. The kitchen part 7 is " You see a kitchen island. [if there is something on the s_3]On the kitchen island you can see [a list of things on the s_3].[end if]".
The kitchen part 8 is some text that varies. The kitchen part 8 is "[if there is nothing on the s_3]But the thing is empty.[end if]".
...
The kitchen part 11 is some text that varies. The kitchen part 11 is " wooden door leading west. You don't like doors? Why not try going north, that entranceway is unguarded. You need an unguarded exit? You should try going south.".
...
The bedroom part 1 is some text that varies. The bedroom part 1 is " chest drawer right there by you.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0]. The light flickers for a second, but nothing else happens.[end if]".
...
The bedroom part 6 is some text that varies. The bedroom part 6 is " You see a king-size bed. The king-size bed is normal.[if there is something on the s_0] On the king-size bed you can make out [a list of things on the s_0]. Classic TextWorld.[end if]".
The bedroom part 7 is some text that varies. The bedroom part 7 is "[if there is nothing on the s_0] But the thing is empty, unfortunately.[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You arrive in a backyard. A normal kind of place. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
 ...
 Look out! It's a- oh, never mind, it's just a set of chairs. The set of chairs is usual.[if there is something on the s_10] On the set of chairs you see [a list of things on the s_10].[end if]".
The backyard part 1 is some text that varies. The backyard part 1 is "[if there is nothing on the s_10] But the thing hasn't got anything on it. It would have been so cool if there was stuff on the set of chairs.[end if]".
The backyard part 2 is some text that varies. The backyard part 2 is " You rest your hand against a wall, but you miss the wall and fall onto a bbq. [if there is something on the s_8]On the bbq you see [a list of things on the s_8].[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You smell an interesting smell, and follow it to a patio table. [if there is something on the s_9]On the patio table you can make out [a list of things on the s_9].[end if]".
The backyard part 5 is some text that varies. The backyard part 5 is "[if there is nothing on the s_9]But oh no! there's nothing on this piece of garbage. You make a mental note to not get your hopes up the next time you see a patio table in a room.[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You're now in the living room.

 You see a couch. You shudder, but continue examining the couch. [if there is something on the s_5]On the couch you can see [a list of things on the s_5].[end if]".
...
The living room part 2 is some text that varies. The living room part 2 is " You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a low table. [if there is something on the s_6]You see [a list of things on the s_6] on the low table.[end if]".
The living room part 3 is some text that varies. The living room part 3 is "[if there is nothing on the s_6]Looks like someone's already been here and taken everything off it, though. What, you think everything in TextWorld should have stuff on it?[end if]".
The living room part 4 is some text that varies. The living room part 4 is " Oh, great. Here's a tv. The tv is standard.[if there is something on the s_7] On the tv you make out [a list of things on the s_7]. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[end if]".
...
The bathroom part 3 is some text that varies. The bathroom part 3 is "[if c_4 is open and the c_4 contains nothing] The bath is empty, what a horrible day![end if]".
The bathroom part 4 is some text that varies. The bathroom part 4 is " You make out a sink. Make a note of this, you might have to put stuff on or in it later on. The sink is normal.[if there is something on the s_4] On the sink you make out [a list of things on the s_4].[end if]".
The bathroom part 5 is some text that varies. The bathroom part 5 is "[if there is nothing on the s_4] But oh no! there's nothing on this piece of junk. Oh! Why couldn't there just be stuff on it?[end if]".
...
The description of d_0 is "it's a towering wooden door [if open]It is open.[else if closed]It is closed.[otherwise]It is locked.[end if]".
...
The c_4 is in r_3.
The c_4 is closed.
The description of f_3 is "that's an ordinary tomato plant!".
...
The f_4 is in r_5.
The f_4 is edible.
The description of f_5 is "that's a standard lettuce!".
The printed name of f_5 is "lettuce".
Understand "lettuce" as f_5.
The f_5 is in r_5.
The f_5 is edible.
The description of o_3 is "The shovel is clean.".
The printed name of o_3 is "shovel".
Understand "shovel" as o_3.
The o_3 is in r_5.
The description of s_0 is "The king-size bed is unstable.".
...
The s_3 is in r_1.
The description of s_4 is "The sink is an unstable piece of trash.".
...
Test quest6_0 with "open chest drawer / take old key from chest drawer / unlock wooden door with old key / open wooden door / go east / go south / take milk from couch"
...
Test quest7_0 with "open chest drawer / take old key from chest drawer / unlock wooden door with old key / open wooden door / go east / go south / take milk from couch / go north / put milk on stove"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First stop, open the chest drawer inside the bedroom. Then, retrieve the old key from the chest drawer i".
The objective part 1 is some text that varies. The objective part 1 is "nside the bedroom. Then, insert the old key into the wooden door in the bedroom's lock to unlock it. Then, open the wooden door inside the bedroom. After opening the wooden door, try to head east. The".
The objective part 2 is some text that varies. The objective part 2 is "n, make an attempt to travel south. And then, recover the milk from the couch within the living room. And then, move north. Then, rest the milk on the stove. And once you've done that, you win!".
