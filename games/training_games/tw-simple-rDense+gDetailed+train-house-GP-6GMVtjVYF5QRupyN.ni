...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is how to play! First stop, assure that the antique trunk is wide open. Then, pick up the old key from the antique trunk. After that, unlock the wooden door within the bedro".
The objective part 1 is some text that varies. The objective part 1 is "om with the old key. And then, make it so that the wooden door is wide open. Having pulled open the wooden door, make an attempt to travel east. With that done, ensure that the screen door is open. An".
The objective part 2 is some text that varies. The objective part 2 is "d then, try to travel east. With that over with, go to the south. Once you succeed at that, lift the bell pepper from the floor of the garden. After picking up the bell pepper, make an attempt to head".
The objective part 3 is some text that varies. The objective part 3 is " north. Next, take a trip west. Next, place the bell pepper on the stove inside the kitchen. Got that? Good!".
