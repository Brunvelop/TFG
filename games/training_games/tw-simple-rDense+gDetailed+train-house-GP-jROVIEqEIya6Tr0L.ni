...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You've just sauntered into a kitchen.
 ...
 You hear a noise behind you and spin around, but you can't see anything other than a refrigerator. I mean, just wow! Isn't TextWorld just the best?[if c_2 is open and there is something in the c_2] The refrigerator contains [a list of things in the c_2].[end if]".
...
The kitchen part 3 is some text that varies. The kitchen part 3 is "[if there is nothing on the s_1]However, the counter, like an empty counter, has nothing on it.[end if]".
The kitchen part 4 is some text that varies. The kitchen part 4 is " You make out a stove. You wonder idly who left that here. The stove is ordinary.[if there is something on the s_2] On the stove you make out [a list of things on the s_2].[end if]".
The kitchen part 5 is some text that varies. The kitchen part 5 is "[if there is nothing on the s_2] The stove appears to be empty.[end if]".
The kitchen part 6 is some text that varies. The kitchen part 6 is " You can see a kitchen island. [if there is something on the s_3]You see [a list of things on the s_3] on the kitchen island.[end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is "[if there is nothing on the s_3]The kitchen island appears to be empty.[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You're now in the bedroom. You begin to take stock of what's here.
 ...
 You can make out a chest drawer.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0].[end if]".
The bedroom part 1 is some text that varies. The bedroom part 1 is "[if c_0 is open and the c_0 contains nothing] The chest drawer is empty, what a horrible day![end if]".
...
The bedroom part 3 is some text that varies. The bedroom part 3 is " antique trunk.[if c_1 is open and there is something in the c_1] The antique trunk contains [a list of things in the c_1]. You look at the price tag that hangs off the antique trunk. Three hundred dollars?! Where'd they buy this antique trunk, some kind of expensive store?[end if]".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " You make out a king-size bed. [if there is something on the s_0]You see [a list of things on the s_0] on the king-size bed. You shudder, but continue examining the room.[end if]".
The bedroom part 6 is some text that varies. The bedroom part 6 is "[if there is nothing on the s_0]But oh no! there's nothing on this piece of garbage. Hm. Oh well[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "If you're wondering why everything seems so ordinary all of a sudden, it's because you've just walked into the backyard. Okay, just remember what you're here to do, and everything will go great.

 You can see a set of chairs. I guess it's true what they say, if you're looking for a set of chairs, go to TextWorld. The set of chairs is usual.[if there is something on the s_10] On the set of chairs you can make out [a list of things on the s_10].[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You see a bbq. [if there is something on the s_8]On the bbq you can make out [a list of things on the s_8].[end if]".
The backyard part 3 is some text that varies. The backyard part 3 is "[if there is nothing on the s_8]But oh no! there's nothing on this piece of garbage. You swear loudly.[end if]".
The backyard part 4 is some text that varies. The backyard part 4 is " You can see a patio table. Now why would someone leave that there? [if there is something on the s_9]You see [a list of things on the s_9] on the patio table.[end if]".
The backyard part 5 is some text that varies. The backyard part 5 is "[if there is nothing on the s_9]But oh no! there's nothing on this piece of garbage.[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "Of every living room you could have walked into, you had to come round an usual one. I guess you better just go and list everything you see here.

 You can see a couch. The couch is typical.[if there is something on the s_5] On the couch you see [a list of things on the s_5].[end if]".
The living room part 1 is some text that varies. The living room part 1 is "[if there is nothing on the s_5] But there isn't a thing on it. Hm. Oh well[end if]".
The living room part 2 is some text that varies. The living room part 2 is " Hey, want to see a low table? Look over there, a low table. The low table is standard.[if there is something on the s_6] On the low table you see [a list of things on the s_6].[end if]".
The living room part 3 is some text that varies. The living room part 3 is "[if there is nothing on the s_6] But the thing hasn't got anything on it.[end if]".
The living room part 4 is some text that varies. The living room part 4 is " You hear a noise behind you and spin around, but you can't see anything other than a tv. [if there is something on the s_7]On the tv you can see [a list of things on the s_7].[end if]".
The living room part 5 is some text that varies. The living room part 5 is "[if there is nothing on the s_7]But the thing hasn't got anything on it.[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You arrive in a bathroom. A normal kind of place.
 ...
 You make out a toilet, so there's that.[if c_3 is open and there is something in the c_3] The toilet contains [a list of things in the c_3]. You shudder, but continue examining the room.[end if]".
...
The bathroom part 3 is some text that varies. The bathroom part 3 is " bath.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4], so there's that.[end if]".
...
The bathroom part 5 is some text that varies. The bathroom part 5 is " You can make out a sink. The sink is standard.[if there is something on the s_4] On the sink you can make out [a list of things on the s_4].[end if]".
The bathroom part 6 is some text that varies. The bathroom part 6 is "[if there is nothing on the s_4] Unfortunately, there isn't a thing on it. You move on, clearly infuriated by TextWorld.[end if]".
...
The f_3 is in r_5.
The f_3 is edible.
The description of f_4 is "The apple looks tasty.".
The printed name of f_4 is "apple".
Understand "apple" as f_4.
The f_4 is in r_5.
The f_4 is edible.
The description of f_5 is "that's a standard bell pepper!".
...
The s_4 is in r_3.
The description of s_5 is "The couch is an unstable piece of trash.".
...
The s_6 is in r_2.
The description of s_7 is "The tv is an unstable piece of garbage.".
The printed name of s_7 is "tv".
Understand "tv" as s_7.
The s_7 is in r_2.
The description of s_8 is "The bbq is an unstable piece of trash.".
...
The description of f_1 is "The tomato plant looks savory.".
...
The description of f_2 is "The milk looks savory.".
...
Test quest8_0 with "open chest drawer / take old key from chest drawer / unlock wooden door with old key / open wooden door / go east / open screen door / go east / go south / take bell pepper"
...
Test quest9_0 with "open chest drawer / take old key from chest drawer / unlock wooden door with old key / open wooden door / go east / open screen door / go east / go south / take bell pepper / go north / go west / put bell pepper on stove"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First thing I need you to do is to make it so that the chest drawer is wide open. And then, recover the ".
The objective part 1 is some text that varies. The objective part 1 is "old key from the chest drawer inside the bedroom. And then, unlock the wooden door within the bedroom. And then, ensure that the wooden door is open. And then, make an effort to go to the east. That d".
The objective part 2 is some text that varies. The objective part 2 is "one, make it so that the screen door within the kitchen is ajar. After that, make an effort to move east. With that accomplished, make an attempt to take a trip south. Once you do that, pick-up the be".
The objective part 3 is some text that varies. The objective part 3 is "ll pepper from the floor of the garden. After that, make an effort to travel north. Then, make an effort to move west. With that over with, sit the bell pepper on the stove in the kitchen. And once yo".
The objective part 4 is some text that varies. The objective part 4 is "u've done that, you win!".
