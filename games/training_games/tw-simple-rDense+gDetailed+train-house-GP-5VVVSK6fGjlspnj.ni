...
The kitchen part 2 is some text that varies. The kitchen part 2 is " Oh, great. Here's a counter. The counter is usual.[if there is something on the s_1] On the counter you see [a list of things on the s_1]. You shudder, but continue examining the room.[end if]".
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " You can see a stove. The stove is ordinary.[if there is something on the s_2] On the stove you can see [a list of things on the s_2].[end if]".
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " You see a kitchen island. [if there is something on the s_3]You see [a list of things on the s_3] on the kitchen island.[end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is "[if there is nothing on the s_3]But oh no! there's nothing on this piece of garbage. This always happens, here in TextWorld![end if]".
...
The kitchen part 10 is some text that varies. The kitchen part 10 is " wooden door leading west. You don't like doors? Why not try going north, that entranceway is unguarded. There is an exit to the south. Don't worry, it is unblocked.".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You've just walked into a bedroom.
 ...
 You smell an interesting smell, and follow it to a chest drawer.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0].[end if]".
...
The bedroom part 4 is some text that varies. The bedroom part 4 is " You can see a king-size bed. The king-size bed is usual.[if there is something on the s_0] On the king-size bed you can see [a list of things on the s_0]. There's something strange about this being here, but you can't put your finger on it.[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "Look around you. Take it all in. It's not every day someone gets to be in a backyard.
 ...
 You see a set of chairs. The set of chairs is ordinary.[if there is something on the s_10] On the set of chairs you can see [a list of things on the s_10].[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " Hey, want to see a bbq? Look over there, a bbq. The bbq is usual.[if there is something on the s_8] On the bbq you can see [a list of things on the s_8].[end if]".
The backyard part 3 is some text that varies. The backyard part 3 is "[if there is nothing on the s_8] The bbq appears to be empty. This always happens![end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You arrive in a living room. A standard one.

 You make out a couch. [if there is something on the s_5]You see [a list of things on the s_5] on the couch.[end if]".
The living room part 1 is some text that varies. The living room part 1 is "[if there is nothing on the s_5]But there isn't a thing on it. What, you think everything in TextWorld should have stuff on it?[end if]".
The living room part 2 is some text that varies. The living room part 2 is " You can make out a low table. [if there is something on the s_6]On the low table you can make out [a list of things on the s_6].[end if]".
The living room part 3 is some text that varies. The living room part 3 is "[if there is nothing on the s_6]But the thing is empty, unfortunately. What, you think everything in TextWorld should have stuff on it?[end if]".
The living room part 4 is some text that varies. The living room part 4 is " You can see a tv. [if there is something on the s_7]You see [a list of things on the s_7] on the tv. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
The living room part 5 is some text that varies. The living room part 5 is "[if there is nothing on the s_7]However, the tv, like an empty tv, has nothing on it. You think about smashing the tv to bits, throwing the bits in the dump, etc, until you get bored.[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "Look at you, bigshot, walking into a bathroom like it isn't some huge deal.
 ...
 You can see a toilet. Now why would someone leave that there?[if c_3 is open and there is something in the c_3] The toilet contains [a list of things in the c_3].[end if]".
...
The bathroom part 2 is some text that varies. The bathroom part 2 is " Look out! It's a- oh, never mind, it's just a bath.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4].[end if]".
...
The bathroom part 4 is some text that varies. The bathroom part 4 is " You see a gleam over in a corner, where you can see a sink. The sink is typical.[if there is something on the s_4] On the sink you see [a list of things on the s_4].[end if]".
...
The description of d_0 is "it's a manageable wooden door [if open]It is open.[else if closed]It is closed.[otherwise]It is locked.[end if]".
...
The c_4 is in r_3.
The c_4 is closed.
The description of f_3 is "The bell pepper looks tempting.".
...
The f_3 is in r_5.
The f_3 is edible.
The description of f_4 is "that's an ordinary tomato plant!".
...
The o_3 is in r_5.
The description of s_0 is "The king-size bed is an unstable piece of junk.".
...
The description of f_1 is "that's an usual half of a bag of chips!".
...
The description of f_2 is "that's an usual lettuce!".
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First off, ensure that the antique trunk within the bedroom is open. Having opened the antique trunk, pi".
The objective part 1 is some text that varies. The objective part 1 is "ck up the old key from the antique trunk inside the bedroom. After that, unlock the wooden door within the bedroom with the old key. After that, open the wooden door. After opening the wooden door, at".
The objective part 2 is some text that varies. The objective part 2 is "tempt to go to the east. Okay, and then, ensure that the screen door is open. And then, try to go to the east. Then, try to head south. Once you get around to doing that, retrieve the tomato plant fro".
The objective part 3 is some text that varies. The objective part 3 is "m the floor of the garden. And then, move north. Then, make an attempt to move west. Okay, and then, rest the tomato plant on the stove within the kitchen. And if you do that, you're the winner!".
