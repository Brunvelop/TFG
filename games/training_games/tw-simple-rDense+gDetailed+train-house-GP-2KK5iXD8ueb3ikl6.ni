...
The kitchen part 0 is some text that varies. The kitchen part 0 is "Okay, so you're in a kitchen, cool, but is it standard? You better believe it is.
 ...
 You see a gleam over in a corner, where you can see a refrigerator.[if c_2 is open and there is something in the c_2] The refrigerator contains [a list of things in the c_2].[end if]".
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " You make out a stove. [if there is something on the s_2]You see [a list of things on the s_2] on the stove, so there's that.[end if]".
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " You can make out a kitchen island. The kitchen island is typical.[if there is something on the s_3] On the kitchen island you see [a list of things on the s_3].[end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is "[if there is nothing on the s_3] But the thing hasn't got anything on it.[end if]".
...
The bedroom part 6 is some text that varies. The bedroom part 6 is " You can make out a king-size bed. The king-size bed is typical.[if there is something on the s_0] On the king-size bed you can see [a list of things on the s_0].[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You arrive in a backyard. An usual kind of place. Okay, just remember what you're here to do, and everything will go great.

 You make out a set of chairs. [if there is something on the s_10]You see [a list of things on the s_10] on the set of chairs.[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You see a patio table. [if there is something on the s_9]On the patio table you see [a list of things on the s_9].[end if]".
The backyard part 5 is some text that varies. The backyard part 5 is "[if there is nothing on the s_9]But the thing is empty. Hm. Oh well[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You arrive in a living room. A normal one.

 You can make out a couch. You wonder idly who left that here. [if there is something on the s_5]On the couch you make out [a list of things on the s_5].[end if]".
The living room part 1 is some text that varies. The living room part 1 is "[if there is nothing on the s_5]Unfortunately, there isn't a thing on it. Hm. Oh well[end if]".
The living room part 2 is some text that varies. The living room part 2 is " You see a low table. The low table is typical.[if there is something on the s_6] On the low table you see [a list of things on the s_6], so there's that.[end if]".
...
The living room part 4 is some text that varies. The living room part 4 is " You make out a tv. The tv is usual.[if there is something on the s_7] On the tv you see [a list of things on the s_7].[end if]".
...
The bathroom part 2 is some text that varies. The bathroom part 2 is " [if c_4 is locked]A locked[else if c_4 is open]An open[otherwise]A closed[end if]".
The bathroom part 3 is some text that varies. The bathroom part 3 is " bath is nearby.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4].[end if]".
...
The bathroom part 5 is some text that varies. The bathroom part 5 is " You see a sink. You shudder, but continue examining the sink. The sink is usual.[if there is something on the s_4] On the sink you see [a list of things on the s_4]. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[end if]".
...
The garden part 0 is some text that varies. The garden part 0 is "You're not going to believe this, but you've just entered a garden. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The s_8 is in r_4.
The description of s_9 is "The patio table is solidly built.".
The printed name of s_9 is "patio table".
Understand "patio table" as s_9.
Understand "patio" as s_9.
Understand "table" as s_9.
The s_9 is in r_4.
The description of f_0 is "The tomato plant looks appealing.".
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another life changing episode of TextWorld! Here is your task for today. First stop, open the chest drawer. Then, retrieve the old key from the chest drawer. If you can get your hands on th".
The objective part 1 is some text that varies. The objective part 1 is "e old key, insert the old key into the wooden door's lock to unlock it. And then, ensure that the wooden door is open. After that, attempt to take a trip east. After that, make an attempt to go south.".
The objective part 2 is some text that varies. The objective part 2 is " After that, retrieve the bell pepper from the couch. With the bell pepper, make an attempt to venture north. With that done, rest the bell pepper on the stove within the kitchen. And if you do that, ".
