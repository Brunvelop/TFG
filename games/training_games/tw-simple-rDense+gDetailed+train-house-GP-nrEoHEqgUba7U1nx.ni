...
Test quest8_0 with "open chest drawer / take old key from chest drawer / unlock wooden door with old key / open wooden door / go east / open screen door / go east / go south / take half of a bag of chips"
...
Test quest9_0 with "open chest drawer / take old key from chest drawer / unlock wooden door with old key / open wooden door / go east / open screen door / go east / go south / take half of a bag of chips / go north / go west / put half of a bag of chips on stove"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First stop, look and see that the chest drawer within the bedroom is open. And then, retrieve the old ke".
The objective part 1 is some text that varies. The objective part 1 is "y from the chest drawer. After getting the old key, unlock the wooden door. And then, doublecheck that the wooden door inside the bedroom is opened. Then, try to go east. Following that, open the scre".
The objective part 2 is some text that varies. The objective part 2 is "en door inside the kitchen. And then, attempt to move east. Then, try to head south. Next, retrieve the half of a bag of chips from the floor of the garden. And then, make an effort to go to the north".
The objective part 3 is some text that varies. The objective part 3 is ". Next, attempt to head west. Following that, rest the half of a bag of chips on the stove. And if you do that, you're the winner!".
