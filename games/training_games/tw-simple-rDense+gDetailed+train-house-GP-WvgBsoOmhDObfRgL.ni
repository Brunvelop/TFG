...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! First off, open the chest drawer. And then, recover the old key from the chest drawer. Then, look and see that t".
The objective part 1 is some text that varies. The objective part 1 is "he wooden door is unlocked. Then, assure that the wooden door is open. Then, attempt to go to the east. With that done, make sure that the refrigerator is ajar. And then, recover the tomato plant from".
The objective part 2 is some text that varies. The objective part 2 is " the refrigerator in the kitchen. And then, sit the tomato plant on the stove within the kitchen. Once that's all handled, you can stop!".
