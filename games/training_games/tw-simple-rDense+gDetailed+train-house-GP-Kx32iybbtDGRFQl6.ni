...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is how to play! Your first objective is to open the antique trunk within the bedroom. After that, recover t".
The objective part 1 is some text that varies. The objective part 1 is "he old key from the antique trunk. After taking the old key, unlock the wooden door. After unlocking the wooden door, open the wooden door. And then, attempt to travel east. After that, open the refri".
The objective part 2 is some text that varies. The objective part 2 is "gerator inside the kitchen. After that, recover the milk from the refrigerator in the kitchen. Then, sit the milk on the stove. And once you've done that, you win!".
