...
The kitchen part 2 is some text that varies. The kitchen part 2 is " You can see a counter. [if there is something on the s_1]You see [a list of things on the s_1] on the counter. Wow! Just like in the movies![end if]".
The kitchen part 3 is some text that varies. The kitchen part 3 is "[if there is nothing on the s_1]But the thing hasn't got anything on it. It would have been so cool if there was stuff on the counter.[end if]".
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " You see a gleam over in a corner, where you can see a kitchen island. Make a note of this, you might have to put stuff on or in it later on. The kitchen island is standard.[if there is something on the s_3] On the kitchen island you see [a list of things on the s_3].[end if]".
...
The bedroom part 3 is some text that varies. The bedroom part 3 is " You see an antique trunk.[if c_1 is open and there is something in the c_1] The antique trunk contains [a list of things in the c_1]. Classic TextWorld.[end if]".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " You see a gleam over in a corner, where you can see a king-size bed. [if there is something on the s_0]You see [a list of things on the s_0] on the king-size bed.[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You arrive in a backyard. A standard one.
 ...
 You make out a set of chairs. [if there is something on the s_10]You see [a list of things on the s_10] on the set of chairs. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " As if things weren't amazing enough already, you can even see a bbq. The bbq is ordinary.[if there is something on the s_8] On the bbq you can make out [a list of things on the s_8].[end if]".
The backyard part 3 is some text that varies. The backyard part 3 is "[if there is nothing on the s_8] However, the bbq, like an empty bbq, has nothing on it. Hm. Oh well[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You find yourself in a living room. A normal one.
 ...
 You scan the room for a couch, and you find a couch. The couch is normal.[if there is something on the s_5] On the couch you can see [a list of things on the s_5]. There's something strange about this being here, but you can't put your finger on it.[end if]".
...
The living room part 2 is some text that varies. The living room part 2 is " Look out! It's a- oh, never mind, it's just a low table. You shudder, but continue examining the low table. [if there is something on the s_6]You see [a list of things on the s_6] on the low table. You can't wait to tell the folks at home about this![end if]".
The living room part 3 is some text that varies. The living room part 3 is "[if there is nothing on the s_6]But the thing is empty, unfortunately. Sometimes, just sometimes, TextWorld can just be the worst.[end if]".
The living room part 4 is some text that varies. The living room part 4 is " You rest your hand against a wall, but you miss the wall and fall onto a tv. The tv is standard.[if there is something on the s_7] On the tv you can see [a list of things on the s_7].[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You are in a bathroom. An ordinary one. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The bathroom part 4 is some text that varies. The bathroom part 4 is " You see a sink. The sink is standard.[if there is something on the s_4] On the sink you can see [a list of things on the s_4].[end if]".
The bathroom part 5 is some text that varies. The bathroom part 5 is "[if there is nothing on the s_4] Unfortunately, there isn't a thing on it. You swear loudly.[end if]".
...
The s_9 is in r_4.
The description of f_0 is "The bell pepper looks appetizing.".
...
The description of o_2 is "The remote appears to be out of place here".
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is your task for today. First, it would be good if you could doublecheck that the antique trunk within the bedroom is ajar. And then, pick up the old key from the antique tr".
The objective part 1 is some text that varies. The objective part 1 is "unk. And then, insert the old key into the wooden door's lock to unlock it. After that, open the wooden door inside the bedroom. After that, try to go east. That done, assure that the screen door is a".
The objective part 2 is some text that varies. The objective part 2 is "jar. And then, move east. Okay, and then, attempt to travel south. With that done, pick up the half of a bag of chips from the floor of the garden. Then, venture north. Following that, make an effort ".
The objective part 3 is some text that varies. The objective part 3 is "to go west. Then, rest the half of a bag of chips on the stove in the kitchen. Once that's all handled, you can stop!".
