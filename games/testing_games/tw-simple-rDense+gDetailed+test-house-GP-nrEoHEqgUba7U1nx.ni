...
The f_4 is in r_5.
The f_4 is edible.
The description of f_5 is "The garlic looks delicious.".
The printed name of f_5 is "garlic".
...
The description of o_4 is "The dinner is almost ready! It's only missing a grilled garlic.".
...
Test quest8_0 with "open chest drawer / take old key from chest drawer / unlock wooden door with old key / open wooden door / go east / open screen door / go east / go south / take garlic"
...
Test quest9_0 with "open chest drawer / take old key from chest drawer / unlock wooden door with old key / open wooden door / go east / open screen door / go east / go south / take garlic / go north / go west / put garlic on stove"
...
The objective part 2 is some text that varies. The objective part 2 is "en door inside the kitchen. And then, attempt to move east. Then, try to head south. Next, retrieve the garlic from the floor of the garden. And then, make an effort to go to the north. Next, attempt ".
The objective part 3 is some text that varies. The objective part 3 is "to head west. Following that, rest the garlic on the stove. And if you do that, you're the winner!".
