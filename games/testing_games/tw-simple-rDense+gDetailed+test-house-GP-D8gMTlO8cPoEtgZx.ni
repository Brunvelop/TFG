...
The objective part 3 is some text that varies. The objective part 3 is "south. That done, pick-up the carrot from the floor of the garden. Once you have got the carrot, attempt to go to the north. Following that, make an effort to go to the west. Okay, and then, put the c".
The objective part 4 is some text that varies. The objective part 4 is "arrot on the stove. Got that? Good!".
