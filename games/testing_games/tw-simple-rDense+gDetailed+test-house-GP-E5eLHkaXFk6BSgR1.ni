...
The s_9 is in r_4.
The description of f_0 is "The garlic looks delicious.".
The printed name of f_0 is "garlic".
...
Test quest5_0 with "open chest drawer / take old key from chest drawer / unlock wooden door with old key / open wooden door / go east / open refrigerator / take garlic from refrigerator"
...
Test quest6_0 with "open chest drawer / take old key from chest drawer / unlock wooden door with old key / open wooden door / go east / open refrigerator / take garlic from refrigerator / put garlic on stove"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a exciting game of TextWorld! Here is your task for today. First off, ensure that the chest drawer in the bedroom is open. And then, recover the old key from the chest drawer. Then".
The objective part 1 is some text that varies. The objective part 1 is ", doublecheck that the wooden door inside the bedroom is unlocked with the old key. And then, open the wooden door. After that, make an effort to go east. And then, doublecheck that the refrigerator i".
The objective part 2 is some text that varies. The objective part 2 is "s open. Then, take the garlic from the refrigerator within the kitchen. Then, rest the garlic on the stove. Once that's all handled, you can stop!".
