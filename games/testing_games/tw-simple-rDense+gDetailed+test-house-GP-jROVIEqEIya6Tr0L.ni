...
The f_4 is in r_5.
The f_4 is edible.
The description of f_5 is "that's a standard garlic!".
...
The objective part 2 is some text that varies. The objective part 2 is "one, make it so that the screen door within the kitchen is ajar. After that, make an effort to move east. With that accomplished, make an attempt to take a trip south. Once you do that, pick-up the ga".
The objective part 3 is some text that varies. The objective part 3 is "rlic from the floor of the garden. After that, make an effort to travel north. Then, make an effort to move west. With that over with, sit the garlic on the stove in the kitchen. And once you've done ".
The objective part 4 is some text that varies. The objective part 4 is "that, you win!".
