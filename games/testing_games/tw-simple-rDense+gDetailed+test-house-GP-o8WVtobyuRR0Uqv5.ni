...
The kitchen part 3 is some text that varies. The kitchen part 3 is " Hey, want to see a counter? Look over there, a counter. The counter is standard.[if there is something on the s_1] On the counter you see [a list of things on the s_1].[end if]".
The kitchen part 4 is some text that varies. The kitchen part 4 is "[if there is nothing on the s_1] But oh no! there's nothing on this piece of garbage.[end if]".
The kitchen part 5 is some text that varies. The kitchen part 5 is " You see a stove. The stove is normal.[if there is something on the s_2] On the stove you make out [a list of things on the s_2].[end if]".
The kitchen part 6 is some text that varies. The kitchen part 6 is "[if there is nothing on the s_2] But the thing is empty, unfortunately. What, you think everything in TextWorld should have stuff on it?[end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is " You see a kitchen island. [if there is something on the s_3]On the kitchen island you see [a list of things on the s_3].[end if]".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " You can make out a king-size bed. The king-size bed is usual.[if there is something on the s_0] On the king-size bed you can make out [a list of things on the s_0].[end if]".
The bedroom part 6 is some text that varies. The bedroom part 6 is "[if there is nothing on the s_0] But oh no! there's nothing on this piece of garbage. It would have been so cool if there was stuff on the king-size bed.[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "I never took you for the sort of person who would show up in a backyard, but I guess I was wrong.
 ...
 You can see a set of chairs. [if there is something on the s_10]On the set of chairs you can make out [a list of things on the s_10].[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You can make out a bbq. The bbq is normal.[if there is something on the s_8] On the bbq you can make out [a list of things on the s_8].[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " What's that over there? It looks like it's a patio table. The patio table is standard.[if there is something on the s_9] On the patio table you can make out [a list of things on the s_9].[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You've entered a living room.
 ...
 You can make out a couch. Make a note of this, you might have to put stuff on or in it later on. [if there is something on the s_5]On the couch you see [a list of things on the s_5].[end if]".
...
The living room part 2 is some text that varies. The living room part 2 is " You can make out a low table. The low table is usual.[if there is something on the s_6] On the low table you can see [a list of things on the s_6].[end if]".
The living room part 3 is some text that varies. The living room part 3 is "[if there is nothing on the s_6] But the thing is empty, unfortunately. It would have been so cool if there was stuff on the low table.[end if]".
The living room part 4 is some text that varies. The living room part 4 is " You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a tv. The tv is typical.[if there is something on the s_7] On the tv you can make out [a list of things on the s_7].[end if]".
The living room part 5 is some text that varies. The living room part 5 is "[if there is nothing on the s_7] But the thing is empty, unfortunately. You think about smashing the tv to bits, throwing the bits in the dump, etc, until you get bored.[end if]".
...
The bathroom part 3 is some text that varies. The bathroom part 3 is " bath, which looks usual, in the corner.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4].[end if]".
...
The bathroom part 5 is some text that varies. The bathroom part 5 is " You can see a sink. The sink is typical.[if there is something on the s_4] On the sink you see [a list of things on the s_4].[end if]".
...
The description of d_0 is "The wooden door looks sturdy. [if open]It is open.[else if closed]It is closed.[otherwise]It is locked.[end if]".
...
The c_4 is in r_3.
The c_4 is closed.
The description of f_3 is "The lettuce looks delectable.".
...
Test quest5_0 with "open antique trunk / take old key from antique trunk / unlock wooden door with old key / open wooden door / go east / open refrigerator / take kiwi from refrigerator"
...
Test quest6_0 with "open antique trunk / take old key from antique trunk / unlock wooden door with old key / open wooden door / go east / open refrigerator / take kiwi from refrigerator / put kiwi on stove"
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is your task for today. First thing I need you to do is to ensure that the antique trunk is open. Then, tak".
The objective part 1 is some text that varies. The objective part 1 is "e the old key from the antique trunk. With the old key, insert the old key into the wooden door's lock to unlock it. After that, doublecheck that the wooden door is wide open. And then, take a trip ea".
The objective part 2 is some text that varies. The objective part 2 is "st. And then, open the refrigerator in the kitchen. Once you have opened the refrigerator, pick up the kiwi from the refrigerator within the kitchen. After that, rest the kiwi on the stove within the ".
The objective part 3 is some text that varies. The objective part 3 is "kitchen. Got that? Good!".
