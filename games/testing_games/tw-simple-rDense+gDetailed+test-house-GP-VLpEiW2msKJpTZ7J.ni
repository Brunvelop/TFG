...
The s_9 is in r_4.
The description of f_0 is "that's a standard garlic!".
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! First of all, open the chest drawer in the bedroom. Then, take the old key from the chest drawer inside the bedroom. And then, look and see that th".
The objective part 1 is some text that varies. The objective part 1 is "e wooden door is unlocked. Then, open the wooden door. After that, attempt to move east. With that over with, open the refrigerator in the kitchen. And then, retrieve the garlic from the refrigerator.".
The objective part 2 is some text that varies. The objective part 2 is " Then, sit the garlic on the stove. Got that? Good!".
