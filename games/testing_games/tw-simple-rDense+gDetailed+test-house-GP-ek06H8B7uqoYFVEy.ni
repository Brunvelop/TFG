...
The objective part 2 is some text that varies. The objective part 2 is "jar. And then, move east. Okay, and then, attempt to travel south. With that done, pick up the kiwi from the floor of the garden. Then, venture north. Following that, make an effort to go west. Then, ".
The objective part 3 is some text that varies. The objective part 3 is "rest the kiwi on the stove in the kitchen. Once that's all handled, you can stop!".
