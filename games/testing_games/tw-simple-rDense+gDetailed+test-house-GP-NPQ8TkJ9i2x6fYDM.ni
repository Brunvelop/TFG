...
The kitchen part 1 is some text that varies. The kitchen part 1 is " refrigerator is here.[if c_2 is open and there is something in the c_2] The refrigerator contains [a list of things in the c_2].[end if]".
...
The kitchen part 3 is some text that varies. The kitchen part 3 is " You scan the room for a counter, and you find a counter. The counter is ordinary.[if there is something on the s_1] On the counter you make out [a list of things on the s_1].[end if]".
The kitchen part 4 is some text that varies. The kitchen part 4 is "[if there is nothing on the s_1] But the thing is empty. You move on, clearly infuriated by your TextWorld experience.[end if]".
The kitchen part 5 is some text that varies. The kitchen part 5 is " You see a stove. [if there is something on the s_2]On the stove you can see [a list of things on the s_2]. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
The kitchen part 6 is some text that varies. The kitchen part 6 is "[if there is nothing on the s_2]Unfortunately, there isn't a thing on it.[end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is " You see a kitchen island. [if there is something on the s_3]You see [a list of things on the s_3] on the kitchen island, so there's that.[end if]".
...
The kitchen part 11 is some text that varies. The kitchen part 11 is " wooden door leading west. There is an unblocked exit to the north. There is an exit to the south. Don't worry, it is unblocked.".
...
The bedroom part 1 is some text that varies. The bedroom part 1 is " chest drawer.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0]. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
...
The bedroom part 3 is some text that varies. The bedroom part 3 is " You see an antique trunk. Now that's what I call TextWorld![if c_1 is open and there is something in the c_1] The antique trunk contains [a list of things in the c_1].[end if]".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " You make out a king-size bed. The king-size bed is normal.[if there is something on the s_0] On the king-size bed you make out [a list of things on the s_0]. I mean, just wow! Isn't TextWorld just the best?[end if]".
The bedroom part 6 is some text that varies. The bedroom part 6 is "[if there is nothing on the s_0] Unfortunately, there isn't a thing on it.[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You're now in the backyard.
 ...
 You make out a set of chairs. The set of chairs is typical.[if there is something on the s_10] On the set of chairs you see [a list of things on the s_10].[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You see a bbq. The bbq is typical.[if there is something on the s_8] On the bbq you see [a list of things on the s_8].[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You hear a noise behind you and spin around, but you can't see anything other than a patio table. The patio table is ordinary.[if there is something on the s_9] On the patio table you make out [a list of things on the s_9]. Now that's what I call TextWorld![end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You make another one of your grand eccentric entrances into a living room.

 You make out a couch. The couch is standard.[if there is something on the s_5] On the couch you can make out [a list of things on the s_5].[end if]".
The living room part 1 is some text that varies. The living room part 1 is "[if there is nothing on the s_5] However, the couch, like an empty couch, has nothing on it. What, you think everything in TextWorld should have stuff on it?[end if]".
The living room part 2 is some text that varies. The living room part 2 is " Look over there! a low table. You shudder, but continue examining the low table. [if there is something on the s_6]On the low table you make out [a list of things on the s_6].[end if]".
...
The living room part 4 is some text that varies. The living room part 4 is " You hear a noise behind you and spin around, but you can't see anything other than a tv. The tv is typical.[if there is something on the s_7] On the tv you make out [a list of things on the s_7]. Classic TextWorld.[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You find yourself in a bathroom. An ordinary kind of place. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.

 You can see [if c_3 is locked]a locked[else if c_3 is open]an opened[otherwise]a closed[end if]".
The bathroom part 1 is some text that varies. The bathroom part 1 is " toilet, which looks usual, in the room.[if c_3 is open and there is something in the c_3] The toilet contains [a list of things in the c_3].[end if]".
...
The bathroom part 4 is some text that varies. The bathroom part 4 is " bath, which looks standard, here.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4]. You can't wait to tell the folks at home about this![end if]".
...
The bathroom part 6 is some text that varies. The bathroom part 6 is " You can see a sink. Why don't you take a picture of it, it'll last longer! [if there is something on the s_4]On the sink you can see [a list of things on the s_4]. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[end if]".
...
The c_4 is in r_3.
The c_4 is closed.
The description of f_3 is "that's a normal bell pepper!".
...
The f_3 is in r_5.
The f_3 is edible.
The description of f_4 is "The apple looks inviting.".
...
The f_5 is in r_5.
The f_5 is edible.
The description of o_3 is "The shovel looks well matched to everything else here".
...
The s_9 is in r_4.
The description of f_0 is "The garlic looks appetizing.".
The printed name of f_0 is "garlic".
Understand "garlic" as f_0.
The f_0 is edible.
The f_0 is in the c_2.
The description of f_1 is "The half of a bag of chips looks savory.".
...
The description of o_1 is "The soap bar is clean.".
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! First step, open the chest drawer. After that, retrieve the old key from the chest drawer. After that, insert the old key into the wooden door inside the bedroom's lock to unlock".
The objective part 1 is some text that varies. The objective part 1 is " it. Then, ensure that the wooden door is open. Having pulled open the wooden door, make an attempt to move east. If you can accomplish that, ensure that the refrigerator in the kitchen is open. After".
The objective part 2 is some text that varies. The objective part 2 is " that, take the garlic from the refrigerator. And then, sit the garlic on the stove. Got that? Good!".
