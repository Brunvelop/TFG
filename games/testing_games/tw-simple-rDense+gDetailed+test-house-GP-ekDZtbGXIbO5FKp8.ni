...
The kitchen part 1 is some text that varies. The kitchen part 1 is " refrigerator nearby.[if c_2 is open and there is something in the c_2] The refrigerator contains [a list of things in the c_2].[end if]".
...
The kitchen part 3 is some text that varies. The kitchen part 3 is " You can see a counter. The counter is normal.[if there is something on the s_1] On the counter you make out [a list of things on the s_1]. Huh, weird.[end if]".
...
The kitchen part 5 is some text that varies. The kitchen part 5 is " You rest your hand against a wall, but you miss the wall and fall onto a stove. [if there is something on the s_2]On the stove you can make out [a list of things on the s_2].[end if]".
The kitchen part 6 is some text that varies. The kitchen part 6 is "[if there is nothing on the s_2]Looks like someone's already been here and taken everything off it, though. It would have been so cool if there was stuff on the stove.[end if]".
...
The bedroom part 1 is some text that varies. The bedroom part 1 is " normal looking chest drawer right there by you.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0].[end if]".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " You see a king-size bed. [if there is something on the s_0]On the king-size bed you see [a list of things on the s_0].[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "This is going to sound unbelievable, but you've just entered a backyard.
 ...
 You see a set of chairs. [if there is something on the s_10]You see [a list of things on the s_10] on the set of chairs. Wow! Just like in the movies![end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " What's that over there? It looks like it's a bbq. [if there is something on the s_8]You see [a list of things on the s_8] on the bbq. It doesn't get more TextWorld than this![end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You bend down to tie your shoe. When you stand up, you notice a patio table. [if there is something on the s_9]On the patio table you can see [a list of things on the s_9].[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "Well I'll be, you are in the place we're calling the living room.

 You bend down to tie your shoe. When you stand up, you notice a couch. [if there is something on the s_5]You see [a list of things on the s_5] on the couch.[end if]".
...
The living room part 2 is some text that varies. The living room part 2 is " You see a low table. The low table is standard.[if there is something on the s_6] On the low table you see [a list of things on the s_6].[end if]".
...
The living room part 4 is some text that varies. The living room part 4 is " You scan the room for a tv, and you find a tv. The tv is ordinary.[if there is something on the s_7] On the tv you can make out [a list of things on the s_7].[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You find yourself in a normal kind of place. That is to say, you're in a bathroom. You begin to take stock of what's here.
...
The bathroom part 3 is some text that varies. The bathroom part 3 is " bath right there by you.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4].[end if]".
...
The bathroom part 5 is some text that varies. The bathroom part 5 is " You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a sink. The sink is standard.[if there is something on the s_4] On the sink you can see [a list of things on the s_4].[end if]".
The bathroom part 6 is some text that varies. The bathroom part 6 is "[if there is nothing on the s_4] However, the sink, like an empty sink, has nothing on it. This always happens![end if]".
...
The d_0 is locked.
The description of d_1 is "it's an imposing screen door [if open]It is open.[else if closed]It is closed.[otherwise]It is locked.[end if]".
...
The description of f_1 is "The bell pepper looks tempting.".
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First off, if it's not too much trouble, I need you to doublecheck that the antique trunk in the bedroom".
The objective part 1 is some text that varies. The objective part 1 is " is wide open. After that, pick up the old key from the antique trunk in the bedroom. After that, doublecheck that the wooden door is unlocked with the old key. And then, make absolutely sure that the".
The objective part 2 is some text that varies. The objective part 2 is " wooden door is opened. After that, make an effort to go to the east. And then, travel south. With that done, recover the carrot from the couch. And then, move north. Then, rest the carrot on the stov".
The objective part 3 is some text that varies. The objective part 3 is "e in the kitchen. And once you've done that, you win!".
