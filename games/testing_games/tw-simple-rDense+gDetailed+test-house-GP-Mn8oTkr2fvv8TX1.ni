...
The objective part 2 is some text that varies. The objective part 2 is " do that, open the screen door. And then, move east. Then, try to travel south. Then, lift the carrot from the floor of the garden. And then, head north. Okay, and then, make an effort to travel west.".
The objective part 3 is some text that varies. The objective part 3 is " Following that, put the carrot on the stove within the kitchen. And if you do that, you're the winner!".
