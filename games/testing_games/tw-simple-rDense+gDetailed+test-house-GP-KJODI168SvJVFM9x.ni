...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is your task for today. First stop, open the antique trunk inside the bedroom. And then, take the old key from the antique trunk inside the bedroom. With the old key, unlock".
The objective part 1 is some text that varies. The objective part 1 is " the wooden door inside the bedroom with the old key. After that, ensure that the wooden door in the bedroom is open. After that, make an attempt to travel east. Then, ensure that the screen door in t".
The objective part 2 is some text that varies. The objective part 2 is "he kitchen is open. Once you have opened the screen door, make an effort to go to the east. After that, try to go to the south. After that, retrieve the carrot from the floor of the garden. And then, ".
The objective part 3 is some text that varies. The objective part 3 is "try to move north. Once you succeed at that, try to take a trip west. And then, rest the carrot on the stove. That's it!".
