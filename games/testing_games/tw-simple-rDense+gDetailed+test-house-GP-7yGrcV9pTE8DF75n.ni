...
The f_3 is in r_5.
The f_3 is edible.
The description of f_4 is "The kiwi looks heavenly.".
The printed name of f_4 is "kiwi".
Understand "kiwi" as f_4.
The f_4 is in r_5.
The f_4 is edible.
...
The description of o_4 is "The dinner is almost ready! It's only missing a grilled kiwi.".
...
Test quest8_0 with "open chest drawer / take old key from chest drawer / unlock wooden door with old key / open wooden door / go east / open screen door / go east / go south / take kiwi"
...
Test quest9_0 with "open chest drawer / take old key from chest drawer / unlock wooden door with old key / open wooden door / go east / open screen door / go east / go south / take kiwi / go north / go west / put kiwi on stove"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! First of all, you could, like, ensure that the chest drawer is open. After that, recover the old key from the chest drawer. After that, unlock the wooden door. And then, open the".
The objective part 1 is some text that varies. The objective part 1 is " wooden door. And then, go to the east. Then, ensure that the screen door in the kitchen is open. After pulling open the screen door, try to take a trip east. After that, travel south. With that over ".
The objective part 2 is some text that varies. The objective part 2 is "with, recover the kiwi from the floor of the garden. If you can get your hands on the kiwi, attempt to venture north. Then, make an effort to take a trip west. Following that, rest the kiwi on the sto".
The objective part 3 is some text that varies. The objective part 3 is "ve. That's it!".
