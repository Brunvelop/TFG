...
The s_9 is in r_4.
The description of f_0 is "The garlic looks tasty.".
...
Test quest5_0 with "open antique trunk / take old key from antique trunk / unlock wooden door with old key / open wooden door / go east / open refrigerator / take garlic from refrigerator"
...
Test quest6_0 with "open antique trunk / take old key from antique trunk / unlock wooden door with old key / open wooden door / go east / open refrigerator / take garlic from refrigerator / put garlic on stove"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another profound game of TextWorld! Here is your task for today. First off, if it's not too much trouble, I need you to open the antique trunk. And then, pick up the old key from the antiqu".
The objective part 1 is some text that varies. The objective part 1 is "e trunk. And then, check that the wooden door in the bedroom is unlocked with the old key. Then, ensure that the wooden door is open. And then, go to the east. Next, ensure that the refrigerator is op".
The objective part 2 is some text that varies. The objective part 2 is "en. And then, recover the garlic from the refrigerator within the kitchen. After that, put the garlic on the stove. And if you do that, you're the winner!".
