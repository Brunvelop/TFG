...
The kitchen part 3 is some text that varies. The kitchen part 3 is " You make out a counter. [if there is something on the s_1]You see [a list of things on the s_1] on the counter, so there's that.[end if]".
...
The kitchen part 5 is some text that varies. The kitchen part 5 is " You make out a stove. The stove is standard.[if there is something on the s_2] On the stove you can see [a list of things on the s_2]. It doesn't get more TextWorld than this![end if]".
The kitchen part 6 is some text that varies. The kitchen part 6 is "[if there is nothing on the s_2] But there isn't a thing on it. What, you think everything in TextWorld should have stuff on it?[end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is " You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a kitchen island. [if there is something on the s_3]You see [a list of things on the s_3] on the kitchen island.[end if]".
The kitchen part 8 is some text that varies. The kitchen part 8 is "[if there is nothing on the s_3]But the thing is empty. You make a mental note to not get your hopes up the next time you see a kitchen island in a room.[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You've stumbled into a typical room. Your mind races to think of what kind of room would be typical. And then it hits you. Of course. You're in the bedroom.
 ...
 As if things weren't amazing enough already, you can even see a chest drawer.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0].[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "Of every backyard you could have walked into, you had to walk into an usual one.

 You see a set of chairs. The set of chairs is usual.[if there is something on the s_10] On the set of chairs you can see [a list of things on the s_10].[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You see a bbq. What a coincidence, weren't you just thinking about a bbq? The bbq is ordinary.[if there is something on the s_8] On the bbq you can see [a list of things on the s_8].[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You make out a patio table. The patio table is normal.[if there is something on the s_9] On the patio table you can make out [a list of things on the s_9]. Wow! Just like in the movies![end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "This might come as a shock to you, but you've just stumbled into a living room.

 You smell an awful smell, and follow it to a couch. [if there is something on the s_5]On the couch you can see [a list of things on the s_5].[end if]".
The living room part 1 is some text that varies. The living room part 1 is "[if there is nothing on the s_5]Looks like someone's already been here and taken everything off it, though. You swear loudly.[end if]".
The living room part 2 is some text that varies. The living room part 2 is " Oh wow! Is that what I think it is? It is! It's a low table. The low table is ordinary.[if there is something on the s_6] On the low table you see [a list of things on the s_6]. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
...
The living room part 4 is some text that varies. The living room part 4 is " You make out a tv. [if there is something on the s_7]On the tv you can see [a list of things on the s_7].[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You find yourself in a bathroom. A standard kind of place.
 ...
 You rest your hand against a wall, but you miss the wall and fall onto a toilet. You can't wait to tell the folks at home about this![if c_3 is open and there is something in the c_3] The toilet contains [a list of things in the c_3].[end if]".
...
The bathroom part 5 is some text that varies. The bathroom part 5 is " What's that over there? It looks like it's a sink. The sink is typical.[if there is something on the s_4] On the sink you see [a list of things on the s_4].[end if]".
The bathroom part 6 is some text that varies. The bathroom part 6 is "[if there is nothing on the s_4] But oh no! there's nothing on this piece of trash.[end if]".
...
The garden part 0 is some text that varies. The garden part 0 is "Well, here we are in the garden. The room is well lit.
...
The description of d_0 is "The wooden door looks commanding. [if open]It is open.[else if closed]It is closed.[otherwise]It is locked.[end if]".
...
Test quest5_0 with "open chest drawer / take old key from chest drawer / unlock wooden door with old key / open wooden door / go east / open refrigerator / take carrot from refrigerator"
...
Test quest6_0 with "open chest drawer / take old key from chest drawer / unlock wooden door with old key / open wooden door / go east / open refrigerator / take carrot from refrigerator / put carrot on stove"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. Your first objective is to ensure that the chest drawer inside the bedroom is open. After that, pick up ".
The objective part 1 is some text that varies. The objective part 1 is "the old key from the chest drawer. If you can get your hands on the old key, check that the wooden door is unlocked with the old key. And then, assure that the wooden door inside the bedroom is ajar. ".
The objective part 2 is some text that varies. The objective part 2 is "And then, make an effort to head east. That done, open the refrigerator inside the kitchen. After that, take the carrot from the refrigerator. With the carrot, place the carrot on the stove. Got that?".
