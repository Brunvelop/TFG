...
The kitchen part 0 is some text that varies. The kitchen part 0 is "Well I'll be, you are in the place we're calling the kitchen.
 ...
 You see a refrigerator.[if c_2 is open and there is something in the c_2] The refrigerator contains [a list of things in the c_2]. Now that's what I call TextWorld![end if]".
...
The kitchen part 2 is some text that varies. The kitchen part 2 is " You make out a counter. The counter is ordinary.[if there is something on the s_1] On the counter you make out [a list of things on the s_1]. Wow! Just like in the movies![end if]".
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " You make out a stove. The stove is ordinary.[if there is something on the s_2] On the stove you make out [a list of things on the s_2].[end if]".
...
The kitchen part 10 is some text that varies. The kitchen part 10 is " wooden door leading west. There is an unblocked exit to the north. You don't like doors? Why not try going south, that entranceway is unblocked.".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You arrive in a bedroom. A typical one. You decide to just list off a complete list of everything you see in the room, because hey, why not?

 You can make out [if c_0 is locked]a locked[else if c_0 is open]an opened[otherwise]a closed[end if]".
The bedroom part 1 is some text that varies. The bedroom part 1 is " chest drawer, which looks usual, in the corner.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0].[end if]".
...
The bedroom part 3 is some text that varies. The bedroom part 3 is " As if things weren't amazing enough already, you can even see an antique trunk.[if c_1 is open and there is something in the c_1] The antique trunk contains [a list of things in the c_1].[end if]".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " Oh wow! Is that what I think it is? It is! It's a king-size bed. The king-size bed is standard.[if there is something on the s_0] On the king-size bed you can make out [a list of things on the s_0].[end if]".
The bedroom part 6 is some text that varies. The bedroom part 6 is "[if there is nothing on the s_0] But there isn't a thing on it.[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "Fancy seeing you here. Here, by the way, being the backyard. You start to take note of what's in the room.

 You can make out a set of chairs. The set of chairs is standard.[if there is something on the s_10] On the set of chairs you can make out [a list of things on the s_10].[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You bend down to tie your shoe. When you stand up, you notice a bbq. The bbq is normal.[if there is something on the s_8] On the bbq you see [a list of things on the s_8], so there's that.[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You arrive in a living room. A typical kind of place. Let's see what's in here.

 You can see a couch. [if there is something on the s_5]You see [a list of things on the s_5] on the couch. Classic TextWorld.[end if]".
The living room part 1 is some text that varies. The living room part 1 is "[if there is nothing on the s_5]However, the couch, like an empty couch, has nothing on it. What's the point of an empty couch?[end if]".
The living room part 2 is some text that varies. The living room part 2 is " You can see a low table. [if there is something on the s_6]On the low table you can make out [a list of things on the s_6].[end if]".
...
The living room part 4 is some text that varies. The living room part 4 is " You make out a tv. The tv is typical.[if there is something on the s_7] On the tv you make out [a list of things on the s_7]. Now that's what I call TextWorld![end if]".
The living room part 5 is some text that varies. The living room part 5 is "[if there is nothing on the s_7] But oh no! there's nothing on this piece of junk.[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You arrive in a bathroom. A standard one. You can barely contain your excitement.
...
The bathroom part 3 is some text that varies. The bathroom part 3 is " bath here.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4], so there's that.[end if]".
...
The bathroom part 5 is some text that varies. The bathroom part 5 is " Look out! It's a- oh, never mind, it's just a sink. [if there is something on the s_4]On the sink you see [a list of things on the s_4].[end if]".
The bathroom part 6 is some text that varies. The bathroom part 6 is "[if there is nothing on the s_4]But oh no! there's nothing on this piece of garbage. Oh! Why couldn't there just be stuff on it?[end if]".
...
The f_4 is in r_5.
The f_4 is edible.
The description of f_5 is "The carrot looks tantalizing.".
...
The s_3 is in r_1.
The description of s_4 is "The sink is shaky.".
...
The description of f_2 is "The lettuce looks tempting.".
...
The description of o_1 is "The soap bar would seem to be out of place here".
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Here is how to play! Your first objective is to make it so that the antique trunk in the bedroom ".
The objective part 1 is some text that varies. The objective part 1 is "is opened. Then, pick up the old key from the antique trunk. Then, unlock the wooden door in the bedroom. After unlocking the wooden door, open the wooden door inside the bedroom. And then, travel eas".
The objective part 2 is some text that varies. The objective part 2 is "t. Once you get around to doing that, open the screen door in the kitchen. And then, travel east. After that, make an attempt to venture south. Then, retrieve the carrot from the floor of the garden. ".
The objective part 3 is some text that varies. The objective part 3 is "Then, go north. And then, attempt to go to the west. That done, place the carrot on the stove. That's it!".
