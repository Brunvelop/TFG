...
Test quest8_0 with "open antique trunk / take old key from antique trunk / unlock wooden door with old key / open wooden door / go east / open screen door / go east / go south / take carrot"
...
Test quest9_0 with "open antique trunk / take old key from antique trunk / unlock wooden door with old key / open wooden door / go east / open screen door / go east / go south / take carrot / go north / go west / put carrot on stove"
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! First stop, open the antique trunk. And then, retrieve the old key from the antique trunk. With t".
The objective part 1 is some text that varies. The objective part 1 is "he old key, insert the old key into the wooden door's lock to unlock it. After unlocking the wooden door, ensure that the wooden door in the bedroom is open. Then, make an attempt to move east. Then, ".
The objective part 2 is some text that varies. The objective part 2 is "open the screen door. And then, venture east. Then, travel south. That done, retrieve the carrot from the floor of the garden. After that, go to the north. Then, attempt to go to the west. If you can ".
The objective part 3 is some text that varies. The objective part 3 is "manage that, sit the carrot on the stove. And if you do that, you're the winner!".
